...
<script>
ew.ready("head", [ew.PATH_BASE + "ckeditor/ckeditor.js?v=24.16.0", ew.PATH_BASE + "js/eweditor.js?v=24.16.0"], "editor");
</script>
<script>
...
<script>
loadjs(ew.PATH_BASE + "timepicker/<?= CssFile("jquery.timepicker.css") ?>?v=24.16.0");
ew.ready("head", [ew.PATH_BASE + "timepicker/jquery.timepicker.js?v=24.16.0", ew.PATH_BASE + "js/ewtimepicker.js?v=24.16.0"], "timepicker");
</script>
<script>
...
<link rel="shortcut icon" type="image/x-icon" href="<?= BasePath() ?>/icono.ico">
<link rel="icon" type="image/x-icon" href="<?= BasePath() ?>/icono.ico">
        ...
        <div class="container-fluid">
            ...
            <ul id="ew-navbar" class="navbar-nav">
                ...
                <a class="navbar-brand d-none" href="#" data-ew-action="none">
                    <img src="<?= GetUrl("images/hercules_logo.png") ?>" alt="" class="brand-image ew-brand-image">
                </a>
            </ul>
            <!-- Right navbar links -->
