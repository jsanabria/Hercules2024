...
<?= $Page->Pager->render() ?>
<?php } ?>
<form name="fsco_useredit" id="fsco_useredit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
...
<div class="input-group">
    <input type="password" name="x__password" id="x__password" autocomplete="new-password" data-table="sco_user" data-field="x__password" value="<?= $Page->_password->EditValue ?>" size="30" maxlength="60" placeholder="<?= HtmlEncode($Page->_password->getPlaceHolder()) ?>"<?= $Page->_password->editAttributes() ?> aria-describedby="x__password_help">
...
<span id="el_sco_user_level">
    <select
        ...
        data-select2-id="fsco_useredit_x_level"
        data-table="sco_user"
        data-field="x_level"
...
<script>
loadjs.ready("fsco_useredit", function() {
    var options = { name: "x_level", selectId: "fsco_useredit_x_level" };
    if (fsco_useredit.lists.level?.lookupOptions.length) {
        options.data = { id: "x_level", form: "fsco_useredit" };
    } else {
        options.ajax = { id: "x_level", form: "fsco_useredit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_sco_user_activo">
    <select
        ...
        data-select2-id="fsco_useredit_x_activo"
        <?php } ?>
        data-table="sco_user"
        data-field="x_activo"
...
<script>
loadjs.ready("fsco_useredit", function() {
    var options = { name: "x_activo", selectId: "fsco_useredit_x_activo" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_useredit.lists.activo?.lookupOptions.length) {
        options.data = { id: "x_activo", form: "fsco_useredit" };
    } else {
        options.ajax = { id: "x_activo", form: "fsco_useredit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<script>
loadjs.ready(["fsco_useredit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsco_useredit", "x_fecha_ingreso_cia", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fsco_useredit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsco_useredit", "x_fecha_egreso_cia", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_sco_user_motivo_egreso">
    <select
        ...
        data-select2-id="fsco_useredit_x_motivo_egreso"
        <?php } ?>
        data-table="sco_user"
...
<script>
loadjs.ready("fsco_useredit", function() {
    var options = { name: "x_motivo_egreso", selectId: "fsco_useredit_x_motivo_egreso" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_useredit.lists.motivo_egreso?.lookupOptions.length) {
        options.data = { id: "x_motivo_egreso", form: "fsco_useredit" };
    } else {
        options.ajax = { id: "x_motivo_egreso", form: "fsco_useredit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_sco_user_departamento">
    <select
        ...
        data-select2-id="fsco_useredit_x_departamento"
        data-table="sco_user"
...
<script>
loadjs.ready("fsco_useredit", function() {
    var options = { name: "x_departamento", selectId: "fsco_useredit_x_departamento" };
    if (fsco_useredit.lists.departamento?.lookupOptions.length) {
        options.data = { id: "x_departamento", form: "fsco_useredit" };
    } else {
        options.ajax = { id: "x_departamento", form: "fsco_useredit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_sco_user_cargo">
    <select
        ...
        data-select2-id="fsco_useredit_x_cargo"
        data-table="sco_user"
        data-field="x_cargo"
...
<script>
loadjs.ready("fsco_useredit", function() {
    var options = { name: "x_cargo", selectId: "fsco_useredit_x_cargo" };
    if (fsco_useredit.lists.cargo?.lookupOptions.length) {
        options.data = { id: "x_cargo", form: "fsco_useredit" };
    } else {
        options.ajax = { id: "x_cargo", form: "fsco_useredit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<script>
loadjs.ready(["fsco_useredit", "timepicker"], () => ew.createTimePicker("fsco_useredit", "x_hora_entrada", Object.assign({"step":15}, { timeFormat: "<?= DateFormat(3) ?>" })));
</script>
<?php } ?>
</span>
</div></div>
...
<script>
loadjs.ready(["fsco_useredit", "timepicker"], () => ew.createTimePicker("fsco_useredit", "x_hora_salida", Object.assign({"step":15}, { timeFormat: "<?= DateFormat(3) ?>" })));
</script>
<?php } ?>
</span>
</div></div>
...
<span id="el_sco_user_proveedor">
    <select
        ...
        data-select2-id="fsco_useredit_x_proveedor"
        data-table="sco_user"
...
<script>
loadjs.ready("fsco_useredit", function() {
    var options = { name: "x_proveedor", selectId: "fsco_useredit_x_proveedor" };
    if (fsco_useredit.lists.proveedor?.lookupOptions.length) {
        options.data = { id: "x_proveedor", form: "fsco_useredit" };
    } else {
        options.ajax = { id: "x_proveedor", form: "fsco_useredit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_sco_user_seguro">
    <select
        ...
        data-select2-id="fsco_useredit_x_seguro"
        data-table="sco_user"
        data-field="x_seguro"
...
<script>
loadjs.ready("fsco_useredit", function() {
    var options = { name: "x_seguro", selectId: "fsco_useredit_x_seguro" };
    if (fsco_useredit.lists.seguro?.lookupOptions.length) {
        options.data = { id: "x_seguro", form: "fsco_useredit" };
    } else {
        options.ajax = { id: "x_seguro", form: "fsco_useredit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_sco_user_evaluacion">
    <select
        ...
        data-select2-id="fsco_useredit_x_evaluacion"
        <?php } ?>
        data-table="sco_user"
...
<script>
loadjs.ready("fsco_useredit", function() {
    var options = { name: "x_evaluacion", selectId: "fsco_useredit_x_evaluacion" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_useredit.lists.evaluacion?.lookupOptions.length) {
        options.data = { id: "x_evaluacion", form: "fsco_useredit" };
    } else {
        options.ajax = { id: "x_evaluacion", form: "fsco_useredit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php } ?>
    ...
    <input type="hidden" data-table="sco_user" data-field="x_Nuser" data-hidden="1" name="x_Nuser" id="x_Nuser" value="<?= HtmlEncode($Page->Nuser->CurrentValue) ?>">
<?php
    if (in_array("sco_user_nota", explode(",", $Page->getCurrentDetailTable())) && $sco_user_nota->DetailEdit) {
?>
...
<?php } ?>
<?php
    if (in_array("sco_user_adjunto", explode(",", $Page->getCurrentDetailTable())) && $sco_user_adjunto->DetailEdit) {
?>
<?php if ($Page->getCurrentDetailTable() != "") { ?>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fsco_useredit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fsco_useredit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
