...
<?php } ?>
<?php } ?>
<form name="fsco_tasa_usdview" id="fsco_tasa_usdview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->moneda->Visible) { // moneda ?>
    <tr id="r_moneda"<?= $Page->moneda->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_tasa_usd_moneda"><?= $Page->moneda->caption() ?></span></td>
...
<?php if ($Page->tasa->Visible) { // tasa ?>
    <tr id="r_tasa"<?= $Page->tasa->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_tasa_usd_tasa"><?= $Page->tasa->caption() ?></span></td>
...
<?php if ($Page->fecha->Visible) { // fecha ?>
    <tr id="r_fecha"<?= $Page->fecha->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_tasa_usd_fecha"><?= $Page->fecha->caption() ?></span></td>
...
<?php if ($Page->hora->Visible) { // hora ?>
    <tr id="r_hora"<?= $Page->hora->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_tasa_usd_hora"><?= $Page->hora->caption() ?></span></td>
...
<?php if ($Page->_username->Visible) { // username ?>
    <tr id="r__username"<?= $Page->_username->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_tasa_usd__username"><?= $Page->_username->caption() ?></span></td>
