...
// Page object
$ScoMascotaEstatusPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { sco_mascota_estatus: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->estatus->Visible) { // estatus ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->estatus->headerCellClass() ?>"><div role="button" data-table="sco_mascota_estatus" data-sort="<?= HtmlEncode($Page->estatus->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->estatus->getNextSort() ?>">
...
<?php if ($Page->fecha_hora->Visible) { // fecha_hora ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->fecha_hora->headerCellClass() ?>"><div role="button" data-table="sco_mascota_estatus" data-sort="<?= HtmlEncode($Page->fecha_hora->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->fecha_hora->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->_username->Visible) { // username ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->_username->headerCellClass() ?>"><div role="button" data-table="sco_mascota_estatus" data-sort="<?= HtmlEncode($Page->_username->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->_username->getNextSort() ?>">
            <div class="ew-table-header-btn">
