...
<?php } ?>
<?php } ?>
<form name="fsco_encuesta_calidadview" id="fsco_encuesta_calidadview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fsco_encuesta_calidadview")
        .setPageId("view")
        .build();
    window[form.id] = form;
    currentForm = form;
...
<?php if ($Page->tipo->Visible) { // tipo ?>
    <tr id="r_tipo"<?= $Page->tipo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_encuesta_calidad_tipo"><?= $Page->tipo->caption() ?></span></td>
...
<?php if ($Page->pregunta->Visible) { // pregunta ?>
    <tr id="r_pregunta"<?= $Page->pregunta->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_encuesta_calidad_pregunta"><?= $Page->pregunta->caption() ?></span></td>
...
<?php if ($Page->respuesta->Visible) { // respuesta ?>
    <tr id="r_respuesta"<?= $Page->respuesta->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_encuesta_calidad_respuesta"><?= $Page->respuesta->caption() ?></span></td>
...
<?php if ($Page->activo->Visible) { // activo ?>
    <tr id="r_activo"<?= $Page->activo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_encuesta_calidad_activo"><?= $Page->activo->caption() ?></span></td>
