...
<?= $Page->Pager->render() ?>
<?php } ?>
<form name="fsco_expediente_oldedit" id="fsco_expediente_oldedit" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<script>
var currentTable = <?= JsonEncode($Page->toClientVar()) ?>;
ew.deepAssign(ew.vars, { tables: { sco_expediente_old: currentTable } });
var currentPageID = ew.PAGE_ID = "edit";
var currentForm;
var fsco_expediente_oldedit;
...
<?php if ($Page->Nexpediente->Visible) { // Nexpediente ?>
    <div id="r_Nexpediente"<?= $Page->Nexpediente->rowAttributes() ?>>
        <label id="elh_sco_expediente_old_Nexpediente" class="<?= $Page->LeftColumnClass ?>"><?= $Page->Nexpediente->caption() ?><?= $Page->Nexpediente->Required ? $Language->phrase("FieldRequiredIndicator") : "" ?></label>
...
<input type="hidden" data-table="sco_expediente_old" data-field="x_Nexpediente" data-hidden="1" name="x_Nexpediente" id="x_Nexpediente" value="<?= HtmlEncode($Page->Nexpediente->CurrentValue) ?>">
</span>
</div></div>
    </div>
<?php } ?>
...
<script>
loadjs.ready(["fsco_expediente_oldedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsco_expediente_oldedit", "x_fecha_nacimiento", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fsco_expediente_oldedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsco_expediente_oldedit", "x_fecha_ocurrencia", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<script>
loadjs.ready(["fsco_expediente_oldedit", "timepicker"], () => ew.createTimePicker("fsco_expediente_oldedit", "x_hora_ocurrencia", Object.assign({"step":15}, { timeFormat: "<?= DateFormat(4) ?>" }, undefined)));
</script>
<?php } ?>
</span>
</div></div>
...
loadjs.ready(["fsco_expediente_oldedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsco_expediente_oldedit", "x_fecha_registro", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fsco_expediente_oldedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsco_expediente_oldedit", "x_fecha_cierre", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
loadjs.ready(["fsco_expediente_oldedit", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsco_expediente_oldedit", "x_fecha_autoriza", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fsco_expediente_oldedit"><?= $Language->phrase("SaveBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fsco_expediente_oldedit" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
