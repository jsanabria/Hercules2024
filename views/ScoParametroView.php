...
<?php } ?>
<?php } ?>
<form name="fsco_parametroview" id="fsco_parametroview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->Nparametro->Visible) { // Nparametro ?>
    <tr id="r_Nparametro"<?= $Page->Nparametro->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_parametro_Nparametro"><?= $Page->Nparametro->caption() ?></span></td>
...
<?php if ($Page->codigo->Visible) { // codigo ?>
    <tr id="r_codigo"<?= $Page->codigo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_parametro_codigo"><?= $Page->codigo->caption() ?></span></td>
...
<?php if ($Page->descripcion->Visible) { // descripcion ?>
    <tr id="r_descripcion"<?= $Page->descripcion->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_parametro_descripcion"><?= $Page->descripcion->caption() ?></span></td>
...
<?php if ($Page->valor1->Visible) { // valor1 ?>
    <tr id="r_valor1"<?= $Page->valor1->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_parametro_valor1"><?= $Page->valor1->caption() ?></span></td>
...
<?php if ($Page->valor2->Visible) { // valor2 ?>
    <tr id="r_valor2"<?= $Page->valor2->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_parametro_valor2"><?= $Page->valor2->caption() ?></span></td>
...
<?php if ($Page->valor3->Visible) { // valor3 ?>
    <tr id="r_valor3"<?= $Page->valor3->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_parametro_valor3"><?= $Page->valor3->caption() ?></span></td>
...
<?php if ($Page->valor4->Visible) { // valor4 ?>
    <tr id="r_valor4"<?= $Page->valor4->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_parametro_valor4"><?= $Page->valor4->caption() ?></span></td>
