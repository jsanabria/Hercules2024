...
// Page object
$ScoExpedienteSegurosAdjuntoPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { sco_expediente_seguros_adjunto: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->archivo->Visible) { // archivo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->archivo->headerCellClass() ?>"><div role="button" data-table="sco_expediente_seguros_adjunto" data-sort="<?= HtmlEncode($Page->archivo->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->archivo->getNextSort() ?>">
...
<?php if ($Page->nota->Visible) { // nota ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->nota->headerCellClass() ?>"><div role="button" data-table="sco_expediente_seguros_adjunto" data-sort="<?= HtmlEncode($Page->nota->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->nota->getNextSort() ?>">
            <div class="ew-table-header-btn">
