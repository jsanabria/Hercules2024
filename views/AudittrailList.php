...
?>
    <div id="xs_script" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->script->UseFilter ? " ew-filter-field" : "" ?>">
        <div class="d-flex my-1 my-sm-0">
            ...
            <div class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z_script" id="z_script" value="=">
</div>
        </div>
...
?>
    <div id="xs__table" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->_table->UseFilter ? " ew-filter-field" : "" ?>">
        <div class="d-flex my-1 my-sm-0">
            ...
            <div class="ew-search-operator">
<?= $Language->phrase("=") ?>
<input type="hidden" name="z__table" id="z__table" value="=">
</div>
        </div>
...
?>
    <div id="xs_field" class="col-sm-auto d-sm-flex align-items-start mb-3 px-0 pe-sm-2<?= $Page->field->UseFilter ? " ew-filter-field" : "" ?>">
        <div class="d-flex my-1 my-sm-0">
