...
// Page object
$ScoParcelaVentasNotaPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { sco_parcela_ventas_nota: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->nota->Visible) { // nota ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->nota->headerCellClass() ?>"><div role="button" data-table="sco_parcela_ventas_nota" data-sort="<?= HtmlEncode($Page->nota->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->nota->getNextSort() ?>">
...
<?php if ($Page->_username->Visible) { // username ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->_username->headerCellClass() ?>"><div role="button" data-table="sco_parcela_ventas_nota" data-sort="<?= HtmlEncode($Page->_username->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->_username->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->fecha_hora->Visible) { // fecha_hora ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->fecha_hora->headerCellClass() ?>"><div role="button" data-table="sco_parcela_ventas_nota" data-sort="<?= HtmlEncode($Page->fecha_hora->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->fecha_hora->getNextSort() ?>">
            <div class="ew-table-header-btn">
