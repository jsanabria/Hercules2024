...
// Page object
$ScoReclamoAdjuntoPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { sco_reclamo_adjunto: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->nota->Visible) { // nota ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->nota->headerCellClass() ?>"><div role="button" data-table="sco_reclamo_adjunto" data-sort="<?= HtmlEncode($Page->nota->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->nota->getNextSort() ?>">
...
<?php if ($Page->archivo->Visible) { // archivo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->archivo->headerCellClass() ?>"><div role="button" data-table="sco_reclamo_adjunto" data-sort="<?= HtmlEncode($Page->archivo->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->archivo->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->usuario->Visible) { // usuario ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->usuario->headerCellClass() ?>"><div role="button" data-table="sco_reclamo_adjunto" data-sort="<?= HtmlEncode($Page->usuario->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->usuario->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->fecha->Visible) { // fecha ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->fecha->headerCellClass() ?>"><div role="button" data-table="sco_reclamo_adjunto" data-sort="<?= HtmlEncode($Page->fecha->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->fecha->getNextSort() ?>">
            <div class="ew-table-header-btn">
