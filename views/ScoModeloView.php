...
<?php } ?>
<?php } ?>
<form name="fsco_modeloview" id="fsco_modeloview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->tipo->Visible) { // tipo ?>
    <tr id="r_tipo"<?= $Page->tipo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_modelo_tipo"><?= $Page->tipo->caption() ?></span></td>
...
<?php if ($Page->marca->Visible) { // marca ?>
    <tr id="r_marca"<?= $Page->marca->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_modelo_marca"><?= $Page->marca->caption() ?></span></td>
...
<?php if ($Page->nombre->Visible) { // nombre ?>
    <tr id="r_nombre"<?= $Page->nombre->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_modelo_nombre"><?= $Page->nombre->caption() ?></span></td>
...
<?php if ($Page->activo->Visible) { // activo ?>
    <tr id="r_activo"<?= $Page->activo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_sco_modelo_activo"><?= $Page->activo->caption() ?></span></td>
