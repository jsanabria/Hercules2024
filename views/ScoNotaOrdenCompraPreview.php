...
// Page object
$ScoNotaOrdenCompraPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { sco_nota_orden_compra: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->nota->Visible) { // nota ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->nota->headerCellClass() ?>"><div role="button" data-table="sco_nota_orden_compra" data-sort="<?= HtmlEncode($Page->nota->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->nota->getNextSort() ?>">
