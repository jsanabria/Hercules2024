...
<span id="el_userlevels_reserva">
    <select
        ...
        data-select2-id="fuserlevelsedit_x_reserva"
        <?php } ?>
...
loadjs.ready("fuserlevelsedit", function() {
    var options = { name: "x_reserva", selectId: "fuserlevelsedit_x_reserva" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fuserlevelsedit.lists.reserva?.lookupOptions.length) {
        options.data = { id: "x_reserva", form: "fuserlevelsedit" };
    } else {
        options.ajax = { id: "x_reserva", form: "fuserlevelsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_userlevels_indicador">
    <select
        ...
        data-select2-id="fuserlevelsedit_x_indicador"
        <?php } ?>
        data-table="userlevels"
...
<script>
loadjs.ready("fuserlevelsedit", function() {
    var options = { name: "x_indicador", selectId: "fuserlevelsedit_x_indicador" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fuserlevelsedit.lists.indicador?.lookupOptions.length) {
        options.data = { id: "x_indicador", form: "fuserlevelsedit" };
    } else {
        options.ajax = { id: "x_indicador", form: "fuserlevelsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_userlevels_tipo_proveedor">
    <select
        ...
        data-select2-id="fuserlevelsedit_x_tipo_proveedor"
        <?php } ?>
        data-table="userlevels"
...
<script>
loadjs.ready("fuserlevelsedit", function() {
    var options = { name: "x_tipo_proveedor", selectId: "fuserlevelsedit_x_tipo_proveedor" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fuserlevelsedit.lists.tipo_proveedor?.lookupOptions.length) {
        options.data = { id: "x_tipo_proveedor", form: "fuserlevelsedit" };
    } else {
        options.ajax = { id: "x_tipo_proveedor", form: "fuserlevelsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_userlevels_ver_alertas">
    <select
        ...
        data-select2-id="fuserlevelsedit_x_ver_alertas"
        <?php } ?>
        data-table="userlevels"
...
<script>
loadjs.ready("fuserlevelsedit", function() {
    var options = { name: "x_ver_alertas", selectId: "fuserlevelsedit_x_ver_alertas" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fuserlevelsedit.lists.ver_alertas?.lookupOptions.length) {
        options.data = { id: "x_ver_alertas", form: "fuserlevelsedit" };
    } else {
        options.ajax = { id: "x_ver_alertas", form: "fuserlevelsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_userlevels_financiero">
    <select
        ...
        data-select2-id="fuserlevelsedit_x_financiero"
        <?php } ?>
        data-table="userlevels"
...
<script>
loadjs.ready("fuserlevelsedit", function() {
    var options = { name: "x_financiero", selectId: "fuserlevelsedit_x_financiero" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fuserlevelsedit.lists.financiero?.lookupOptions.length) {
        options.data = { id: "x_financiero", form: "fuserlevelsedit" };
    } else {
        options.ajax = { id: "x_financiero", form: "fuserlevelsedit", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php
    if (in_array("sco_grupo_funciones", explode(",", $Page->getCurrentDetailTable())) && $sco_grupo_funciones->DetailEdit) {
?>
