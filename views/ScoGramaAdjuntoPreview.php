...
// Page object
$ScoGramaAdjuntoPreview = &$Page;
?>
<script>
ew.deepAssign(ew.vars, { tables: { sco_grama_adjunto: <?= JsonEncode($Page->toClientVar()) ?> } });
</script>
<script>
...
<?php if ($Page->archivo->Visible) { // archivo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->archivo->headerCellClass() ?>"><div role="button" data-table="sco_grama_adjunto" data-sort="<?= HtmlEncode($Page->archivo->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->archivo->getNextSort() ?>">
...
<?php if ($Page->nota->Visible) { // nota ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->nota->headerCellClass() ?>"><div role="button" data-table="sco_grama_adjunto" data-sort="<?= HtmlEncode($Page->nota->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->nota->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->fecha->Visible) { // fecha ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->fecha->headerCellClass() ?>"><div role="button" data-table="sco_grama_adjunto" data-sort="<?= HtmlEncode($Page->fecha->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->fecha->getNextSort() ?>">
            <div class="ew-table-header-btn">
...
<?php if ($Page->activo->Visible) { // activo ?>
    ...
    <?php } else { ?>
        <th class="<?= $Page->activo->headerCellClass() ?>"><div role="button" data-table="sco_grama_adjunto" data-sort="<?= HtmlEncode($Page->activo->Name) ?>" data-sort-type="1" data-sort-order="<?= $Page->activo->getNextSort() ?>">
            <div class="ew-table-header-btn">
