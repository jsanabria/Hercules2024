...
var currentForm;
var fsco_expediente_segurosadd;
loadjs.ready(["wrapper", "head"], function () {
    ...
    let form = new ew.FormBuilder()
        .setId("fsco_expediente_segurosadd")
        .setPageId("add")
...
$Page->showMessage();
?>
<form name="fsco_expediente_segurosadd" id="fsco_expediente_segurosadd" class="<?= $Page->FormClassName ?>" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
...
<span id="el_sco_expediente_seguros_seguro">
    <select
        ...
        data-select2-id="fsco_expediente_segurosadd_x_seguro"
...
<script>
loadjs.ready("fsco_expediente_segurosadd", function() {
    var options = { name: "x_seguro", selectId: "fsco_expediente_segurosadd_x_seguro" };
    if (fsco_expediente_segurosadd.lists.seguro?.lookupOptions.length) {
        options.data = { id: "x_seguro", form: "fsco_expediente_segurosadd" };
    } else {
        options.ajax = { id: "x_seguro", form: "fsco_expediente_segurosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_sco_expediente_seguros_parentesco_contacto">
    <select
        ...
        data-select2-id="fsco_expediente_segurosadd_x_parentesco_contacto"
        <?php } ?>
        data-table="sco_expediente_seguros"
...
<script>
loadjs.ready("fsco_expediente_segurosadd", function() {
    var options = { name: "x_parentesco_contacto", selectId: "fsco_expediente_segurosadd_x_parentesco_contacto" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_expediente_segurosadd.lists.parentesco_contacto?.lookupOptions.length) {
        options.data = { id: "x_parentesco_contacto", form: "fsco_expediente_segurosadd" };
    } else {
        options.ajax = { id: "x_parentesco_contacto", form: "fsco_expediente_segurosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
...
<span id="el_sco_expediente_seguros_sexo">
    <select
        ...
        data-select2-id="fsco_expediente_segurosadd_x_sexo"
        <?php } ?>
        data-table="sco_expediente_seguros"
        data-field="x_sexo"
...
<script>
loadjs.ready("fsco_expediente_segurosadd", function() {
    var options = { name: "x_sexo", selectId: "fsco_expediente_segurosadd_x_sexo" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_expediente_segurosadd.lists.sexo?.lookupOptions.length) {
        options.data = { id: "x_sexo", form: "fsco_expediente_segurosadd" };
    } else {
        options.ajax = { id: "x_sexo", form: "fsco_expediente_segurosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<script>
loadjs.ready(["fsco_expediente_segurosadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsco_expediente_segurosadd", "x_fecha_nacimiento", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_sco_expediente_seguros_lugar_ocurrencia">
    <select
        ...
        data-select2-id="fsco_expediente_segurosadd_x_lugar_ocurrencia"
        <?php } ?>
        data-table="sco_expediente_seguros"
...
<script>
loadjs.ready("fsco_expediente_segurosadd", function() {
    var options = { name: "x_lugar_ocurrencia", selectId: "fsco_expediente_segurosadd_x_lugar_ocurrencia" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_expediente_segurosadd.lists.lugar_ocurrencia?.lookupOptions.length) {
        options.data = { id: "x_lugar_ocurrencia", form: "fsco_expediente_segurosadd" };
    } else {
        options.ajax = { id: "x_lugar_ocurrencia", form: "fsco_expediente_segurosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
loadjs.ready(["fsco_expediente_segurosadd", "datetimepicker"], function () {
    ...
    ew.createDateTimePicker("fsco_expediente_segurosadd", "x_fecha_ocurrencia", ew.deepAssign({"useCurrent":false,"display":{"sideBySide":false}}, options));
});
</script>
<?php } ?>
</span>
...
<span id="el_sco_expediente_seguros_causa_ocurrencia">
    <select
        ...
        data-select2-id="fsco_expediente_segurosadd_x_causa_ocurrencia"
        <?php } ?>
        data-table="sco_expediente_seguros"
...
<script>
loadjs.ready("fsco_expediente_segurosadd", function() {
    var options = { name: "x_causa_ocurrencia", selectId: "fsco_expediente_segurosadd_x_causa_ocurrencia" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_expediente_segurosadd.lists.causa_ocurrencia?.lookupOptions.length) {
        options.data = { id: "x_causa_ocurrencia", form: "fsco_expediente_segurosadd" };
    } else {
        options.ajax = { id: "x_causa_ocurrencia", form: "fsco_expediente_segurosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_sco_expediente_seguros_religion">
    <select
        ...
        data-select2-id="fsco_expediente_segurosadd_x_religion"
        <?php } ?>
        data-table="sco_expediente_seguros"
...
<script>
loadjs.ready("fsco_expediente_segurosadd", function() {
    var options = { name: "x_religion", selectId: "fsco_expediente_segurosadd_x_religion" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_expediente_segurosadd.lists.religion?.lookupOptions.length) {
        options.data = { id: "x_religion", form: "fsco_expediente_segurosadd" };
    } else {
        options.ajax = { id: "x_religion", form: "fsco_expediente_segurosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_sco_expediente_seguros_servicio_tipo">
    <select
        ...
        data-select2-id="fsco_expediente_segurosadd_x_servicio_tipo"
        <?php } ?>
        data-table="sco_expediente_seguros"
...
<script>
loadjs.ready("fsco_expediente_segurosadd", function() {
    var options = { name: "x_servicio_tipo", selectId: "fsco_expediente_segurosadd_x_servicio_tipo" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_expediente_segurosadd.lists.servicio_tipo?.lookupOptions.length) {
        options.data = { id: "x_servicio_tipo", form: "fsco_expediente_segurosadd" };
    } else {
        options.ajax = { id: "x_servicio_tipo", form: "fsco_expediente_segurosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_sco_expediente_seguros_servicio">
    <select
        ...
        data-select2-id="fsco_expediente_segurosadd_x_servicio"
        <?php } ?>
        data-table="sco_expediente_seguros"
...
<script>
loadjs.ready("fsco_expediente_segurosadd", function() {
    var options = { name: "x_servicio", selectId: "fsco_expediente_segurosadd_x_servicio" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_expediente_segurosadd.lists.servicio?.lookupOptions.length) {
        options.data = { id: "x_servicio", form: "fsco_expediente_segurosadd" };
    } else {
        options.ajax = { id: "x_servicio", form: "fsco_expediente_segurosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<span id="el_sco_expediente_seguros_funeraria">
    <select
        ...
        data-select2-id="fsco_expediente_segurosadd_x_funeraria"
        <?php } ?>
        data-table="sco_expediente_seguros"
...
<script>
loadjs.ready("fsco_expediente_segurosadd", function() {
    var options = { name: "x_funeraria", selectId: "fsco_expediente_segurosadd_x_funeraria" },
        el = document.querySelector("select[data-select2-id='" + options.selectId + "']");
    if (!el)
        return;
    options.closeOnSelect = !options.multiple;
    options.dropdownParent = el.closest("#ew-modal-dialog, #ew-add-opt-dialog");
    if (fsco_expediente_segurosadd.lists.funeraria?.lookupOptions.length) {
        options.data = { id: "x_funeraria", form: "fsco_expediente_segurosadd" };
    } else {
        options.ajax = { id: "x_funeraria", form: "fsco_expediente_segurosadd", limit: ew.LOOKUP_PAGE_SIZE };
    }
    options.minimumResultsForSearch = Infinity;
...
<?php
    if (in_array("sco_expediente_seguros_adjunto", explode(",", $Page->getCurrentDetailTable())) && $sco_expediente_seguros_adjunto->DetailAdd) {
?>
...
<button class="btn btn-primary ew-btn" name="btn-action" id="btn-action" type="submit" form="fsco_expediente_segurosadd"><?= $Language->phrase("AddBtn") ?></button>
<?php if (IsJsonResponse()) { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" data-bs-dismiss="modal"><?= $Language->phrase("CancelBtn") ?></button>
<?php } else { ?>
<button class="btn btn-default ew-btn" name="btn-cancel" id="btn-cancel" type="button" form="fsco_expediente_segurosadd" data-href="<?= HtmlEncode(GetUrl($Page->getReturnUrl())) ?>"><?= $Language->phrase("CancelBtn") ?></button>
<?php } ?>
    </div><!-- /buttons offset -->
