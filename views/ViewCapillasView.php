...
<?php } ?>
<?php } ?>
<form name="fview_capillasview" id="fview_capillasview" class="ew-form ew-view-form overlay-wrapper" action="<?= CurrentPageUrl(false) ?>" method="post" novalidate autocomplete="off">
<?php if (!$Page->isExport()) { ?>
<script>
...
<?php if ($Page->tipo->Visible) { // tipo ?>
    <tr id="r_tipo"<?= $Page->tipo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_capillas_tipo"><?= $Page->tipo->caption() ?></span></td>
...
<?php if ($Page->Nservicio->Visible) { // Nservicio ?>
    <tr id="r_Nservicio"<?= $Page->Nservicio->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_capillas_Nservicio"><?= $Page->Nservicio->caption() ?></span></td>
...
<?php if ($Page->nombre->Visible) { // nombre ?>
    <tr id="r_nombre"<?= $Page->nombre->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_capillas_nombre"><?= $Page->nombre->caption() ?></span></td>
...
<?php if ($Page->secuencia->Visible) { // secuencia ?>
    <tr id="r_secuencia"<?= $Page->secuencia->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_capillas_secuencia"><?= $Page->secuencia->caption() ?></span></td>
...
<?php if ($Page->activo->Visible) { // activo ?>
    <tr id="r_activo"<?= $Page->activo->rowAttributes() ?>>
        <td class="<?= $Page->TableLeftColumnClass ?>"><span id="elh_view_capillas_activo"><?= $Page->activo->caption() ?></span></td>
