...
$nota = "Yo, ________________________________________________________, venezolano (a), legalmente hábil, y titular de la Cedula de Identidad No. _____________________, declaro que los restos mortales de mi familiar Sr.(a) " . strtoupper($row["nombre_fallecido"] . " " . $row["apellidos_fallecido"]) . " titular de la cédula de identidad No. " . $row["cedula_fallecido"] . " , serán cremados a las " . $row["hora_fin"] . " del día " . $row["fecha_fin"] . ".";
$nota = $nota;
$pdf->Cell(10);
$pdf->MultiCell(190,6,$nota,0,'J');
$pdf->Ln();

$nota = "Asimismo, hago constar que me despedí y realicé el reconocimiento de mi familiar (máximo 2 familiares) y nuevamente autorizo a KAUFMAN BIO INCINERACIONES, C.A. ha realizar el proceso cremación.";
$nota = $nota;
$pdf->Cell(10);
$pdf->MultiCell(190,6,$nota,0,'J');
$pdf->Ln();
...
$nota = "Igualmente declaro que: 1) En el cuerpo del difunto(a) " . ($row["marca_pasos"]=="S"?"*** SI tiene alojado MARCAPASOS ***. ":"no tiene marcapasos, prótesis o cualquier sistema de energía que funcione con mercurio u otro material que ponga en riesgo a los operadores y a los equipos. ");
$nota .= "2) Dicho cuerpo no está sometido a un proceso de investigación penal o científica. ";
$nota .= "3) El difunto(a) no ha sido tratado con nitroglicerina en un lapso de tres (3) días antes de su fallecimiento. ";
$nota .= "4) El difunto(a) tiene un peso corporal menor a cien (100) Kilos, y que en caso contrario debo pagar un monto adicional por el proceso de cremación. Peso declarado: " . strtoupper($row["peso"]) . ". ";
$nota .= "5) Que las cenizas se entregan veinticuatro (24) horas después de concluido el acto de cremación en horario comprendido entre las 08:00am a 3:30pm de lunes a viernes. ";
$nota .= "6) Todos los objetos de valor sentimental o económico que traiga el difunto(a) deberán ser retirados conjuntamente con las cenizas, en caso contrario la empresa los resguardará por lapso de dos (2) semanas contadas a partir del día en que debían haberse retirado las cenizas. ";
$nota .= "7) Para las cremaciones directas sin velación no se realizan arreglos estéticos ni de vestimenta. ";
$nota = $nota;
$pdf->Cell(10);
$pdf->MultiCell(190,6,$nota,0,'J');
$pdf->Ln();
