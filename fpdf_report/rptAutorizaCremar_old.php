...
$nota = "Yo, ______________________________________________________________________________________ titular de la Cédula de Identidad No., ___________________________________ Hago constar que los restos mortales de mi familiar Sr.(a) " . strtoupper($row["nombre_fallecido"] . " " . $row["apellidos_fallecido"]) . " titular de la cédula de identidad No., " . $row["cedula_fallecido"] . " van a ser cremados a las " . $row["hora_fin"] . " del día " . $row["fecha_fin"] . ".";
$nota = $nota;
$pdf->Cell(10);
$pdf->MultiCell(190,6,$nota,0,'J');
$pdf->Ln();

$nota = "Asimismo, hago constar que ya me despedí, realicé el reconocimiento de mi difunto y autorizo a Kaufman Bio Incineraciones, C.A. para que realice el proceso de la cremación.";
$nota = $nota;
$pdf->Cell(10);
$pdf->MultiCell(190,6,$nota,0,'J');
$pdf->Ln();
...
$nota = "Declaro que mi familiar " . ($row["marca_pasos"]=="S"?"*** SI tiene MARCAPASOS ***":"--- NO tiene MARCAPASOS ---");
$nota = $nota;
$pdf->Cell(10);
$pdf->MultiCell(190,6,$nota,0,'C');
$pdf->Ln();
...
$pdf->Cell(60,6);
$pdf->Cell(60,6,"Operador del Equipo",0,0,'C');
$pdf->Ln(10);
...
$pdf->Cell(80,6,$nombre_usuario,0,0,'C');
$pdf->Ln(8);
$pdf->Cell(80,6,"Gerencia de Servicios",0,0,'C');
$pdf->Cell(60,6);
$pdf->Cell(60,6,"Funeraria Monumental",0,0,'C');
$pdf->Ln(10);
...
$pdf->Cell(80,6,"Seguridad",0,0,'C');
$pdf->Ln(10);
$pdf->Cell(80,6,"C.I. No. _____________________",0,0,'C');


$pdf->Line(13, 188, 70, 188);
$pdf->Rect(90, 175, 33, 35);
