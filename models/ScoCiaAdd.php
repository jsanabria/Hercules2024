 ...
 * Page class
 */
class ScoCiaAdd extends ScoCia
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCiaAdd";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (($keyValue = Get("Ncia") ?? Route("Ncia")) !== null) {
                $this->Ncia->setQueryStringValue($keyValue);
            }
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ScoCiaList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ScoCiaList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ScoCiaView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ScoCiaList") {
                            ...
                            $returnUrl = "ScoCiaList"; // Return list page content
                        }
                    }
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'Ncia' first before field var 'x_Ncia'
        $val = $CurrentForm->hasValue("Ncia") ? $CurrentForm->getValue("Ncia") : $CurrentForm->getValue("x_Ncia");
    }
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->servicio->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter($this->servicio->Lookup->getTable()->Fields["Nservicio_tipo"]->searchExpression(), "=", $this->servicio->CurrentValue, $this->servicio->Lookup->getTable()->Fields["Nservicio_tipo"]->searchDataType(), "");
                }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoCiaList"), "", $this->TableVar, true);
