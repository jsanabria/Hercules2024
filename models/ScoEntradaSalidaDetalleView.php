 ...
 * Page class
 */
class ScoEntradaSalidaDetalleView extends ScoEntradaSalidaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEntradaSalidaDetalleView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoEntradaSalidaDetalleView";
    ...
    {
        $this->Nentrada_salida_detalle->setVisibility();
        $this->entrada_salida->setVisibility();
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Nentrada_salida_detalle") ?? Route("Nentrada_salida_detalle")) !== null) {
            $this->RecKey["Nentrada_salida_detalle"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nentrada_salida_detalle") ?? Route("Nentrada_salida_detalle")) !== null) {
            ...
            $this->RecKey["Nentrada_salida_detalle"] = $this->Nentrada_salida_detalle->QueryStringValue;
        } elseif (Post("Nentrada_salida_detalle") !== null) {
            $this->Nentrada_salida_detalle->setFormValue(Post("Nentrada_salida_detalle"));
            $this->RecKey["Nentrada_salida_detalle"] = $this->Nentrada_salida_detalle->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nentrada_salida_detalle->setQueryStringValue($keyValue);
            $this->RecKey["Nentrada_salida_detalle"] = $this->Nentrada_salida_detalle->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoEntradaSalidaDetalleList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoEntradaSalidaDetalleList"; // No matching record, return to list
                    } else {
