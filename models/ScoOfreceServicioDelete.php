 ...
 * Page class
 */
class ScoOfreceServicioDelete extends ScoOfreceServicio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOfreceServicioDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOfreceServicioDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoOfreceServicioList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoOfreceServicioList"); // Return to list
                return;
            }
        }
