 ...
 * Page class
 */
class ScoEntradaSalidaDelete extends ScoEntradaSalida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEntradaSalidaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoEntradaSalidaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoEntradaSalidaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoEntradaSalidaList"); // Return to list
                return;
            }
        }
