 ...
 * Page class
 */
class ScoArticuloDelete extends ScoArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoArticuloDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoArticuloDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoArticuloList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoArticuloList"); // Return to list
                return;
            }
        }
