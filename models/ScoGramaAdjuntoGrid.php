 ...
 * Page class
 */
class ScoGramaAdjuntoGrid extends ScoGramaAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaAdjuntoGrid";
    ...
    public $FormName = "fsco_grama_adjuntogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoGramaAdjuntoGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "sco_grama") {
            $this->grama->Visible = true; // Need to insert foreign key
            $this->grama->CurrentValue = $this->grama->getSessionValue();
        }
