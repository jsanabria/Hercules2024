 ...
 * Page class
 */
class AutogestionPlantillasAdd extends AutogestionPlantillas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AutogestionPlantillasAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "AutogestionPlantillasAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "AutogestionPlantillasView") {
    ...
    protected function getAddRow()
    {
        ...
        // orden
        $this->orden->setDbValueDef($rsnew, $this->orden->CurrentValue, false);
        ...
        // mostrar
        $this->mostrar->setDbValueDef($rsnew, $this->mostrar->CurrentValue, false);
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['orden'])) { // orden
            $this->orden->setFormValue($row['orden']);
        }
