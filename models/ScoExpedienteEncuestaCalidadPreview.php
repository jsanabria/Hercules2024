 ...
 * Page class
 */
class ScoExpedienteEncuestaCalidadPreview extends ScoExpedienteEncuestaCalidad
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteEncuestaCalidadPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteEncuestaCalidadPreview";
