...
class UserlevelsAdd extends Userlevels
{
    ...
    {
        $this->color->DefaultValue = $this->color->getDefault(); // PHP
        $this->color->OldValue = $this->color->DefaultValue;
        $this->reserva->DefaultValue = $this->reserva->getDefault(); // PHP
        $this->reserva->OldValue = $this->reserva->DefaultValue;
        $this->indicador->DefaultValue = $this->indicador->getDefault(); // PHP
        $this->indicador->OldValue = $this->indicador->DefaultValue;
        $this->tipo_proveedor->DefaultValue = $this->tipo_proveedor->getDefault(); // PHP
        $this->tipo_proveedor->OldValue = $this->tipo_proveedor->DefaultValue;
        $this->ver_alertas->DefaultValue = $this->ver_alertas->getDefault(); // PHP
        $this->ver_alertas->OldValue = $this->ver_alertas->DefaultValue;
        $this->financiero->DefaultValue = $this->financiero->getDefault(); // PHP
        $this->financiero->OldValue = $this->financiero->DefaultValue;
    }
    ...
    protected function validateForm()
    {
        ...
        if (in_array("sco_grupo_funciones", $detailTblVar) && $detailPage->DetailAdd) {
            $detailPage->run();
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("ScoGrupoFuncionesGrid");
            if (in_array("sco_grupo_funciones", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
    ...
    protected function getAddRow()
    {
        ...
        // reserva
        $this->reserva->setDbValueDef($rsnew, $this->reserva->CurrentValue, strval($this->reserva->CurrentValue) == "");

        // indicador
        $this->indicador->setDbValueDef($rsnew, $this->indicador->CurrentValue, strval($this->indicador->CurrentValue) == "");

        // tipo_proveedor
        $this->tipo_proveedor->setDbValueDef($rsnew, $this->tipo_proveedor->CurrentValue, strval($this->tipo_proveedor->CurrentValue) == "");

        // ver_alertas
        $this->ver_alertas->setDbValueDef($rsnew, $this->ver_alertas->CurrentValue, strval($this->ver_alertas->CurrentValue) == "");

        // financiero
        $this->financiero->setDbValueDef($rsnew, $this->financiero->CurrentValue, strval($this->financiero->CurrentValue) == "");
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['reserva'])) { // reserva
            $this->reserva->setFormValue($row['reserva']);
        }
        ...
        if (isset($row['ver_alertas'])) { // ver_alertas
            $this->ver_alertas->setFormValue($row['ver_alertas']);
        }
        if (isset($row['financiero'])) { // financiero
            $this->financiero->setFormValue($row['financiero']);
        }
    }
