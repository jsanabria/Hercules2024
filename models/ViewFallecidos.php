...
/**
 * Table class for view_fallecidos
 */
class ViewFallecidos extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_fallecidos";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_fallecidos";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewFallecidosList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewFallecidosView" => $Language->phrase("View"),
            "ViewFallecidosEdit" => $Language->phrase("Edit"),
            "ViewFallecidosAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewFallecidosView",
            Config("API_ADD_ACTION") => "ViewFallecidosAdd",
            Config("API_EDIT_ACTION") => "ViewFallecidosEdit",
            Config("API_DELETE_ACTION") => "ViewFallecidosDelete",
            Config("API_LIST_ACTION") => "ViewFallecidosList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewFallecidosView", $parm);
        } else {
            $url = $this->keyUrl("ViewFallecidosView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewFallecidosAdd?" . $parm;
        } else {
            $url = "ViewFallecidosAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFallecidosEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFallecidosList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFallecidosAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewFallecidosList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewFallecidosDelete", $parm);
        }
    }
