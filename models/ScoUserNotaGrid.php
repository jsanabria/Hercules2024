 ...
 * Page class
 */
class ScoUserNotaGrid extends ScoUserNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoUserNotaGrid";
    ...
    public $FormName = "fsco_user_notagrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoUserNotaGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nuser_nota->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->user->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->user->setFormValue($val, true, $validate);
            }
        }
        ...
        // Check field name 'Nuser_nota' first before field var 'x_Nuser_nota'
        $val = $CurrentForm->hasValue("Nuser_nota") ? $CurrentForm->getValue("Nuser_nota") : $CurrentForm->getValue("x_Nuser_nota");
        if (!$this->Nuser_nota->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->Nuser_nota->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->Nuser_nota->CurrentValue = $this->Nuser_nota->FormValue;
        }
    ...
    protected function editRow()
    {
        ...
        // Check referential integrity for master table 'sco_user'
        $detailKeys = [];
        $keyValue = $rsnew['user'] ?? $rsold['user'];
        $detailKeys['user'] = $keyValue;
        ...
        if (!$validMasterRecord) {
            $relatedRecordMsg = str_replace("%t", "sco_user", $Language->phrase("RelatedRecordRequired"));
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'sco_user_nota'
