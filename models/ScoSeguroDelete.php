 ...
 * Page class
 */
class ScoSeguroDelete extends ScoSeguro
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoSeguroDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoSeguroDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoSeguroList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoSeguroList"); // Return to list
                return;
            }
        }
