 ...
 * Page class
 */
class ScoParcelaDelete extends ScoParcela
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoParcelaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoParcelaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoParcelaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoParcelaList"); // Return to list
                return;
            }
        }
