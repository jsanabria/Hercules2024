 ...
 * Page class
 */
class ScoCostosTarifaDetallePreview extends ScoCostosTarifaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCostosTarifaDetallePreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCostosTarifaDetallePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sco_costos_tarifa") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_costos_tarifa&" . GetForeignKeyUrl("fk_Ncostos_tarifa", $this->costos_tarifa->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "sco_costos_tarifa") {
            $this->costos_tarifa->setQueryStringValue($keys[0] ?? "");
        }
    }
