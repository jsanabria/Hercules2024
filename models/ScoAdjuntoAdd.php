 ...
 * Page class
 */
class ScoAdjuntoAdd extends ScoAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoAdjuntoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoAdjuntoAdd";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (($keyValue = Get("Nadjunto") ?? Route("Nadjunto")) !== null) {
                $this->Nadjunto->setQueryStringValue($keyValue);
            }
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ScoAdjuntoList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ScoAdjuntoList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ScoAdjuntoView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ScoAdjuntoList") {
                            ...
                            $returnUrl = "ScoAdjuntoList"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        // flota_incidencia
        $this->flota_incidencia->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoAdjuntoList"), "", $this->TableVar, true);
