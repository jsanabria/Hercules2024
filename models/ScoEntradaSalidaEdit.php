 ...
 * Page class
 */
class ScoEntradaSalidaEdit extends ScoEntradaSalida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEntradaSalidaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoEntradaSalidaEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("Nentrada_salida") ?? Key(0) ?? Route(2)) !== null) {
                $this->Nentrada_salida->setQueryStringValue($keyValue);
                $this->Nentrada_salida->setOldValue($this->Nentrada_salida->QueryStringValue);
            } elseif (Post("Nentrada_salida") !== null) {
                $this->Nentrada_salida->setFormValue(Post("Nentrada_salida"));
                $this->Nentrada_salida->setOldValue($this->Nentrada_salida->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("Nentrada_salida") ?? Route("Nentrada_salida")) !== null) {
                    ...
                    $this->Nentrada_salida->CurrentValue = null;
                }
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->Nentrada_salida->IsDetailKey) {
            $this->Nentrada_salida->setFormValue($val);
        }
    }
    ...
    {
        global $CurrentForm;
        $this->Nentrada_salida->CurrentValue = $this->Nentrada_salida->FormValue;
    ...
    protected function validateForm()
    {
        ...
        if (in_array("sco_entrada_salida_detalle", $detailTblVar) && $detailPage->DetailEdit) {
            $detailPage->run();
    ...
    protected function editRow()
    {
        ...
        if ($updateRow) {
            ...
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("ScoEntradaSalidaDetalleGrid");
            if (in_array("sco_entrada_salida_detalle", $detailTblVar) && $detailPage->DetailEdit && $editRow) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // tipo_doc
        $this->tipo_doc->setDbValueDef($rsnew, $this->tipo_doc->CurrentValue, $this->tipo_doc->ReadOnly);

        // proveedor
        $this->proveedor->setDbValueDef($rsnew, $this->proveedor->CurrentValue, $this->proveedor->ReadOnly);

        // clasificacion
        $this->clasificacion->setDbValueDef($rsnew, $this->clasificacion->CurrentValue, $this->clasificacion->ReadOnly);
