 ...
 * Page class
 */
class ScoGramaNotaGrid extends ScoGramaNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaNotaGrid";
    ...
    public $FormName = "fsco_grama_notagrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoGramaNotaGrid";
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'Nnota' first before field var 'x_Nnota'
        $val = $CurrentForm->hasValue("Nnota") ? $CurrentForm->getValue("Nnota") : $CurrentForm->getValue("x_Nnota");
        if (!$this->Nnota->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->Nnota->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->Nnota->CurrentValue = $this->Nnota->FormValue;
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        // Check referential integrity for master table 'sco_grama_nota'
