 ...
 * Page class
 */
class ScoReservaOldAdd extends ScoReservaOld
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoReservaOldAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoReservaOldAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoReservaOldView") {
    ...
    protected function getAddRow()
    {
        ...
        // hora
        $this->hora->setDbValueDef($rsnew, UnFormatDateTime($this->hora->CurrentValue, $this->hora->formatPattern()), false);
