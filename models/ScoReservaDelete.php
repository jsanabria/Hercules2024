 ...
 * Page class
 */
class ScoReservaDelete extends ScoReserva
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoReservaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoReservaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoReservaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoReservaList"); // Return to list
                return;
            }
        }
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoReservaList"), "", $this->TableVar, true);
        $pageId = "delete";
