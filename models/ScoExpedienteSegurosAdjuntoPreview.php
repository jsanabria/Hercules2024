 ...
 * Page class
 */
class ScoExpedienteSegurosAdjuntoPreview extends ScoExpedienteSegurosAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteSegurosAdjuntoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteSegurosAdjuntoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sco_expediente_seguros") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_expediente_seguros&" . GetForeignKeyUrl("fk_Nexpediente_seguros", $this->expediente_seguros->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "sco_expediente_seguros") {
            $this->expediente_seguros->setQueryStringValue($keys[0] ?? "");
        }
    }
