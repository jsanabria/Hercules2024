 ...
 * Page class
 */
class ScoParcelaVentasNotaPreview extends ScoParcelaVentasNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoParcelaVentasNotaPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoParcelaVentasNotaPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sco_parcela_ventas") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_parcela_ventas&" . GetForeignKeyUrl("fk_Nparcela_ventas", $this->parcela_ventas->QueryStringValue) . "";
        }
        if ($masterTblVar == "view_parcela_ventas") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_parcela_ventas&" . GetForeignKeyUrl("fk_Nparcela_ventas", $this->parcela_ventas->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "sco_parcela_ventas") {
            $this->parcela_ventas->setQueryStringValue($keys[0] ?? "");
        }
        if ($masterTblVar == "view_parcela_ventas") {
            $this->parcela_ventas->setQueryStringValue($keys[0] ?? "");
        }
