...
/**
 * Table class for sco_lapidas
 */
class ScoLapidas extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "sco_lapidas";
        $this->TableName = 'sco_lapidas';
        $this->TableType = "TABLE";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "sco_lapidas";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        // Nlapidas
        $this->Nlapidas = new DbField(
            $this, // Table
            'x_Nlapidas', // Variable name
            'Nlapidas', // Name
            '`Nlapidas`', // Expression
            '`Nlapidas`', // Basic search expression
            3, // Type
            11, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Nlapidas`', // Virtual expression
            false, // Is virtual
        ...
        $this->Nlapidas->InputTextType = "text";
        $this->Nlapidas->Raw = true;
        $this->Nlapidas->IsAutoIncrement = true; // Autoincrement field
        $this->Nlapidas->IsPrimaryKey = true; // Primary key field
        $this->Nlapidas->Nullable = false; // NOT NULL field
        $this->Nlapidas->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Nlapidas->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['Nlapidas'] = &$this->Nlapidas;
        ...
        // instalacion
        $this->instalacion = new DbField(
            $this, // Table
            'x_instalacion', // Variable name
            'instalacion', // Name
            '`instalacion`', // Expression
            '`instalacion`', // Basic search expression
            200, // Type
            100, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`instalacion`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->instalacion->InputTextType = "text";
        $this->instalacion->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['instalacion'] = &$this->instalacion;

        // nota1
        $this->nota1 = new DbField(
            $this, // Table
            'x_nota1', // Variable name
            'nota1', // Name
            '`nota1`', // Expression
            '`nota1`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nota1`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nota1->InputTextType = "text";
        $this->nota1->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['nota1'] = &$this->nota1;
        ...
        // nota2
        $this->nota2 = new DbField(
            $this, // Table
            'x_nota2', // Variable name
            'nota2', // Name
            '`nota2`', // Expression
            '`nota2`', // Basic search expression
            200, // Type
            255, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`nota2`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->nota2->InputTextType = "text";
        $this->nota2->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['nota2'] = &$this->nota2;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "sco_lapidas";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->Nlapidas->setDbValue($conn->lastInsertId());
            $rs['Nlapidas'] = $this->Nlapidas->DbValue;
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['Nlapidas']) && !EmptyValue($this->Nlapidas->CurrentValue)) {
                $rs['Nlapidas'] = $this->Nlapidas->CurrentValue;
            }
        }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('Nlapidas', $rs)) {
                AddFilter($where, QuotedName('Nlapidas', $this->Dbid) . '=' . QuotedValue($rs['Nlapidas'], $this->Nlapidas->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->Nlapidas->DbValue = $row['Nlapidas'];
        ...
        $this->instalacion->DbValue = $row['instalacion'];
        $this->nota1->DbValue = $row['nota1'];
        $this->cliente->DbValue = $row['cliente'];
        $this->nota2->DbValue = $row['nota2'];
    ...
    {
        $keys = [];
        $val = $current ? $this->Nlapidas->CurrentValue : $this->Nlapidas->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->Nlapidas->CurrentValue = $keys[0];
            } else {
                $this->Nlapidas->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('Nlapidas', $row) ? $row['Nlapidas'] : null;
        } else {
            $val = !EmptyValue($this->Nlapidas->OldValue) && !$current ? $this->Nlapidas->OldValue : $this->Nlapidas->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@Nlapidas@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ScoLapidasList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ScoLapidasView" => $Language->phrase("View"),
            "ScoLapidasEdit" => $Language->phrase("Edit"),
            "ScoLapidasAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ScoLapidasView",
            Config("API_ADD_ACTION") => "ScoLapidasAdd",
            Config("API_EDIT_ACTION") => "ScoLapidasEdit",
            Config("API_DELETE_ACTION") => "ScoLapidasDelete",
            Config("API_LIST_ACTION") => "ScoLapidasList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ScoLapidasView", $parm);
        } else {
            $url = $this->keyUrl("ScoLapidasView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoLapidasEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoLapidasList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoLapidasAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoLapidasList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ScoLapidasDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"Nlapidas\":" . VarToJson($this->Nlapidas->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    {
        if ($this->Nlapidas->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->Nlapidas->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("Nlapidas") ?? Route("Nlapidas")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->Nlapidas->CurrentValue = $key;
            } else {
                $this->Nlapidas->OldValue = $key;
            }
    ...
    public function loadListRowValues(&$rs)
    {
        ...
        $this->Nlapidas->setDbValue($row['Nlapidas']);
        ...
        $this->instalacion->setDbValue($row['instalacion']);
        $this->nota1->setDbValue($row['nota1']);
        $this->cliente->setDbValue($row['cliente']);
        $this->nota2->setDbValue($row['nota2']);
    ...
    public function renderListRow()
    {
        ...
        // Nlapidas
        $this->Nlapidas->ViewValue = $this->Nlapidas->CurrentValue;
        ...
        // instalacion
        $this->instalacion->ViewValue = $this->instalacion->CurrentValue;

        // nota1
        $this->nota1->ViewValue = $this->nota1->CurrentValue;

        // cliente
        $this->cliente->ViewValue = $this->cliente->CurrentValue;

        // nota2
        $this->nota2->ViewValue = $this->nota2->CurrentValue;

        // difunto
        $this->difunto->ViewValue = $this->difunto->CurrentValue;

        // Nlapidas
        $this->Nlapidas->HrefValue = "";
        $this->Nlapidas->TooltipValue = "";
        ...
        // instalacion
        $this->instalacion->HrefValue = "";
        $this->instalacion->TooltipValue = "";

        // nota1
        $this->nota1->HrefValue = "";
        $this->nota1->TooltipValue = "";
        ...
        // nota2
        $this->nota2->HrefValue = "";
        $this->nota2->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        // Nlapidas
        $this->Nlapidas->setupEditAttributes();
        $this->Nlapidas->EditValue = $this->Nlapidas->CurrentValue;
        ...
        // instalacion
        $this->instalacion->setupEditAttributes();
        if (!$this->instalacion->Raw) {
            $this->instalacion->CurrentValue = HtmlDecode($this->instalacion->CurrentValue);
        }
        $this->instalacion->EditValue = $this->instalacion->CurrentValue;
        $this->instalacion->PlaceHolder = RemoveHtml($this->instalacion->caption());

        // nota1
        $this->nota1->setupEditAttributes();
        if (!$this->nota1->Raw) {
            $this->nota1->CurrentValue = HtmlDecode($this->nota1->CurrentValue);
        }
        $this->nota1->EditValue = $this->nota1->CurrentValue;
        $this->nota1->PlaceHolder = RemoveHtml($this->nota1->caption());
        ...
        // nota2
        $this->nota2->setupEditAttributes();
        if (!$this->nota2->Raw) {
            $this->nota2->CurrentValue = HtmlDecode($this->nota2->CurrentValue);
        }
        $this->nota2->EditValue = $this->nota2->CurrentValue;
        $this->nota2->PlaceHolder = RemoveHtml($this->nota2->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->instalacion);
                    $doc->exportCaption($this->nota1);
                    $doc->exportCaption($this->cliente);
                    $doc->exportCaption($this->nota2);
                    $doc->exportCaption($this->difunto);
                } else {
                    $doc->exportCaption($this->Nlapidas);
                    $doc->exportCaption($this->fecha);
                    $doc->exportCaption($this->seccion);
                    $doc->exportCaption($this->modulo);
                    $doc->exportCaption($this->subseccion);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->instalacion);
                        $doc->exportField($this->nota1);
                        $doc->exportField($this->cliente);
                        $doc->exportField($this->nota2);
                        $doc->exportField($this->difunto);
                    } else {
                        $doc->exportField($this->Nlapidas);
                        $doc->exportField($this->fecha);
                        $doc->exportField($this->seccion);
                        $doc->exportField($this->modulo);
                        $doc->exportField($this->subseccion);
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'sco_lapidas');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'sco_lapidas', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'sco_lapidas', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'sco_lapidas', $fldname, $key, $oldvalue);
            }
        }
    }
