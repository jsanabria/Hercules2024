 ...
 * Page class
 */
class ScoNotaMascotaGrid extends ScoNotaMascota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotaMascotaGrid";
    ...
    public $FormName = "fsco_nota_mascotagrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoNotaMascotaGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nnota_mascota->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->Nnota_mascota->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->Nnota_mascota->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->Nnota_mascota->CurrentValue = $this->Nnota_mascota->FormValue;
        }
