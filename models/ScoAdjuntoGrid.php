 ...
 * Page class
 */
class ScoAdjuntoGrid extends ScoAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoAdjuntoGrid";
    ...
    public $FormName = "fsco_adjuntogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoAdjuntoGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "view_capillas") {
            $this->servicio->Visible = true; // Need to insert foreign key
            $this->servicio->CurrentValue = $this->servicio->getSessionValue();
        }
        ...
        if ($this->getCurrentMasterTable() == "sco_flota") {
            $this->flota->Visible = true; // Need to insert foreign key
            $this->flota->CurrentValue = $this->flota->getSessionValue();
        }
        if ($this->getCurrentMasterTable() == "sco_flota_incidencia") {
            $this->flota_incidencia->Visible = true; // Need to insert foreign key
            $this->flota_incidencia->CurrentValue = $this->flota_incidencia->getSessionValue();
        }
