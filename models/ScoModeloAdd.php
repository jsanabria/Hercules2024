 ...
 * Page class
 */
class ScoModeloAdd extends ScoModelo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoModeloAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoModeloAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoModeloView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->marca->DefaultValue = $this->marca->getDefault(); // PHP
        $this->marca->OldValue = $this->marca->DefaultValue;
        $this->nombre->DefaultValue = $this->nombre->getDefault(); // PHP
        $this->nombre->OldValue = $this->nombre->DefaultValue;
    ...
    protected function getAddRow()
    {
        ...
        // marca
        $this->marca->setDbValueDef($rsnew, $this->marca->CurrentValue, strval($this->marca->CurrentValue) == "");
