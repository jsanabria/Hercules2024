 ...
 * Page class
 */
class ScoClienteAdd extends ScoCliente
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoClienteAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoClienteAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoClienteView") {
    ...
    protected function getAddRow()
    {
        ...
        // rif_ci
        $this->rif_ci->setDbValueDef($rsnew, $this->rif_ci->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['rif_ci'])) { // rif_ci
            $this->rif_ci->setFormValue($row['rif_ci']);
        }
