 ...
 * Page class
 */
class ScoSeguroAdd extends ScoSeguro
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoSeguroAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoSeguroAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoSeguroView") {
    ...
    protected function getAddRow()
    {
        ...
        // email3
        $this->email3->setDbValueDef($rsnew, $this->email3->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['email3'])) { // email3
            $this->email3->setFormValue($row['email3']);
        }
