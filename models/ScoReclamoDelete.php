 ...
 * Page class
 */
class ScoReclamoDelete extends ScoReclamo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoReclamoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoReclamoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoReclamoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoReclamoList"); // Return to list
                return;
            }
        }
