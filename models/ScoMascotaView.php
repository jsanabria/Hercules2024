 ...
 * Page class
 */
class ScoMascotaView extends ScoMascota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoMascotaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoMascotaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nmascota") ?? Route("Nmascota")) !== null) {
            ...
            $this->RecKey["Nmascota"] = $this->Nmascota->QueryStringValue;
        } elseif (Post("Nmascota") !== null) {
            $this->Nmascota->setFormValue(Post("Nmascota"));
            $this->RecKey["Nmascota"] = $this->Nmascota->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nmascota->setQueryStringValue($keyValue);
            $this->RecKey["Nmascota"] = $this->Nmascota->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoMascotaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoMascotaList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $item = &$option->add("detail_sco_nota_mascota");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("sco_nota_mascota", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoNotaMascotaList?" . Config("TABLE_SHOW_MASTER") . "=sco_mascota&" . GetForeignKeyUrl("fk_Nmascota", $this->Nmascota->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_mascota')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_nota_mascota"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_mascota')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_nota_mascota"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
        ...
        $item = &$option->add("detail_sco_mascota_estatus");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("sco_mascota_estatus", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoMascotaEstatusList?" . Config("TABLE_SHOW_MASTER") . "=sco_mascota&" . GetForeignKeyUrl("fk_Nmascota", $this->Nmascota->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("ScoMascotaEstatusGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_mascota')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mascota_estatus"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_mascota')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mascota_estatus"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
