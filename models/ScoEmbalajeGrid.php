 ...
 * Page class
 */
class ScoEmbalajeGrid extends ScoEmbalaje
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEmbalajeGrid";
    ...
    public $FormName = "fsco_embalajegrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoEmbalajeGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nembalaje->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_precinto1") &&
            $CurrentForm->hasValue("o_precinto1") &&
            $this->precinto1->CurrentValue != $this->precinto1->DefaultValue &&
            !($this->precinto1->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->precinto1->CurrentValue == $this->precinto1->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_precinto2") &&
            $CurrentForm->hasValue("o_precinto2") &&
            $this->precinto2->CurrentValue != $this->precinto2->DefaultValue &&
            !($this->precinto2->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->precinto2->CurrentValue == $this->precinto2->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_fecha_servicio") &&
            $CurrentForm->hasValue("o_fecha_servicio") &&
            $this->fecha_servicio->CurrentValue != $this->fecha_servicio->DefaultValue &&
            !($this->fecha_servicio->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->fecha_servicio->CurrentValue == $this->fecha_servicio->getSessionValue())
        ) {
            return false;
        }
        if (
        ...
        if (
            $CurrentForm->hasValue("x_anulado") &&
            $CurrentForm->hasValue("o_anulado") &&
            $this->anulado->CurrentValue != $this->anulado->DefaultValue &&
            !($this->anulado->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->anulado->CurrentValue == $this->anulado->getSessionValue())
        ) {
            return false;
        }
        return true;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_precinto1")) {
            $this->precinto1->setOldValue($CurrentForm->getValue("o_precinto1"));
        }
        ...
        if ($CurrentForm->hasValue("o_precinto2")) {
            $this->precinto2->setOldValue($CurrentForm->getValue("o_precinto2"));
        }
        ...
        if ($CurrentForm->hasValue("o_fecha_servicio")) {
            $this->fecha_servicio->setOldValue($CurrentForm->getValue("o_fecha_servicio"));
        }
        ...
        if ($CurrentForm->hasValue("o_anulado")) {
            $this->anulado->setOldValue($CurrentForm->getValue("o_anulado"));
        }
        ...
        if (!$this->Nembalaje->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->Nembalaje->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->Nembalaje->CurrentValue = $this->Nembalaje->FormValue;
        }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if ($this->anulado->Visible && $this->anulado->Required) {
                if (!$this->anulado->IsDetailKey && EmptyValue($this->anulado->FormValue)) {
    ...
    protected function getEditRow($rsold)
    {
        ...
        // precinto1
        $this->precinto1->setDbValueDef($rsnew, $this->precinto1->CurrentValue, $this->precinto1->ReadOnly);

        // precinto2
        $this->precinto2->setDbValueDef($rsnew, $this->precinto2->CurrentValue, $this->precinto2->ReadOnly);

        // fecha_servicio
        $this->fecha_servicio->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_servicio->CurrentValue, $this->fecha_servicio->formatPattern()), $this->fecha_servicio->ReadOnly);
    ...
    protected function restoreEditFormFromRow($row)
    {
        ...
        if (isset($row['precinto1'])) { // precinto1
            $this->precinto1->CurrentValue = $row['precinto1'];
        }
        if (isset($row['precinto2'])) { // precinto2
            $this->precinto2->CurrentValue = $row['precinto2'];
        }
        if (isset($row['fecha_servicio'])) { // fecha_servicio
            $this->fecha_servicio->CurrentValue = $row['fecha_servicio'];
        }
    ...
    protected function getAddRow()
    {
        ...
        // anulado
        $this->anulado->setDbValueDef($rsnew, $this->anulado->CurrentValue, strval($this->anulado->CurrentValue) == "");
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['anulado'])) { // anulado
            $this->anulado->setFormValue($row['anulado']);
        }
