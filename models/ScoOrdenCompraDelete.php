 ...
 * Page class
 */
class ScoOrdenCompraDelete extends ScoOrdenCompra
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOrdenCompraDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOrdenCompraDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoOrdenCompraList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoOrdenCompraList"); // Return to list
                return;
            }
        }
