 ...
 * Page class
 */
class ScoNotaOrdenCompraDelete extends ScoNotaOrdenCompra
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotaOrdenCompraDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoNotaOrdenCompraDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoNotaOrdenCompraList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoNotaOrdenCompraList"); // Return to list
                return;
            }
        }
