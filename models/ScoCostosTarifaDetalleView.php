 ...
 * Page class
 */
class ScoCostosTarifaDetalleView extends ScoCostosTarifaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCostosTarifaDetalleView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCostosTarifaDetalleView";
    ...
    {
        $this->Ncostos_tarifa_detalle->setVisibility();
        $this->costos_tarifa->setVisibility();
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Ncostos_tarifa_detalle") ?? Route("Ncostos_tarifa_detalle")) !== null) {
            $this->RecKey["Ncostos_tarifa_detalle"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Ncostos_tarifa_detalle") ?? Route("Ncostos_tarifa_detalle")) !== null) {
            ...
            $this->RecKey["Ncostos_tarifa_detalle"] = $this->Ncostos_tarifa_detalle->QueryStringValue;
        } elseif (Post("Ncostos_tarifa_detalle") !== null) {
            $this->Ncostos_tarifa_detalle->setFormValue(Post("Ncostos_tarifa_detalle"));
            $this->RecKey["Ncostos_tarifa_detalle"] = $this->Ncostos_tarifa_detalle->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Ncostos_tarifa_detalle->setQueryStringValue($keyValue);
            $this->RecKey["Ncostos_tarifa_detalle"] = $this->Ncostos_tarifa_detalle->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoCostosTarifaDetalleList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoCostosTarifaDetalleList"; // No matching record, return to list
                    } else {
