 ...
 * Page class
 */
class ScoServicioView extends ScoServicio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoServicioView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoServicioView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Nservicio") ?? Route("Nservicio")) !== null) {
            $this->RecKey["Nservicio"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nservicio") ?? Route("Nservicio")) !== null) {
            ...
            $this->RecKey["Nservicio"] = $this->Nservicio->QueryStringValue;
        } elseif (Post("Nservicio") !== null) {
            $this->Nservicio->setFormValue(Post("Nservicio"));
            $this->RecKey["Nservicio"] = $this->Nservicio->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nservicio->setQueryStringValue($keyValue);
            $this->RecKey["Nservicio"] = $this->Nservicio->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoServicioList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoServicioList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoAdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=sco_servicio&" . GetForeignKeyUrl("fk_Nservicio", $this->Nservicio->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
