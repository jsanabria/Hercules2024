 ...
 * Page class
 */
class ScoCremacionEstatusPreview extends ScoCremacionEstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCremacionEstatusPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCremacionEstatusPreview";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoCremacionEstatusList"), "", $this->TableVar, true);
        $pageId = "preview";
    ...
    public function listOptionsRendered() {
    	...
    	//$this->ListOptions->Items["new"]->Body = "xxx";
    		...
    		case "RECEPCION":
    			$color = "background-color: #f2dede; color: #a94442; font-weight: bold";
    			break;
    		case "DOCUMENTOS":
    			$color = "background-color: #fcf8e3; color: #8a6d3b; font-weight: bold";
    			break;
    		case "PROCESO":
    			$color = "background-color: #dff0d8; color: #3c763d; font-weight: bold";
    			break;
    		case "CREMACION OK":
    			$color = "background-color: #f7d9ca; color: #ff6a1d; font-weight: bold";
    			break;
    		case "ENTREGADAS":
    			$color = "background-color: #d6cbe3; color: #5c239b; font-weight: bold";
    			break;
    		}
    		$style = $color; 	
