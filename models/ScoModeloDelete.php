 ...
 * Page class
 */
class ScoModeloDelete extends ScoModelo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoModeloDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoModeloDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoModeloList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoModeloList"); // Return to list
                return;
            }
        }
