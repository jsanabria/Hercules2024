 ...
 * Page class
 */
class ViewCapillasView extends ViewCapillas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewCapillasView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewCapillasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nservicio") ?? Route("Nservicio")) !== null) {
            ...
            $returnUrl = "ViewCapillasList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ViewCapillasList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewCapillasList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoAdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=view_capillas&" . GetForeignKeyUrl("fk_Nservicio", $this->Nservicio->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewCapillasList"), "", $this->TableVar, true);
        $pageId = "view";
