 ...
 * Page class
 */
class ScoFlotaIncidenciaDetalleAdd extends ScoFlotaIncidenciaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoFlotaIncidenciaDetalleAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoFlotaIncidenciaDetalleAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoFlotaIncidenciaDetalleView") {
