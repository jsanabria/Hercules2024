 ...
 * Page class
 */
class AutogestionTicketView extends AutogestionTicket
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AutogestionTicketView";
    ...
    // CSS class/style
    public $CurrentPageName = "AutogestionTicketView";
    ...
    public function setVisibility()
    {
        ...
        $this->recaudos->setVisibility();
        $this->recaudos2->setVisibility();
        $this->hora_conctactar->setVisibility();
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nticket") ?? Route("Nticket")) !== null) {
            ...
            $this->RecKey["Nticket"] = $this->Nticket->QueryStringValue;
        } elseif (Post("Nticket") !== null) {
            $this->Nticket->setFormValue(Post("Nticket"));
            $this->RecKey["Nticket"] = $this->Nticket->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nticket->setQueryStringValue($keyValue);
            $this->RecKey["Nticket"] = $this->Nticket->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "AutogestionTicketList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AutogestionTicketList"; // No matching record, return to list
                    } else {
