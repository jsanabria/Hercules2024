 ...
 * Page class
 */
class ViewVelacionAdd extends ViewVelacion
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewVelacionAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewVelacionAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ViewVelacionView") {
