 ...
 * Page class
 */
class ScoGramaNotaPreview extends ScoGramaNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaNotaPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoGramaNotaPreview";
    ...
    public function listOptionsRendered() {
    	...
    	$sql = "SELECT valor4 AS color FROM sco_parametro 
    			WHERE codigo = '057' AND valor1 = '" . $this->estatus->CurrentValue . "';";
    	if($row = ExecuteRow($sql)) {
    		$color = $row["color"];
    		$style = $color; 	
    		$this->nota->CellAttrs["style"] = $style;
    		$this->usuario->CellAttrs["style"] = $style;
