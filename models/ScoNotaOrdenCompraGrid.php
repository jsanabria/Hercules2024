 ...
 * Page class
 */
class ScoNotaOrdenCompraGrid extends ScoNotaOrdenCompra
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotaOrdenCompraGrid";
    ...
    public $FormName = "fsco_nota_orden_compragrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoNotaOrdenCompraGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "sco_orden_compra") {
            $this->orden_compra->Visible = true; // Need to insert foreign key
            $this->orden_compra->CurrentValue = $this->orden_compra->getSessionValue();
        }
