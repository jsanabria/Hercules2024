 ...
 * Page class
 */
class ScoOrdenCompraDetalleDelete extends ScoOrdenCompraDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOrdenCompraDetalleDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOrdenCompraDetalleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoOrdenCompraDetalleList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoOrdenCompraDetalleList"); // Return to list
                return;
            }
        }
