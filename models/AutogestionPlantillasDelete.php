 ...
 * Page class
 */
class AutogestionPlantillasDelete extends AutogestionPlantillas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AutogestionPlantillasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "AutogestionPlantillasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("AutogestionPlantillasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("AutogestionPlantillasList"); // Return to list
                return;
            }
        }
