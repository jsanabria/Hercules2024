 ...
 * Page class
 */
class ScoGramaPagosDelete extends ScoGramaPagos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaPagosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoGramaPagosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoGramaPagosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoGramaPagosList"); // Return to list
                return;
            }
        }
