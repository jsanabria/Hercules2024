 ...
 * Page class
 */
class ScoEntradaSalidaDetallePreview extends ScoEntradaSalidaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEntradaSalidaDetallePreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoEntradaSalidaDetallePreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sco_entrada_salida") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_entrada_salida&" . GetForeignKeyUrl("fk_Nentrada_salida", $this->entrada_salida->QueryStringValue) . "&" . GetForeignKeyUrl("fk_tipo_doc", $this->tipo_doc->QueryStringValue) . "&" . GetForeignKeyUrl("fk_proveedor", $this->proveedor->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "sco_entrada_salida") {
            $this->entrada_salida->setQueryStringValue($keys[0] ?? "");
            $this->tipo_doc->setQueryStringValue($keys[1] ?? "");
            $this->proveedor->setQueryStringValue($keys[2] ?? "");
        }
    }
