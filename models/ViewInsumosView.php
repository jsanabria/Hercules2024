 ...
 * Page class
 */
class ViewInsumosView extends ViewInsumos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewInsumosView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewInsumosView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nservicio") ?? Route("Nservicio")) !== null) {
            ...
            $returnUrl = "ViewInsumosList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewInsumosList"; // No matching record, return to list
                    } else {
