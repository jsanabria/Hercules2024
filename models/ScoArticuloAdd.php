 ...
 * Page class
 */
class ScoArticuloAdd extends ScoArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoArticuloAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoArticuloAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoArticuloView") {
