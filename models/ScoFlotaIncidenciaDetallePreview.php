 ...
 * Page class
 */
class ScoFlotaIncidenciaDetallePreview extends ScoFlotaIncidenciaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoFlotaIncidenciaDetallePreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoFlotaIncidenciaDetallePreview";
