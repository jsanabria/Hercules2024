 ...
 * Page class
 */
class ScoLapidasView extends ScoLapidas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoLapidasView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoLapidasView";
    ...
    public function setVisibility()
    {
        ...
        $this->nota1->setVisibility();
        $this->cliente->setVisibility();
        $this->nota2->setVisibility();
    ...
    public function __construct()
    {
        ...
        // Set up record key
        if (($keyValue = Get("Nlapidas") ?? Route("Nlapidas")) !== null) {
            $this->RecKey["Nlapidas"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nlapidas") ?? Route("Nlapidas")) !== null) {
            $this->Nlapidas->setQueryStringValue($keyValue);
            $this->RecKey["Nlapidas"] = $this->Nlapidas->QueryStringValue;
        } elseif (Post("Nlapidas") !== null) {
            $this->Nlapidas->setFormValue(Post("Nlapidas"));
            $this->RecKey["Nlapidas"] = $this->Nlapidas->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nlapidas->setQueryStringValue($keyValue);
            $this->RecKey["Nlapidas"] = $this->Nlapidas->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoLapidasList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoLapidasList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Nlapidas->CurrentValue, $this->CurrentRow['Nlapidas'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoLapidasList"; // No matching record, return to list
                    } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoLapidasList"), "", $this->TableVar, true);
        $pageId = "view";
