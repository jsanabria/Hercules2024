 ...
 * Page class
 */
class ScoReclamoAdjuntoGrid extends ScoReclamoAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoReclamoAdjuntoGrid";
    ...
    public $FormName = "fsco_reclamo_adjuntogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoReclamoAdjuntoGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nreclamo_adjunto->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'Nreclamo_adjunto' first before field var 'x_Nreclamo_adjunto'
        $val = $CurrentForm->hasValue("Nreclamo_adjunto") ? $CurrentForm->getValue("Nreclamo_adjunto") : $CurrentForm->getValue("x_Nreclamo_adjunto");
        if (!$this->Nreclamo_adjunto->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->Nreclamo_adjunto->setFormValue($val);
        }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->Nreclamo_adjunto->CurrentValue = $this->Nreclamo_adjunto->FormValue;
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "sco_reclamo") {
            $this->reclamo->Visible = true; // Need to insert foreign key
            $this->reclamo->CurrentValue = $this->reclamo->getSessionValue();
        }
    ...
    protected function getAddRow()
    {
        ...
        if ($this->reclamo->getSessionValue() != "") {
            $rsnew['reclamo'] = $this->reclamo->getSessionValue();
        }
        return $rsnew;
    }
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['reclamo'])) { // reclamo
            $this->reclamo->setFormValue($row['reclamo']);
        }
    }
