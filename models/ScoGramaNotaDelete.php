 ...
 * Page class
 */
class ScoGramaNotaDelete extends ScoGramaNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaNotaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoGramaNotaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoGramaNotaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoGramaNotaList"); // Return to list
                return;
            }
        }
