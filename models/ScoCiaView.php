 ...
 * Page class
 */
class ScoCiaView extends ScoCia
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCiaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Ncia") ?? Route("Ncia")) !== null) {
            ...
            $this->RecKey["Ncia"] = $this->Ncia->QueryStringValue;
        } elseif (Post("Ncia") !== null) {
            $this->Ncia->setFormValue(Post("Ncia"));
            $this->RecKey["Ncia"] = $this->Ncia->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Ncia->setQueryStringValue($keyValue);
            $this->RecKey["Ncia"] = $this->Ncia->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoCiaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoCiaList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Ncia->CurrentValue, $this->CurrentRow['Ncia'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoCiaList"; // No matching record, return to list
                    } else {
