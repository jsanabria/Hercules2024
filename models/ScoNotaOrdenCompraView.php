 ...
 * Page class
 */
class ScoNotaOrdenCompraView extends ScoNotaOrdenCompra
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotaOrdenCompraView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoNotaOrdenCompraView";
    ...
    {
        $this->Nnota_orden_compra->setVisibility();
        $this->orden_compra->setVisibility();
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Nnota_orden_compra") ?? Route("Nnota_orden_compra")) !== null) {
            $this->RecKey["Nnota_orden_compra"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nnota_orden_compra") ?? Route("Nnota_orden_compra")) !== null) {
            ...
            $this->RecKey["Nnota_orden_compra"] = $this->Nnota_orden_compra->QueryStringValue;
        } elseif (Post("Nnota_orden_compra") !== null) {
            $this->Nnota_orden_compra->setFormValue(Post("Nnota_orden_compra"));
            $this->RecKey["Nnota_orden_compra"] = $this->Nnota_orden_compra->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nnota_orden_compra->setQueryStringValue($keyValue);
            $this->RecKey["Nnota_orden_compra"] = $this->Nnota_orden_compra->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoNotaOrdenCompraList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoNotaOrdenCompraList"; // No matching record, return to list
                    } else {
