 ...
 * Page class
 */
class ScoCremacionEstatusGrid extends ScoCremacionEstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCremacionEstatusGrid";
    ...
    public $FormName = "fsco_cremacion_estatusgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoCremacionEstatusGrid";
