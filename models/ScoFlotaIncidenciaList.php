 ...
 * Page class
 */
class ScoFlotaIncidenciaList extends ScoFlotaIncidencia
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoFlotaIncidenciaList";
    ...
    public $FormName = "fsco_flota_incidencialist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoFlotaIncidenciaList";
    ...
    public function setVisibility()
    {
        ...
        $this->cambio_aceite->Visible = false;
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "ScoFlotaIncidenciaAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "ScoFlotaIncidenciaDelete";
        $this->MultiUpdateUrl = "ScoFlotaIncidenciaUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fsco_flota_incidenciagrid";
        }
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->Nflota_incidencia->AdvancedSearch->toJson(), ","); // Field Nflota_incidencia
        $filterList = Concat($filterList, $this->fecha_registro->AdvancedSearch->toJson(), ","); // Field fecha_registro
        $filterList = Concat($filterList, $this->flota->AdvancedSearch->toJson(), ","); // Field flota
        $filterList = Concat($filterList, $this->tipo->AdvancedSearch->toJson(), ","); // Field tipo
        $filterList = Concat($filterList, $this->falla->AdvancedSearch->toJson(), ","); // Field falla
        ...
        $filterList = Concat($filterList, $this->reparacion->AdvancedSearch->toJson(), ","); // Field reparacion
        $filterList = Concat($filterList, $this->cambio_aceite->AdvancedSearch->toJson(), ","); // Field cambio_aceite
        $filterList = Concat($filterList, $this->kilometraje->AdvancedSearch->toJson(), ","); // Field kilometraje
        ...
        $filterList = Concat($filterList, $this->username_diagnostica->AdvancedSearch->toJson(), ","); // Field username_diagnostica
        $filterList = Concat($filterList, $this->fecha_reparacion->AdvancedSearch->toJson(), ","); // Field fecha_reparacion
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fsco_flota_incidenciasrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Nflota_incidencia
        $this->Nflota_incidencia->AdvancedSearch->SearchValue = @$filter["x_Nflota_incidencia"];
        $this->Nflota_incidencia->AdvancedSearch->SearchOperator = @$filter["z_Nflota_incidencia"];
        $this->Nflota_incidencia->AdvancedSearch->SearchCondition = @$filter["v_Nflota_incidencia"];
        $this->Nflota_incidencia->AdvancedSearch->SearchValue2 = @$filter["y_Nflota_incidencia"];
        $this->Nflota_incidencia->AdvancedSearch->SearchOperator2 = @$filter["w_Nflota_incidencia"];
        $this->Nflota_incidencia->AdvancedSearch->save();
        ...
        // Field flota
        $this->flota->AdvancedSearch->SearchValue = @$filter["x_flota"];
        $this->flota->AdvancedSearch->SearchOperator = @$filter["z_flota"];
        $this->flota->AdvancedSearch->SearchCondition = @$filter["v_flota"];
        $this->flota->AdvancedSearch->SearchValue2 = @$filter["y_flota"];
        $this->flota->AdvancedSearch->SearchOperator2 = @$filter["w_flota"];
        $this->flota->AdvancedSearch->save();
        ...
        // Field reparacion
        $this->reparacion->AdvancedSearch->SearchValue = @$filter["x_reparacion"];
        $this->reparacion->AdvancedSearch->SearchOperator = @$filter["z_reparacion"];
        $this->reparacion->AdvancedSearch->SearchCondition = @$filter["v_reparacion"];
        $this->reparacion->AdvancedSearch->SearchValue2 = @$filter["y_reparacion"];
        $this->reparacion->AdvancedSearch->SearchOperator2 = @$filter["w_reparacion"];
        $this->reparacion->AdvancedSearch->save();

        // Field cambio_aceite
        $this->cambio_aceite->AdvancedSearch->SearchValue = @$filter["x_cambio_aceite"];
        $this->cambio_aceite->AdvancedSearch->SearchOperator = @$filter["z_cambio_aceite"];
        $this->cambio_aceite->AdvancedSearch->SearchCondition = @$filter["v_cambio_aceite"];
        $this->cambio_aceite->AdvancedSearch->SearchValue2 = @$filter["y_cambio_aceite"];
        $this->cambio_aceite->AdvancedSearch->SearchOperator2 = @$filter["w_cambio_aceite"];
        $this->cambio_aceite->AdvancedSearch->save();

        // Field kilometraje
        $this->kilometraje->AdvancedSearch->SearchValue = @$filter["x_kilometraje"];
        $this->kilometraje->AdvancedSearch->SearchOperator = @$filter["z_kilometraje"];
        $this->kilometraje->AdvancedSearch->SearchCondition = @$filter["v_kilometraje"];
        $this->kilometraje->AdvancedSearch->SearchValue2 = @$filter["y_kilometraje"];
        $this->kilometraje->AdvancedSearch->SearchOperator2 = @$filter["w_kilometraje"];
        $this->kilometraje->AdvancedSearch->save();
        ...
        // Field username_diagnostica
        $this->username_diagnostica->AdvancedSearch->SearchValue = @$filter["x_username_diagnostica"];
        $this->username_diagnostica->AdvancedSearch->SearchOperator = @$filter["z_username_diagnostica"];
        $this->username_diagnostica->AdvancedSearch->SearchCondition = @$filter["v_username_diagnostica"];
        $this->username_diagnostica->AdvancedSearch->SearchValue2 = @$filter["y_username_diagnostica"];
        $this->username_diagnostica->AdvancedSearch->SearchOperator2 = @$filter["w_username_diagnostica"];
        $this->username_diagnostica->AdvancedSearch->save();

        // Field fecha_reparacion
        $this->fecha_reparacion->AdvancedSearch->SearchValue = @$filter["x_fecha_reparacion"];
        $this->fecha_reparacion->AdvancedSearch->SearchOperator = @$filter["z_fecha_reparacion"];
        $this->fecha_reparacion->AdvancedSearch->SearchCondition = @$filter["v_fecha_reparacion"];
        $this->fecha_reparacion->AdvancedSearch->SearchValue2 = @$filter["y_fecha_reparacion"];
        $this->fecha_reparacion->AdvancedSearch->SearchOperator2 = @$filter["w_fecha_reparacion"];
        $this->fecha_reparacion->AdvancedSearch->save();
    ...
    public function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->Nflota_incidencia, $default, false); // Nflota_incidencia
        $this->buildSearchSql($where, $this->fecha_registro, $default, false); // fecha_registro
        $this->buildSearchSql($where, $this->flota, $default, false); // flota
        $this->buildSearchSql($where, $this->tipo, $default, false); // tipo
        $this->buildSearchSql($where, $this->falla, $default, false); // falla
        ...
        $this->buildSearchSql($where, $this->reparacion, $default, false); // reparacion
        $this->buildSearchSql($where, $this->cambio_aceite, $default, false); // cambio_aceite
        $this->buildSearchSql($where, $this->kilometraje, $default, false); // kilometraje
        ...
        $this->buildSearchSql($where, $this->username_diagnostica, $default, false); // username_diagnostica
        $this->buildSearchSql($where, $this->fecha_reparacion, $default, false); // fecha_reparacion
        ...
        if (!$default && $this->Command == "search") {
            $this->Nflota_incidencia->AdvancedSearch->save(); // Nflota_incidencia
            $this->fecha_registro->AdvancedSearch->save(); // fecha_registro
            $this->flota->AdvancedSearch->save(); // flota
            ...
            $this->reparacion->AdvancedSearch->save(); // reparacion
            $this->cambio_aceite->AdvancedSearch->save(); // cambio_aceite
            $this->kilometraje->AdvancedSearch->save(); // kilometraje
            ...
            $this->username_diagnostica->AdvancedSearch->save(); // username_diagnostica
            $this->fecha_reparacion->AdvancedSearch->save(); // fecha_reparacion
    ...
    public function showFilterList()
    {
        ...
        // Field Nflota_incidencia
        $filter = $this->queryBuilderWhere("Nflota_incidencia");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->Nflota_incidencia, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->Nflota_incidencia->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
        ...
        // Field flota
        $filter = $this->queryBuilderWhere("flota");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->flota, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->flota->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
        ...
        // Field falla
        $filter = $this->queryBuilderWhere("falla");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->falla, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->falla->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
        ...
        // Field fecha_reparacion
        $filter = $this->queryBuilderWhere("fecha_reparacion");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->fecha_reparacion, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->fecha_reparacion->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->Nflota_incidencia->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->fecha_registro->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->flota->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->reparacion->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->cambio_aceite->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->kilometraje->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->username_diagnostica->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->fecha_reparacion->AdvancedSearch->issetSession()) {
            return true;
        }
        return false;
    }
    ...
    {
        $this->Nflota_incidencia->AdvancedSearch->unsetSession();
        $this->fecha_registro->AdvancedSearch->unsetSession();
        $this->flota->AdvancedSearch->unsetSession();
        ...
        $this->reparacion->AdvancedSearch->unsetSession();
        $this->cambio_aceite->AdvancedSearch->unsetSession();
        $this->kilometraje->AdvancedSearch->unsetSession();
        ...
        $this->username_diagnostica->AdvancedSearch->unsetSession();
        $this->fecha_reparacion->AdvancedSearch->unsetSession();
    }
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->Nflota_incidencia->AdvancedSearch->load();
        $this->fecha_registro->AdvancedSearch->load();
        $this->flota->AdvancedSearch->load();
        ...
        $this->reparacion->AdvancedSearch->load();
        $this->cambio_aceite->AdvancedSearch->load();
        $this->kilometraje->AdvancedSearch->load();
        ...
        $this->username_diagnostica->AdvancedSearch->load();
        $this->fecha_reparacion->AdvancedSearch->load();
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->Command != "json") {
            $defaultSort = $this->Nflota_incidencia->Expression . " DESC"; // Set up default sort
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Nflota_incidencia); // Nflota_incidencia
            $this->updateSort($this->fecha_registro); // fecha_registro
            $this->updateSort($this->flota); // flota
            ...
            $this->updateSort($this->fecha_reparacion); // fecha_reparacion
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Nflota_incidencia->setSort("");
                ...
                $this->reparacion->setSort("");
                $this->cambio_aceite->setSort("");
                $this->kilometraje->setSort("");
                $this->cantidad->setSort("");
                $this->proveedor->setSort("");
                $this->monto->setSort("");
                $this->_username->setSort("");
                $this->username_diagnostica->setSort("");
                $this->fecha_reparacion->setSort("");
            }
    ...
    protected function setupListOptions()
    {
        ...
        // "detail_sco_flota_incidencia_detalle"
        $item = &$this->ListOptions->add("detail_sco_flota_incidencia_detalle");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'sco_flota_incidencia_detalle');
        $item->OnLeft = true;
        ...
        // Set up detail pages
        $pages = new SubPages();
        $pages->add("sco_flota_incidencia_detalle");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"sco_flota_incidencia\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"sco_flota_incidencia\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fsco_flota_incidencialist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fsco_flota_incidencialist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        // "detail_sco_flota_incidencia_detalle"
        $opt = $this->ListOptions["detail_sco_flota_incidencia_detalle"];
        if ($Security->allowList(CurrentProjectID() . 'sco_flota_incidencia_detalle')) {
            $body = $Language->phrase("DetailLink") . $Language->tablePhrase("sco_flota_incidencia_detalle", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("ScoFlotaIncidenciaDetalleList?" . Config("TABLE_SHOW_MASTER") . "=sco_flota_incidencia&" . GetForeignKeyUrl("fk_Nflota_incidencia", $this->Nflota_incidencia->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ScoFlotaIncidenciaDetalleGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_flota_incidencia')) {
                $caption = $Language->phrase("MasterDetailViewLink", null);
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_flota_incidencia_detalle");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
                $detailViewTblVar .= "sco_flota_incidencia_detalle";
            }
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_flota_incidencia')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_flota_incidencia_detalle");
                ...
                $detailEditTblVar .= "sco_flota_incidencia_detalle";
            }
            if ($links != "") {
        ...
        if ($Security->allowList(CurrentProjectID() . 'sco_adjunto')) {
            ...
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("ScoAdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=sco_flota_incidencia&" . GetForeignKeyUrl("fk_Nflota_incidencia", $this->Nflota_incidencia->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->Nflota_incidencia->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function renderListOptionsExt()
    {
        ...
        $detailFilters = [];
        $masterKeys = []; // Reset
        $masterKeys["Nflota_incidencia"] = strval($this->Nflota_incidencia->DbValue);

        // Column "detail_sco_flota_incidencia_detalle"
        if ($this->DetailPages?->getItem("sco_flota_incidencia_detalle")?->Visible && $Security->allowList(CurrentProjectID() . 'sco_flota_incidencia_detalle')) {
            $link = "";
            $option = $this->ListOptions["detail_sco_flota_incidencia_detalle"];
            $detailTbl = Container("sco_flota_incidencia_detalle");
            $detailFilter = $detailTbl->getDetailFilter($this);
            $detailTbl->setCurrentMasterTable($this->TableVar);
            $detailFilter = $detailTbl->applyUserIDFilters($detailFilter);
            $url = "ScoFlotaIncidenciaDetallePreview?t=sco_flota_incidencia&f=" . Encrypt($detailFilter . "|" . implode("|", array_values($masterKeys)));
            $btngrp = "<div data-table=\"sco_flota_incidencia_detalle\" data-url=\"" . $url . "\" class=\"ew-detail-btn-group d-none\">";
            if ($Security->allowList(CurrentProjectID() . 'sco_flota_incidencia')) {
                $label = $Language->tablePhrase("sco_flota_incidencia_detalle", "TblCaption");
                $link = "<button class=\"nav-link\" data-bs-toggle=\"tab\" data-table=\"sco_flota_incidencia_detalle\" data-url=\"" . $url . "\" type=\"button\" role=\"tab\" aria-selected=\"false\">" . $label . "</button>";
                $detaillnk = GetUrl("ScoFlotaIncidenciaDetalleList?" . Config("TABLE_SHOW_MASTER") . "=sco_flota_incidencia");
                foreach ($masterKeys as $key => $value) {
                    $detaillnk .= "&" . GetForeignKeyUrl("fk_$key", $value);
                }
                $title = $Language->tablePhrase("sco_flota_incidencia_detalle", "TblCaption");
            ...
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_flota_incidencia')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $viewurl = GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_flota_incidencia_detalle"));
                $btngrp .= "<a href=\"#\" class=\"me-2\" title=\"" . HtmlTitle($caption) . "\" data-ew-action=\"redirect\" data-url=\"" . HtmlEncode($viewurl) . "\">" . $caption . "</a>";
            }
            if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_flota_incidencia')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $editurl = GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_flota_incidencia_detalle"));
        ...
        if ($this->DetailPages?->getItem("sco_adjunto")?->Visible && $Security->allowList(CurrentProjectID() . 'sco_adjunto')) {
            ...
            $detailTbl->setCurrentMasterTable($this->TableVar);
            $detailFilter = $detailTbl->applyUserIDFilters($detailFilter);
            $url = "ScoAdjuntoPreview?t=sco_flota_incidencia&f=" . Encrypt($detailFilter . "|" . implode("|", array_values($masterKeys)));
            ...
            if ($Security->allowList(CurrentProjectID() . 'sco_flota_incidencia')) {
                ...
                $detaillnk = GetUrl("ScoAdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=sco_flota_incidencia");
                foreach ($masterKeys as $key => $value) {
                    $detaillnk .= "&" . GetForeignKeyUrl("fk_$key", $value);
                }
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"sco_flota_incidencia\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $detailTableLink = "";
        $item = &$option->add("detailadd_sco_flota_incidencia_detalle");
        $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=sco_flota_incidencia_detalle");
        $detailPage = Container("ScoFlotaIncidenciaDetalleGrid");
        $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
        $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
        $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'sco_flota_incidencia') && $Security->canAdd());
        if ($item->Visible) {
            if ($detailTableLink != "") {
                $detailTableLink .= ",";
            }
            $detailTableLink .= "sco_flota_incidencia_detalle";
        }
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "Nflota_incidencia");
            $this->createColumnOption($option, "fecha_registro");
            $this->createColumnOption($option, "flota");
            $this->createColumnOption($option, "tipo");
            $this->createColumnOption($option, "falla");
            $this->createColumnOption($option, "proveedor");
            $this->createColumnOption($option, "username");
            $this->createColumnOption($option, "fecha_reparacion");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fsco_flota_incidenciasrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fsco_flota_incidenciasrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fsco_flota_incidencialist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_sco_flota_incidencia", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_sco_flota_incidencia",
    ...
    protected function loadSearchValues()
    {
        ...
        // Nflota_incidencia
        if ($this->Nflota_incidencia->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Nflota_incidencia->AdvancedSearch->SearchValue != "" || $this->Nflota_incidencia->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // flota
        if ($this->flota->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->flota->AdvancedSearch->SearchValue != "" || $this->flota->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // falla
        if ($this->falla->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->falla->AdvancedSearch->SearchValue != "" || $this->falla->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // reparacion
        if ($this->reparacion->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->reparacion->AdvancedSearch->SearchValue != "" || $this->reparacion->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // cambio_aceite
        if ($this->cambio_aceite->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->cambio_aceite->AdvancedSearch->SearchValue != "" || $this->cambio_aceite->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // kilometraje
        if ($this->kilometraje->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->kilometraje->AdvancedSearch->SearchValue != "" || $this->kilometraje->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        if ($this->username_diagnostica->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->username_diagnostica->AdvancedSearch->SearchValue != "" || $this->username_diagnostica->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // fecha_reparacion
        if ($this->fecha_reparacion->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->fecha_reparacion->AdvancedSearch->SearchValue != "" || $this->fecha_reparacion->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->Nflota_incidencia->EditValue = $this->Nflota_incidencia->AdvancedSearch->SearchValue;
            $this->Nflota_incidencia->PlaceHolder = RemoveHtml($this->Nflota_incidencia->caption());
            ...
            $this->flota->EditValue = $this->flota->AdvancedSearch->SearchValue;
            $curVal = strval($this->flota->AdvancedSearch->SearchValue);
            if ($curVal != "") {
                ...
                if ($this->flota->EditValue === null) { // Lookup from database
                    ...
                    if ($ari > 0) { // Lookup values found
                        ...
                        $this->flota->EditValue = HtmlEncode($this->flota->AdvancedSearch->SearchValue);
                    }
                }
            } else {
            ...
            if ($this->proveedor->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter($this->proveedor->Lookup->getTable()->Fields["Nproveedor"]->searchExpression(), "=", $this->proveedor->AdvancedSearch->SearchValue, $this->proveedor->Lookup->getTable()->Fields["Nproveedor"]->searchDataType(), "");
                }
                $lookupFilter = $this->proveedor->getSelectFilter($this); // PHP
            ...
            $this->fecha_reparacion->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->fecha_reparacion->AdvancedSearch->SearchValue, $this->fecha_reparacion->formatPattern()), $this->fecha_reparacion->formatPattern()));
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->flota->AdvancedSearch->SearchValue)) {
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fsco_flota_incidencialist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fsco_flota_incidenciasrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    ...
    public function pageDataRendering(&$header) {
        // Contenedor principal: Usa Flexbox para alinear el botón y la leyenda horizontalmente.
        $output = '<div style="display: flex; align-items: center; gap: 20px; margin-bottom: 15px;">';

        // 1. Botón Exportar a Excel (Elemento Flex 1)
        $output .= ' <a href="dashboard/ListadoMaster?id=flotas" class="btn btn-primary btn-sm" style="flex-shrink: 0;">
            <span class="fa fa-file-excel"></span> Exportar a Excel
        </a> '; 

        // 2. Leyenda de Colores (Tabla - Elemento Flex 2)
        // CLAVE DE AJUSTE: width: 100% para la tabla.
        $output .= '<table style="width: 60%; border-collapse: separate; border-spacing: 5px;">
                        <tr style="height: 30px;">
                            <td style="background-color: #dc3545; color: white; text-align: center; padding: 5px; font-weight: bold; width: 33%; border-radius: 4px;">
                                FALLA
                            </td>
                            <td style="background-color: #ffc107; color: black; text-align: center; padding: 5px; font-weight: bold; width: 33%; border-radius: 4px;">
                                DIAGNOSTICO
                            </td>
                            <td style="background-color: #28a745; color: white; text-align: center; padding: 5px; font-weight: bold; width: 33%; border-radius: 4px;">
                                REPARACION
                            </td>
                        </tr>
                    </table>';

        // Cerramos el contenedor principal (Flexbox)
        $output .= '</div>';

        // Asignamos el resultado a la variable de referencia
        $header = $output;
    }
    // Page Data Rendered event
    public function pageDataRendered(&$footer) {
        // Contenedor y tabla con estilos CSS modernos para centrado
        $footer = '<div style="display: flex; align-items: center; gap: 20px; margin-bottom: 15px;">';
        $footer .= '<table style="width: 60%; border-collapse: separate; border-spacing: 5px;">
                        <tr style="height: 30px;">
                            <td style="background-color: #dc3545; color: white; text-align: center; padding: 5px; font-weight: bold; width: 33%; border-radius: 4px;">
                                FALLA
                            </td>
    ...
    public function listOptionsRendered() {
        // 1. Obtener la fecha de registro (Fecha de inicio)
        // Se usa el operador de fusión de null (??) para asegurar que $fd nunca sea NULL.
        // Si CurrentValue es null, $fd será una cadena vacía ("").
        $fd = $this->fecha_registro->CurrentValue ?? ""; 

        // 2. Definir la fecha de reparación (Fecha de fin) - (Lógica corregida previamente)
        $fecha_reparacion_valor = $this->fecha_reparacion->CurrentValue ?? "";
        if (empty($fecha_reparacion_valor)) {
            $fh = date("Y-m-d"); 
        } else {
            $fh = $fecha_reparacion_valor;
        }

        // 3. Asignar el resultado. Si $fd es "", la función interna deberá manejarlo.
