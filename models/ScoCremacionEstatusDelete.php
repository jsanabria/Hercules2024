 ...
 * Page class
 */
class ScoCremacionEstatusDelete extends ScoCremacionEstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCremacionEstatusDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCremacionEstatusDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoCremacionEstatusList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoCremacionEstatusList"); // Return to list
                return;
            }
        }
