 ...
 * Page class
 */
class ScoExpedienteCiaView extends ScoExpedienteCia
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteCiaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteCiaView";
    ...
    {
        $this->Nexpediente_cia->setVisibility();
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Nexpediente_cia") ?? Route("Nexpediente_cia")) !== null) {
            $this->RecKey["Nexpediente_cia"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nexpediente_cia") ?? Route("Nexpediente_cia")) !== null) {
            ...
            $this->RecKey["Nexpediente_cia"] = $this->Nexpediente_cia->QueryStringValue;
        } elseif (Post("Nexpediente_cia") !== null) {
            $this->Nexpediente_cia->setFormValue(Post("Nexpediente_cia"));
            $this->RecKey["Nexpediente_cia"] = $this->Nexpediente_cia->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nexpediente_cia->setQueryStringValue($keyValue);
            $this->RecKey["Nexpediente_cia"] = $this->Nexpediente_cia->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoExpedienteCiaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoExpedienteCiaList"; // No matching record, return to list
                    } else {
