 ...
 * Page class
 */
class ScoMascotaEstatusGrid extends ScoMascotaEstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoMascotaEstatusGrid";
    ...
    public $FormName = "fsco_mascota_estatusgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoMascotaEstatusGrid";
    ...
    {
        $this->mascota->DefaultValue = $this->mascota->getDefault(); // PHP
        $this->mascota->OldValue = $this->mascota->DefaultValue;
    }
    ...
    protected function editRow()
    {
        ...
        // Check referential integrity for master table 'sco_mascota'
        $detailKeys = [];
        $keyValue = $rsnew['mascota'] ?? $rsold['mascota'];
        $detailKeys['mascota'] = $keyValue;
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "sco_mascota") {
            $this->mascota->Visible = true; // Need to insert foreign key
            $this->mascota->CurrentValue = $this->mascota->getSessionValue();
        }
        ...
        // Check referential integrity for master table 'sco_mascota_estatus'
        $validMasterRecord = true;
        $detailKeys = [];
        $detailKeys["mascota"] = $this->mascota->getSessionValue();
        $masterTable = Container("sco_mascota");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
        ...
        if ($insertRow && $this->ValidateKey && strval($rsnew['mascota']) == "") {
    ...
    protected function getAddRow()
    {
        ...
        if ($this->mascota->getSessionValue() != "") {
            $rsnew['mascota'] = $this->mascota->getSessionValue();
        }
        return $rsnew;
    }
