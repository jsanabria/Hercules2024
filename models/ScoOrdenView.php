 ...
 * Page class
 */
class ScoOrdenView extends ScoOrden
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOrdenView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOrdenView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Norden") ?? Route("Norden")) !== null) {
            ...
            $returnUrl = "ScoOrdenList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoOrdenList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoOrdenList"; // No matching record, return to list
                    } else {
    ...
    public function pageRedirecting(&$url)
    {
        ...
        $Norden = $this->Norden->CurrentValue;
        $url = "Contenedor?Nexpediente=$Nexpediente&Norden=$Norden";  
    }
