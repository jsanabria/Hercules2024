 ...
 * Page class
 */
class ScoGramaAdjuntoDelete extends ScoGramaAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaAdjuntoDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoGramaAdjuntoDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoGramaAdjuntoList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoGramaAdjuntoList"); // Return to list
                return;
            }
        }
