 ...
 * Page class
 */
class ScoCostosArticulosView extends ScoCostosArticulos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCostosArticulosView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCostosArticulosView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Ncostos_articulo") ?? Route("Ncostos_articulo")) !== null) {
            $this->RecKey["Ncostos_articulo"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Ncostos_articulo") ?? Route("Ncostos_articulo")) !== null) {
            ...
            $this->RecKey["Ncostos_articulo"] = $this->Ncostos_articulo->QueryStringValue;
        } elseif (Post("Ncostos_articulo") !== null) {
            $this->Ncostos_articulo->setFormValue(Post("Ncostos_articulo"));
            $this->RecKey["Ncostos_articulo"] = $this->Ncostos_articulo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Ncostos_articulo->setQueryStringValue($keyValue);
            $this->RecKey["Ncostos_articulo"] = $this->Ncostos_articulo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoCostosArticulosList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoCostosArticulosList"; // No matching record, return to list
                    } else {
