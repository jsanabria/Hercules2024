 ...
 * Page class
 */
class ScoExpedienteEstatusAdd extends ScoExpedienteEstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteEstatusAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteEstatusAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoExpedienteEstatusView") {
    ...
    protected function getAddRow()
    {
        ...
        // expediente
        $this->expediente->setDbValueDef($rsnew, $this->expediente->CurrentValue, strval($this->expediente->CurrentValue) == "");
