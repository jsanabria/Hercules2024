 ...
 * Page class
 */
class ScoOfreceServicioGrid extends ScoOfreceServicio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOfreceServicioGrid";
    ...
    public $FormName = "fsco_ofrece_serviciogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoOfreceServicioGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "sco_proveedor") {
