 ...
 * Page class
 */
class ScoNotificacionesDelete extends ScoNotificaciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotificacionesDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoNotificacionesDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoNotificacionesList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoNotificacionesList"); // Return to list
                return;
            }
        }
