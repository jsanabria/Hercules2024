 ...
 * Page class
 */
class ViewCapillasDelete extends ViewCapillas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewCapillasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewCapillasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewCapillasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ViewCapillasList"); // Return to list
                return;
            }
        }
