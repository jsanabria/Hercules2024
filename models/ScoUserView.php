 ...
 * Page class
 */
class ScoUserView extends ScoUser
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoUserView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoUserView";
    ...
    public function setVisibility()
    {
        ...
        $this->level_cemantick->setVisibility();
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nuser") ?? Route("Nuser")) !== null) {
            ...
            $this->RecKey["Nuser"] = $this->Nuser->QueryStringValue;
        } elseif (Post("Nuser") !== null) {
            $this->Nuser->setFormValue(Post("Nuser"));
            $this->RecKey["Nuser"] = $this->Nuser->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nuser->setQueryStringValue($keyValue);
            $this->RecKey["Nuser"] = $this->Nuser->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoUserList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoUserList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Nuser->CurrentValue, $this->CurrentRow['Nuser'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoUserList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $item = &$option->add("detail_sco_user_nota");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("sco_user_nota", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoUserNotaList?" . Config("TABLE_SHOW_MASTER") . "=sco_user&" . GetForeignKeyUrl("fk_Nuser", $this->Nuser->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_user')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_user_nota"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_user')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_user_nota"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
        ...
        $item = &$option->add("detail_sco_user_adjunto");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("sco_user_adjunto", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoUserAdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=sco_user&" . GetForeignKeyUrl("fk_Nuser", $this->Nuser->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("ScoUserAdjuntoGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_user')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_user_adjunto"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_user')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_user_adjunto"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
    ...
    public function pageDataRendering(&$header) {
    	// Example:
    	if($this->evaluacion->CurrentValue == "S")
    		$header = '<a class="btn btn-primary" href="dashboard/reporte_evaluacion.php?username=' . $this->username->CurrentValue . '">Reporte de Evaluaci&oacute;n</a>';
    }
