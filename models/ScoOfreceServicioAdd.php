 ...
 * Page class
 */
class ScoOfreceServicioAdd extends ScoOfreceServicio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOfreceServicioAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOfreceServicioAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ScoOfreceServicioList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ScoOfreceServicioList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ScoOfreceServicioView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ScoOfreceServicioList") {
                            ...
                            $returnUrl = "ScoOfreceServicioList"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        // Nfrece_servicio
        $this->Nfrece_servicio->RowCssClass = "row";
