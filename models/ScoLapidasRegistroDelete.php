 ...
 * Page class
 */
class ScoLapidasRegistroDelete extends ScoLapidasRegistro
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoLapidasRegistroDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoLapidasRegistroDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoLapidasRegistroList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoLapidasRegistroList"); // Return to list
                return;
            }
        }
