 ...
 * Page class
 */
class ScoMttotecnicoAdjuntoPreview extends ScoMttotecnicoAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoMttotecnicoAdjuntoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoMttotecnicoAdjuntoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sco_mttotecnico") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_mttotecnico&" . GetForeignKeyUrl("fk_Nmttotecnico", $this->mttotecnico->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "sco_mttotecnico") {
            $this->mttotecnico->setQueryStringValue($keys[0] ?? "");
        }
    }
