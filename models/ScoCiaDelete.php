 ...
 * Page class
 */
class ScoCiaDelete extends ScoCia
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCiaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCiaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoCiaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoCiaList"); // Return to list
                return;
            }
        }
