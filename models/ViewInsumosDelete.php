 ...
 * Page class
 */
class ViewInsumosDelete extends ViewInsumos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewInsumosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewInsumosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewInsumosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ViewInsumosList"); // Return to list
                return;
            }
        }
