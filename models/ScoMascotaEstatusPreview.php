 ...
 * Page class
 */
class ScoMascotaEstatusPreview extends ScoMascotaEstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoMascotaEstatusPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoMascotaEstatusPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sco_mascota") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_mascota&" . GetForeignKeyUrl("fk_Nmascota", $this->mascota->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "sco_mascota") {
            $this->mascota->setQueryStringValue($keys[0] ?? "");
        }
    }
    ...
    public function listOptionsRendered() {
    	// Example: 
    	if ($this->PageID == "list" || $this->PageID == "view" || $this->PageID == "preview") { // List/View page only
