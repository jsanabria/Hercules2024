 ...
 * Page class
 */
class ScoNotificacionesView extends ScoNotificaciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotificacionesView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoNotificacionesView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nnotificaciones") ?? Route("Nnotificaciones")) !== null) {
            ...
            $returnUrl = "ScoNotificacionesList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoNotificacionesList"; // No matching record, return to list
                    } else {
