 ...
 * Page class
 */
class ScoOrdenCompraView extends ScoOrdenCompra
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOrdenCompraView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOrdenCompraView";
    ...
    public function setVisibility()
    {
        ...
        $this->fecha_aprobacion->setVisibility();
    }
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Norden_compra") ?? Route("Norden_compra")) !== null) {
            $this->RecKey["Norden_compra"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Norden_compra") ?? Route("Norden_compra")) !== null) {
            ...
            $this->RecKey["Norden_compra"] = $this->Norden_compra->QueryStringValue;
        } elseif (Post("Norden_compra") !== null) {
            $this->Norden_compra->setFormValue(Post("Norden_compra"));
            $this->RecKey["Norden_compra"] = $this->Norden_compra->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Norden_compra->setQueryStringValue($keyValue);
            $this->RecKey["Norden_compra"] = $this->Norden_compra->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoOrdenCompraList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoOrdenCompraList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $item = &$option->add("detail_sco_orden_compra_detalle");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("sco_orden_compra_detalle", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoOrdenCompraDetalleList?" . Config("TABLE_SHOW_MASTER") . "=sco_orden_compra&" . GetForeignKeyUrl("fk_Norden_compra", $this->Norden_compra->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_orden_compra')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_orden_compra_detalle"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_orden_compra')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_orden_compra_detalle"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
        ...
        $item = &$option->add("detail_sco_nota_orden_compra");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("sco_nota_orden_compra", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoNotaOrdenCompraList?" . Config("TABLE_SHOW_MASTER") . "=sco_orden_compra&" . GetForeignKeyUrl("fk_Norden_compra", $this->Norden_compra->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("ScoNotaOrdenCompraGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_orden_compra')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_nota_orden_compra"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_orden_compra')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_nota_orden_compra"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
    ...
    public function pageRedirecting(&$url) {
        ...
        if (trim($showdetail_value) === "") {
            ...
            if (!empty($norden_compra_id)) {
                $norden_compra_id_safe = urlencode($norden_compra_id); 
                $detail_status = "sco_orden_compra_detalle"; 
                $url = "ScoOrdenCompraView/$norden_compra_id_safe?showdetail=$detail_status";
            }
        }
    }
