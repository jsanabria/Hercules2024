 ...
 * Page class
 */
class ViewOficioReligiosoView extends ViewOficioReligioso
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewOficioReligiosoView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewOficioReligiosoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Norden") ?? Route("Norden")) !== null) {
            ...
            $this->RecKey["Norden"] = $this->Norden->QueryStringValue;
        } elseif (Post("Norden") !== null) {
            $this->Norden->setFormValue(Post("Norden"));
            $this->RecKey["Norden"] = $this->Norden->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Norden->setQueryStringValue($keyValue);
            $this->RecKey["Norden"] = $this->Norden->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ViewOficioReligiosoList"; // Return to list
        }
        if (($keyValue = Get("Nexpediente") ?? Route("Nexpediente")) !== null) {
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewOficioReligiosoList"; // No matching record, return to list
                    } else {
