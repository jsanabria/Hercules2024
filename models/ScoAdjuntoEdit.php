 ...
 * Page class
 */
class ScoAdjuntoEdit extends ScoAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoAdjuntoEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoAdjuntoEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("Nadjunto") ?? Key(0) ?? Route(2)) !== null) {
                $this->Nadjunto->setQueryStringValue($keyValue);
                $this->Nadjunto->setOldValue($this->Nadjunto->QueryStringValue);
            } elseif (Post("Nadjunto") !== null) {
                $this->Nadjunto->setFormValue(Post("Nadjunto"));
                $this->Nadjunto->setOldValue($this->Nadjunto->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("Nadjunto") ?? Route("Nadjunto")) !== null) {
                    ...
                    $this->Nadjunto->CurrentValue = null;
                }
            }
