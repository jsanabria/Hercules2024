 ...
 * Page class
 */
class ScoFlotaIncidenciaDetalleEdit extends ScoFlotaIncidenciaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoFlotaIncidenciaDetalleEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoFlotaIncidenciaDetalleEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("Nflota_incidencia_detalle") ?? Key(0) ?? Route(2)) !== null) {
                $this->Nflota_incidencia_detalle->setQueryStringValue($keyValue);
                $this->Nflota_incidencia_detalle->setOldValue($this->Nflota_incidencia_detalle->QueryStringValue);
            } elseif (Post("Nflota_incidencia_detalle") !== null) {
                $this->Nflota_incidencia_detalle->setFormValue(Post("Nflota_incidencia_detalle"));
                $this->Nflota_incidencia_detalle->setOldValue($this->Nflota_incidencia_detalle->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                $loadByQuery = false;
                if (($keyValue = Get("Nflota_incidencia_detalle") ?? Route("Nflota_incidencia_detalle")) !== null) {
                    $this->Nflota_incidencia_detalle->setQueryStringValue($keyValue);
                    $loadByQuery = true;
                } else {
                    $this->Nflota_incidencia_detalle->CurrentValue = null;
                }
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoFlotaIncidenciaDetalleList"); // Return to list page
                        return;
                        ...
                        if ($this->Nflota_incidencia_detalle->CurrentValue != null) {
                            while ($this->fetch()) {
                                if (SameString($this->Nflota_incidencia_detalle->CurrentValue, $this->CurrentRow['Nflota_incidencia_detalle'])) {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ScoFlotaIncidenciaDetalleList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ScoFlotaIncidenciaDetalleList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ScoFlotaIncidenciaDetalleList") {
                            ...
                            $returnUrl = "ScoFlotaIncidenciaDetalleList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->Nflota_incidencia_detalle->IsDetailKey) {
    ...
    public function renderRow()
    {
        ...
        $this->Nflota_incidencia_detalle->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoFlotaIncidenciaDetalleList"), "", $this->TableVar, true);
        $pageId = "edit";
