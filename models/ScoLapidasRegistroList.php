 ...
 * Page class
 */
class ScoLapidasRegistroList extends ScoLapidasRegistro
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoLapidasRegistroList";
    ...
    public $FormName = "fsco_lapidas_registrolist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoLapidasRegistroList";
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "ScoLapidasRegistroAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "ScoLapidasRegistroDelete";
        $this->MultiUpdateUrl = "ScoLapidasRegistroUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fsco_lapidas_registrogrid";
        }
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->Nlapidas_registro->AdvancedSearch->toJson(), ","); // Field Nlapidas_registro
        $filterList = Concat($filterList, $this->solicitante->AdvancedSearch->toJson(), ","); // Field solicitante
        $filterList = Concat($filterList, $this->parentesco->AdvancedSearch->toJson(), ","); // Field parentesco
        ...
        $filterList = Concat($filterList, $this->nombre_difunto->AdvancedSearch->toJson(), ","); // Field nombre_difunto
        ...
        $filterList = Concat($filterList, $this->modificacion->AdvancedSearch->toJson(), ","); // Field modificacion
        $filterList = Concat($filterList, $this->modifica->AdvancedSearch->toJson(), ","); // Field modifica
        ...
        $filterList = Concat($filterList, $this->maqueteo->AdvancedSearch->toJson(), ","); // Field maqueteo
        $filterList = Concat($filterList, $this->coordenadas_maqueta->AdvancedSearch->toJson(), ","); // Field coordenadas_maqueta
        $filterList = Concat($filterList, $this->reclamo->AdvancedSearch->toJson(), ","); // Field reclamo
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fsco_lapidas_registrosrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Nlapidas_registro
        $this->Nlapidas_registro->AdvancedSearch->SearchValue = @$filter["x_Nlapidas_registro"];
        $this->Nlapidas_registro->AdvancedSearch->SearchOperator = @$filter["z_Nlapidas_registro"];
        $this->Nlapidas_registro->AdvancedSearch->SearchCondition = @$filter["v_Nlapidas_registro"];
        $this->Nlapidas_registro->AdvancedSearch->SearchValue2 = @$filter["y_Nlapidas_registro"];
        $this->Nlapidas_registro->AdvancedSearch->SearchOperator2 = @$filter["w_Nlapidas_registro"];
        $this->Nlapidas_registro->AdvancedSearch->save();
        ...
        // Field nombre_difunto
        $this->nombre_difunto->AdvancedSearch->SearchValue = @$filter["x_nombre_difunto"];
        $this->nombre_difunto->AdvancedSearch->SearchOperator = @$filter["z_nombre_difunto"];
        $this->nombre_difunto->AdvancedSearch->SearchCondition = @$filter["v_nombre_difunto"];
        $this->nombre_difunto->AdvancedSearch->SearchValue2 = @$filter["y_nombre_difunto"];
        $this->nombre_difunto->AdvancedSearch->SearchOperator2 = @$filter["w_nombre_difunto"];
        $this->nombre_difunto->AdvancedSearch->save();
        ...
        // Field modificacion
        $this->modificacion->AdvancedSearch->SearchValue = @$filter["x_modificacion"];
        $this->modificacion->AdvancedSearch->SearchOperator = @$filter["z_modificacion"];
        $this->modificacion->AdvancedSearch->SearchCondition = @$filter["v_modificacion"];
        $this->modificacion->AdvancedSearch->SearchValue2 = @$filter["y_modificacion"];
        $this->modificacion->AdvancedSearch->SearchOperator2 = @$filter["w_modificacion"];
        $this->modificacion->AdvancedSearch->save();

        // Field modifica
        $this->modifica->AdvancedSearch->SearchValue = @$filter["x_modifica"];
        $this->modifica->AdvancedSearch->SearchOperator = @$filter["z_modifica"];
        $this->modifica->AdvancedSearch->SearchCondition = @$filter["v_modifica"];
        $this->modifica->AdvancedSearch->SearchValue2 = @$filter["y_modifica"];
        $this->modifica->AdvancedSearch->SearchOperator2 = @$filter["w_modifica"];
        $this->modifica->AdvancedSearch->save();
        ...
        // Field maqueteo
        $this->maqueteo->AdvancedSearch->SearchValue = @$filter["x_maqueteo"];
        $this->maqueteo->AdvancedSearch->SearchOperator = @$filter["z_maqueteo"];
        $this->maqueteo->AdvancedSearch->SearchCondition = @$filter["v_maqueteo"];
        $this->maqueteo->AdvancedSearch->SearchValue2 = @$filter["y_maqueteo"];
        $this->maqueteo->AdvancedSearch->SearchOperator2 = @$filter["w_maqueteo"];
        $this->maqueteo->AdvancedSearch->save();

        // Field coordenadas_maqueta
        $this->coordenadas_maqueta->AdvancedSearch->SearchValue = @$filter["x_coordenadas_maqueta"];
        $this->coordenadas_maqueta->AdvancedSearch->SearchOperator = @$filter["z_coordenadas_maqueta"];
        $this->coordenadas_maqueta->AdvancedSearch->SearchCondition = @$filter["v_coordenadas_maqueta"];
        $this->coordenadas_maqueta->AdvancedSearch->SearchValue2 = @$filter["y_coordenadas_maqueta"];
        $this->coordenadas_maqueta->AdvancedSearch->SearchOperator2 = @$filter["w_coordenadas_maqueta"];
        $this->coordenadas_maqueta->AdvancedSearch->save();

        // Field reclamo
        $this->reclamo->AdvancedSearch->SearchValue = @$filter["x_reclamo"];
        $this->reclamo->AdvancedSearch->SearchOperator = @$filter["z_reclamo"];
        $this->reclamo->AdvancedSearch->SearchCondition = @$filter["v_reclamo"];
        $this->reclamo->AdvancedSearch->SearchValue2 = @$filter["y_reclamo"];
        $this->reclamo->AdvancedSearch->SearchOperator2 = @$filter["w_reclamo"];
        $this->reclamo->AdvancedSearch->save();
    ...
    public function advancedSearchWhere($default = false)
    {
        ...
        $this->buildSearchSql($where, $this->Nlapidas_registro, $default, false); // Nlapidas_registro
        $this->buildSearchSql($where, $this->solicitante, $default, false); // solicitante
        $this->buildSearchSql($where, $this->parentesco, $default, false); // parentesco
        ...
        $this->buildSearchSql($where, $this->nombre_difunto, $default, false); // nombre_difunto
        ...
        $this->buildSearchSql($where, $this->registro, $default, false); // registro
        $this->buildSearchSql($where, $this->registra, $default, false); // registra
        $this->buildSearchSql($where, $this->modificacion, $default, false); // modificacion
        $this->buildSearchSql($where, $this->modifica, $default, false); // modifica
        ...
        $this->buildSearchSql($where, $this->maqueteo, $default, false); // maqueteo
        $this->buildSearchSql($where, $this->coordenadas_maqueta, $default, false); // coordenadas_maqueta
        $this->buildSearchSql($where, $this->reclamo, $default, false); // reclamo
        ...
        if (!$default && $this->Command == "search") {
            $this->Nlapidas_registro->AdvancedSearch->save(); // Nlapidas_registro
            ...
            $this->nombre_difunto->AdvancedSearch->save(); // nombre_difunto
            $this->tipo->AdvancedSearch->save(); // tipo
            $this->comentario->AdvancedSearch->save(); // comentario
            $this->estatus->AdvancedSearch->save(); // estatus
            $this->registro->AdvancedSearch->save(); // registro
            $this->registra->AdvancedSearch->save(); // registra
            $this->modificacion->AdvancedSearch->save(); // modificacion
            $this->modifica->AdvancedSearch->save(); // modifica
            ...
            $this->maqueteo->AdvancedSearch->save(); // maqueteo
            $this->coordenadas_maqueta->AdvancedSearch->save(); // coordenadas_maqueta
            $this->reclamo->AdvancedSearch->save(); // reclamo
    ...
    public function showFilterList()
    {
        ...
        // Field Nlapidas_registro
        $filter = $this->queryBuilderWhere("Nlapidas_registro");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->Nlapidas_registro, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->Nlapidas_registro->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
        ...
        // Field parentesco
        $filter = $this->queryBuilderWhere("parentesco");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->parentesco, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->parentesco->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field ci_difunto
        $filter = $this->queryBuilderWhere("ci_difunto");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->ci_difunto, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->ci_difunto->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field nombre_difunto
        $filter = $this->queryBuilderWhere("nombre_difunto");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->nombre_difunto, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->nombre_difunto->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
        ...
        // Field registro
        $filter = $this->queryBuilderWhere("registro");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->registro, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->registro->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field registra
        $filter = $this->queryBuilderWhere("registra");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->registra, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->registra->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }

        // Field modifica
        $filter = $this->queryBuilderWhere("modifica");
        if (!$filter) {
            $this->buildSearchSql($filter, $this->modifica, false, false);
        }
        if ($filter != "") {
            $filterList .= "<div><span class=\"" . $captionClass . "\">" . $this->modifica->caption() . "</span>" . $captionSuffix . $filter . "</div>";
        }
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        $searchFlds[] = &$this->maqueteo;
        $searchFlds[] = &$this->coordenadas_maqueta;
    ...
    protected function checkSearchParms()
    {
        ...
        if ($this->Nlapidas_registro->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->nombre_difunto->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->registro->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->registra->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->modificacion->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->modifica->AdvancedSearch->issetSession()) {
            return true;
        }
        ...
        if ($this->maqueteo->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->coordenadas_maqueta->AdvancedSearch->issetSession()) {
            return true;
        }
        if ($this->reclamo->AdvancedSearch->issetSession()) {
            return true;
        }
        return false;
    }
    ...
    {
        $this->Nlapidas_registro->AdvancedSearch->unsetSession();
        ...
        $this->nombre_difunto->AdvancedSearch->unsetSession();
        $this->tipo->AdvancedSearch->unsetSession();
        $this->comentario->AdvancedSearch->unsetSession();
        $this->estatus->AdvancedSearch->unsetSession();
        $this->registro->AdvancedSearch->unsetSession();
        $this->registra->AdvancedSearch->unsetSession();
        $this->modificacion->AdvancedSearch->unsetSession();
        $this->modifica->AdvancedSearch->unsetSession();
        ...
        $this->maqueteo->AdvancedSearch->unsetSession();
        $this->coordenadas_maqueta->AdvancedSearch->unsetSession();
        $this->reclamo->AdvancedSearch->unsetSession();
    }
    ...
    protected function restoreSearchParms()
    {
        ...
        $this->Nlapidas_registro->AdvancedSearch->load();
        ...
        $this->nombre_difunto->AdvancedSearch->load();
        $this->tipo->AdvancedSearch->load();
        $this->comentario->AdvancedSearch->load();
        $this->estatus->AdvancedSearch->load();
        $this->registro->AdvancedSearch->load();
        $this->registra->AdvancedSearch->load();
        $this->modificacion->AdvancedSearch->load();
        $this->modifica->AdvancedSearch->load();
        ...
        $this->maqueteo->AdvancedSearch->load();
        $this->coordenadas_maqueta->AdvancedSearch->load();
        $this->reclamo->AdvancedSearch->load();
    }
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->Command != "json") {
            $defaultSort = $this->Nlapidas_registro->Expression . " DESC"; // Set up default sort
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Nlapidas_registro); // Nlapidas_registro
            $this->updateSort($this->solicitante); // solicitante
            $this->updateSort($this->parentesco); // parentesco
            $this->updateSort($this->ci_difunto); // ci_difunto
            $this->updateSort($this->nombre_difunto); // nombre_difunto
            $this->updateSort($this->tipo); // tipo
            $this->updateSort($this->estatus); // estatus
            $this->updateSort($this->registro); // registro
            $this->updateSort($this->registra); // registra
            $this->updateSort($this->modifica); // modifica
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Nlapidas_registro->setSort("");
                ...
                $this->maqueteo->setSort("");
                $this->coordenadas_maqueta->setSort("");
                $this->reclamo->setSort("");
            }
    ...
    protected function setupListOptions()
    {
        ...
        $item = &$this->ListOptions->add("detail_sco_lapidas_notas");
        $item->CssClass = "text-nowrap";
        ...
        $item = &$this->ListOptions->add("detail_sco_lapidas_adjunto");
        $item->CssClass = "text-nowrap";
        ...
        // Set up detail pages
        $pages = new SubPages();
        $pages->add("sco_lapidas_notas");
        $pages->add("sco_lapidas_adjunto");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"sco_lapidas_registro\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"sco_lapidas_registro\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fsco_lapidas_registrolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fsco_lapidas_registrolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        // "detail_sco_lapidas_notas"
        $opt = $this->ListOptions["detail_sco_lapidas_notas"];
        if ($Security->allowList(CurrentProjectID() . 'sco_lapidas_notas')) {
            $body = $Language->phrase("DetailLink") . $Language->tablePhrase("sco_lapidas_notas", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("ScoLapidasNotasList?" . Config("TABLE_SHOW_MASTER") . "=sco_lapidas_registro&" . GetForeignKeyUrl("fk_Nlapidas_registro", $this->Nlapidas_registro->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ScoLapidasNotasGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_lapidas_registro')) {
                $caption = $Language->phrase("MasterDetailViewLink", null);
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_notas");
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_lapidas_registro')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_notas");
        ...
        // "detail_sco_lapidas_adjunto"
        $opt = $this->ListOptions["detail_sco_lapidas_adjunto"];
        if ($Security->allowList(CurrentProjectID() . 'sco_lapidas_adjunto')) {
            $body = $Language->phrase("DetailLink") . $Language->tablePhrase("sco_lapidas_adjunto", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("ScoLapidasAdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=sco_lapidas_registro&" . GetForeignKeyUrl("fk_Nlapidas_registro", $this->Nlapidas_registro->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ScoLapidasAdjuntoGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_lapidas_registro')) {
                $caption = $Language->phrase("MasterDetailViewLink", null);
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_adjunto");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
            ...
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_lapidas_registro')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_adjunto");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->Nlapidas_registro->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function renderListOptionsExt()
    {
        ...
        $detailFilters = [];
        $masterKeys = []; // Reset
        $masterKeys["Nlapidas_registro"] = strval($this->Nlapidas_registro->DbValue);

        // Column "detail_sco_lapidas_notas"
        if ($this->DetailPages?->getItem("sco_lapidas_notas")?->Visible && $Security->allowList(CurrentProjectID() . 'sco_lapidas_notas')) {
            $link = "";
            $option = $this->ListOptions["detail_sco_lapidas_notas"];
            $detailTbl = Container("sco_lapidas_notas");
            $detailFilter = $detailTbl->getDetailFilter($this);
            $detailTbl->setCurrentMasterTable($this->TableVar);
            $detailFilter = $detailTbl->applyUserIDFilters($detailFilter);
            $url = "ScoLapidasNotasPreview?t=sco_lapidas_registro&f=" . Encrypt($detailFilter . "|" . implode("|", array_values($masterKeys)));
            $btngrp = "<div data-table=\"sco_lapidas_notas\" data-url=\"" . $url . "\" class=\"ew-detail-btn-group d-none\">";
            if ($Security->allowList(CurrentProjectID() . 'sco_lapidas_registro')) {
                $label = $Language->tablePhrase("sco_lapidas_notas", "TblCaption");
                $link = "<button class=\"nav-link\" data-bs-toggle=\"tab\" data-table=\"sco_lapidas_notas\" data-url=\"" . $url . "\" type=\"button\" role=\"tab\" aria-selected=\"false\">" . $label . "</button>";
                $detaillnk = GetUrl("ScoLapidasNotasList?" . Config("TABLE_SHOW_MASTER") . "=sco_lapidas_registro");
                foreach ($masterKeys as $key => $value) {
                    $detaillnk .= "&" . GetForeignKeyUrl("fk_$key", $value);
                }
                $title = $Language->tablePhrase("sco_lapidas_notas", "TblCaption");
            ...
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_lapidas_registro')) {
                ...
                $viewurl = GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_notas"));
            ...
            if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_lapidas_registro')) {
                ...
                $editurl = GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_notas"));
        ...
        // Column "detail_sco_lapidas_adjunto"
        if ($this->DetailPages?->getItem("sco_lapidas_adjunto")?->Visible && $Security->allowList(CurrentProjectID() . 'sco_lapidas_adjunto')) {
            $link = "";
            $option = $this->ListOptions["detail_sco_lapidas_adjunto"];
            $detailTbl = Container("sco_lapidas_adjunto");
            $detailFilter = $detailTbl->getDetailFilter($this);
            $detailTbl->setCurrentMasterTable($this->TableVar);
            $detailFilter = $detailTbl->applyUserIDFilters($detailFilter);
            $url = "ScoLapidasAdjuntoPreview?t=sco_lapidas_registro&f=" . Encrypt($detailFilter . "|" . implode("|", array_values($masterKeys)));
            $btngrp = "<div data-table=\"sco_lapidas_adjunto\" data-url=\"" . $url . "\" class=\"ew-detail-btn-group d-none\">";
            if ($Security->allowList(CurrentProjectID() . 'sco_lapidas_registro')) {
                $label = $Language->tablePhrase("sco_lapidas_adjunto", "TblCaption");
                $link = "<button class=\"nav-link\" data-bs-toggle=\"tab\" data-table=\"sco_lapidas_adjunto\" data-url=\"" . $url . "\" type=\"button\" role=\"tab\" aria-selected=\"false\">" . $label . "</button>";
                $detaillnk = GetUrl("ScoLapidasAdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=sco_lapidas_registro");
                foreach ($masterKeys as $key => $value) {
                    $detaillnk .= "&" . GetForeignKeyUrl("fk_$key", $value);
                }
                $title = $Language->tablePhrase("sco_lapidas_adjunto", "TblCaption");
                $caption = $Language->phrase("MasterDetailListLink");
                $btngrp .= "<a href=\"#\" class=\"me-2\" title=\"" . $title . "\" data-ew-action=\"redirect\" data-url=\"" . HtmlEncode($detaillnk) . "\">" . $caption . "</a>";
            }
            ...
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_lapidas_registro')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $viewurl = GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_adjunto"));
                $btngrp .= "<a href=\"#\" class=\"me-2\" title=\"" . HtmlTitle($caption) . "\" data-ew-action=\"redirect\" data-url=\"" . HtmlEncode($viewurl) . "\">" . $caption . "</a>";
            }
            if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_lapidas_registro')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $editurl = GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_adjunto"));
                $btngrp .= "<a href=\"#\" class=\"me-2\" title=\"" . HtmlTitle($caption) . "\" data-ew-action=\"redirect\" data-url=\"" . HtmlEncode($editurl) . "\">" . $caption . "</a>";
            }
            $btngrp .= "</div>";
            if ($link != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"sco_lapidas_registro\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $detailTableLink = "";
        $item = &$option->add("detailadd_sco_lapidas_notas");
        $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_notas");
        $detailPage = Container("ScoLapidasNotasGrid");
        $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
        $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
        $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'sco_lapidas_registro') && $Security->canAdd());
        if ($item->Visible) {
            if ($detailTableLink != "") {
                $detailTableLink .= ",";
            }
        ...
        $item = &$option->add("detailadd_sco_lapidas_adjunto");
        $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=sco_lapidas_adjunto");
        $detailPage = Container("ScoLapidasAdjuntoGrid");
        $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
        $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
        $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'sco_lapidas_registro') && $Security->canAdd());
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "Nlapidas_registro");
            $this->createColumnOption($option, "solicitante");
            $this->createColumnOption($option, "parentesco");
            $this->createColumnOption($option, "ci_difunto");
            $this->createColumnOption($option, "nombre_difunto");
            $this->createColumnOption($option, "tipo");
            $this->createColumnOption($option, "estatus");
            $this->createColumnOption($option, "registro");
            $this->createColumnOption($option, "registra");
            $this->createColumnOption($option, "modifica");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fsco_lapidas_registrosrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fsco_lapidas_registrosrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fsco_lapidas_registrolist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_sco_lapidas_registro", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_sco_lapidas_registro",
    ...
    protected function loadSearchValues()
    {
        ...
        // Nlapidas_registro
        if ($this->Nlapidas_registro->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->Nlapidas_registro->AdvancedSearch->SearchValue != "" || $this->Nlapidas_registro->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // parentesco
        if ($this->parentesco->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->parentesco->AdvancedSearch->SearchValue != "" || $this->parentesco->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // nombre_difunto
        if ($this->nombre_difunto->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->nombre_difunto->AdvancedSearch->SearchValue != "" || $this->nombre_difunto->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // registro
        if ($this->registro->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->registro->AdvancedSearch->SearchValue != "" || $this->registro->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // registra
        if ($this->registra->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->registra->AdvancedSearch->SearchValue != "" || $this->registra->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // modificacion
        if ($this->modificacion->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->modificacion->AdvancedSearch->SearchValue != "" || $this->modificacion->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // modifica
        if ($this->modifica->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->modifica->AdvancedSearch->SearchValue != "" || $this->modifica->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        ...
        // maqueteo
        if ($this->maqueteo->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->maqueteo->AdvancedSearch->SearchValue != "" || $this->maqueteo->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // coordenadas_maqueta
        if ($this->coordenadas_maqueta->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->coordenadas_maqueta->AdvancedSearch->SearchValue != "" || $this->coordenadas_maqueta->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }

        // reclamo
        if ($this->reclamo->AdvancedSearch->get()) {
            $hasValue = true;
            if (($this->reclamo->AdvancedSearch->SearchValue != "" || $this->reclamo->AdvancedSearch->SearchValue2 != "") && $this->Command == "") {
                $this->Command = "search";
            }
        }
        return $hasValue;
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->Nlapidas_registro->EditValue = $this->Nlapidas_registro->AdvancedSearch->SearchValue;
            $this->Nlapidas_registro->PlaceHolder = RemoveHtml($this->Nlapidas_registro->caption());
            ...
            if (!$this->ci_difunto->Raw) {
                $this->ci_difunto->AdvancedSearch->SearchValue = HtmlDecode($this->ci_difunto->AdvancedSearch->SearchValue);
            }
            $this->ci_difunto->EditValue = HtmlEncode($this->ci_difunto->AdvancedSearch->SearchValue);
            ...
            if (!$this->nombre_difunto->Raw) {
                $this->nombre_difunto->AdvancedSearch->SearchValue = HtmlDecode($this->nombre_difunto->AdvancedSearch->SearchValue);
            }
            $this->nombre_difunto->EditValue = HtmlEncode($this->nombre_difunto->AdvancedSearch->SearchValue);
            ...
            $this->registro->EditValue = HtmlEncode(FormatDateTime(UnFormatDateTime($this->registro->AdvancedSearch->SearchValue, $this->registro->formatPattern()), $this->registro->formatPattern()));
            $this->registro->PlaceHolder = RemoveHtml($this->registro->caption());
            $this->registro->setupEditAttributes();
            $this->registro->EditValue2 = HtmlEncode(FormatDateTime(UnFormatDateTime($this->registro->AdvancedSearch->SearchValue2, $this->registro->formatPattern()), $this->registro->formatPattern()));
            $this->registro->PlaceHolder = RemoveHtml($this->registro->caption());

            // registra
            $this->registra->setupEditAttributes();
            $curVal = trim(strval($this->registra->AdvancedSearch->SearchValue));
            if ($curVal != "") {
                $this->registra->AdvancedSearch->ViewValue = $this->registra->lookupCacheOption($curVal);
            } else {
                $this->registra->AdvancedSearch->ViewValue = $this->registra->Lookup !== null && is_array($this->registra->lookupOptions()) && count($this->registra->lookupOptions()) > 0 ? $curVal : null;
            }
            if ($this->registra->AdvancedSearch->ViewValue !== null) { // Load from cache
                $this->registra->EditValue = array_values($this->registra->lookupOptions());
            } else { // Lookup from database
                if ($curVal == "") {
                    $filterWrk = "0=1";
                } else {
                    $filterWrk = SearchFilter($this->registra->Lookup->getTable()->Fields["username"]->searchExpression(), "=", $this->registra->AdvancedSearch->SearchValue, $this->registra->Lookup->getTable()->Fields["username"]->searchDataType(), "");
                }
                $sqlWrk = $this->registra->Lookup->getSql(true, $filterWrk, '', $this, false, true);
                $conn = Conn();
                $config = $conn->getConfiguration();
                $config->setResultCache($this->Cache);
                $rswrk = $conn->executeCacheQuery($sqlWrk, [], [], $this->CacheProfile)->fetchAll();
                $ari = count($rswrk);
                $arwrk = $rswrk;
                $this->registra->EditValue = $arwrk;
            }
            $this->registra->PlaceHolder = RemoveHtml($this->registra->caption());

            // modifica
            $this->modifica->setupEditAttributes();
            $curVal = trim(strval($this->modifica->AdvancedSearch->SearchValue));
            if ($curVal != "") {
                $this->modifica->AdvancedSearch->ViewValue = $this->modifica->lookupCacheOption($curVal);
            } else {
                $this->modifica->AdvancedSearch->ViewValue = $this->modifica->Lookup !== null && is_array($this->modifica->lookupOptions()) && count($this->modifica->lookupOptions()) > 0 ? $curVal : null;
            }
            if ($this->modifica->AdvancedSearch->ViewValue !== null) { // Load from cache
                $this->modifica->EditValue = array_values($this->modifica->lookupOptions());
            } else { // Lookup from database
                if ($curVal == "") {
                    $filterWrk = "0=1";
                } else {
                    $filterWrk = SearchFilter($this->modifica->Lookup->getTable()->Fields["username"]->searchExpression(), "=", $this->modifica->AdvancedSearch->SearchValue, $this->modifica->Lookup->getTable()->Fields["username"]->searchDataType(), "");
                }
                $sqlWrk = $this->modifica->Lookup->getSql(true, $filterWrk, '', $this, false, true);
                $conn = Conn();
                $config = $conn->getConfiguration();
                $config->setResultCache($this->Cache);
                $rswrk = $conn->executeCacheQuery($sqlWrk, [], [], $this->CacheProfile)->fetchAll();
    ...
    protected function validateSearch()
    {
        ...
        if (!CheckInteger($this->Nlapidas_registro->AdvancedSearch->SearchValue)) {
            $this->Nlapidas_registro->addErrorMessage($this->Nlapidas_registro->getErrorMessage(false));
        }
        if (!CheckDate($this->registro->AdvancedSearch->SearchValue, $this->registro->formatPattern())) {
            $this->registro->addErrorMessage($this->registro->getErrorMessage(false));
        }
        if (!CheckDate($this->registro->AdvancedSearch->SearchValue2, $this->registro->formatPattern())) {
            $this->registro->addErrorMessage($this->registro->getErrorMessage(false));
        }
    ...
    protected function getExportTag($type, $custom = false)
    {
        ...
        if (SameText($type, "excel")) {
            ...
            return '<button type="button" class="btn btn-default ew-export-link ew-email" title="' . $Language->phrase("ExportToEmail", true) . '" data-caption="' . $Language->phrase("ExportToEmail", true) . '" form="fsco_lapidas_registrolist" data-ew-action="email" data-custom="false" data-hdr="' . $Language->phrase("ExportToEmail", true) . '" data-exported-selected="false"' . $url . '>' . $Language->phrase("ExportToEmail") . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fsco_lapidas_registrosrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    */
    ...
    public function pageDataRendering(&$header) {
        // 1. Botón de Exportación Estilizado
        $btnExport = '<div class="mb-3">
                        <a href="dashboard/ListadoMaster?id=lapidas" class="btn btn-outline-success btn-sm shadow-sm">
                            <i class="fas fa-file-excel mr-1"></i> Exportar Listado a Excel
                        </a>
                      </div>';

        // 2. Leyenda de Estatus usando Badges de Bootstrap
        // Definimos los estilos en un contenedor flexible para que sea responsive
        $leyenda = '<div class="d-flex flex-wrap gap-2 mb-4" style="font-size: 0.85rem;">';
        $statusItems = [
            ['label' => 'RECIBIDO',          'bg' => '#dc3545', 'color' => 'white'], // Rojo
            ['label' => 'PROCESANDO BOCETO', 'bg' => '#ffc107', 'color' => 'black'], // Amarillo
            ['label' => 'IMPRESO',           'bg' => '#007bff', 'color' => 'white'], // Azul
            ['label' => 'INSTALADA',         'bg' => '#28a745', 'color' => 'white'], // Verde
            ['label' => 'ANULADO',           'bg' => '#6c757d', 'color' => 'white']  // Gris
        ];
        foreach ($statusItems as $item) {
            $leyenda .= sprintf(
                '<span class="badge shadow-sm p-2" style="background-color: %s; color: %s; min-width: 120px; border-radius: 4px;">
                    <i class="fas fa-info-circle mr-1" style="opacity: 0.7;"></i> %s
                </span>',
                $item['bg'],
                $item['color'],
                $item['label']
        ...
        // 3. Asignación al Header
        $header = $btnExport . $leyenda;

        // 4. Ocultar columnas técnicas
        $fieldsToHide = ['seccion', 'modulo', 'sub_seccion', 'parcela', 'boveda'];
        foreach ($fieldsToHide as $f) {
            if (isset($this->$f)) {
    ...
    public function pageDataRendered(&$footer) {
        // 1. Definición de los estados (mantenemos los mismos colores para coherencia)
        $statusItems = [
            ['label' => 'RECIBIDO',          'bg' => '#dc3545', 'color' => 'white', 'icon' => 'fa-clock'],
            ['label' => 'PROCESANDO BOCETO', 'bg' => '#ffc107', 'color' => 'black', 'icon' => 'fa-pen-nib'],
            ['label' => 'IMPRESO',           'bg' => '#007bff', 'color' => 'white', 'icon' => 'fa-print'],
            ['label' => 'INSTALADA',         'bg' => '#28a745', 'color' => 'white', 'icon' => 'fa-check-circle'],
            ['label' => 'ANULADO',           'bg' => '#6c757d', 'color' => 'white', 'icon' => 'fa-times-circle']
        ];

        // 2. Construcción del contenedor con Flexbox
        $html = '<div class="card shadow-sm mt-4">';
        $html .= '  <div class="card-body">';
        $html .= '    <h6 class="card-title text-muted mb-3"><i class="fas fa-map-signs mr-2"></i> Leyenda de Estatus</h6>';
        $html .= '    <div class="d-flex flex-wrap gap-2">';
        foreach ($statusItems as $item) {
            $html .= sprintf(
                '<div class="d-flex align-items-center p-2 border rounded bg-light" style="min-width: 180px;">
                    <div class="mr-3" style="width: 12px; height: 12px; border-radius: 50%%; background-color: %s; box-shadow: 0 0 5px %s;"></div>
                    <span style="font-size: 0.8rem; font-weight: 600; color: #444;">%s</span>
                    <i class="fas %s ml-auto text-muted" style="font-size: 0.75rem; opacity: 0.5;"></i>
                </div>',
                $item['bg'],
                $item['bg'],
                $item['label'],
    ...
    public function listOptionsLoad() {
    	...
    	$opt = &$this->ListOptions->Add("new4");
    	$opt->Header = "Adj";
    	$opt->OnLeft = TRUE; // Link on left
    	$opt->MoveTo(8); // Move to last column
    }
    ...
    public function listOptionsRendered() {
        // 1. Cálculo de fechas y tiempo transcurrido
        $fd = $this->registro->CurrentValue ?? date("Y-m-d");
        $estatus = $this->estatus->CurrentValue;

        // Si está instalada o anulada, usamos fecha de modificación, sino la fecha actual
        $fh = (in_array($estatus, ["INSTALADA", "ANULADO"])) 
              ? ($this->modificacion->CurrentValue ?? date("Y-m-d")) 
              : date("Y-m-d");
        if (isset($this->ListOptions->Items["new"])) {
            $this->ListOptions->Items["new"]->Body = tiempoTranscurridoFechas($fd, $fh);
        }

        // 2. Optimización de Consultas (Notas y Adjuntos)
        // Usamos el ID de registro de forma segura
        $idRegistro = $this->Nlapidas_registro->CurrentValue;
        if ($idRegistro) {
            // Validación de Notas (Icono de archivo)
            if (isset($this->ListOptions->Items["new3"])) {
                $hasNotes = ExecuteScalar("SELECT COUNT(*) FROM sco_lapidas_notas WHERE lapida_registro = " . Conn()->quote($idRegistro));
                $this->ListOptions->Items["new3"]->Body = ($hasNotes > 0) 
                    ? '<span class="fas fa-file-alt text-info" title="Tiene notas"></span>' 
                    : '';
            }

            // Validación de Adjuntos (Icono de clip)
            if (isset($this->ListOptions->Items["new4"])) {
                $hasFiles = ExecuteScalar("SELECT COUNT(*) FROM sco_lapidas_adjunto WHERE lapida_registro = " . Conn()->quote($idRegistro));
                $this->ListOptions->Items["new4"]->Body = ($hasFiles > 0) 
                    ? '<span class="fas fa-paperclip text-primary" title="Tiene adjuntos"></span>' 
                    : '';
            }
        }

        // 3. Control de visibilidad de columnas técnicas
