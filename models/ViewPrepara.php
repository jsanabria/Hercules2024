...
/**
 * Table class for view_prepara
 */
class ViewPrepara extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->fecha_inicio->addMethod("getSearchDefault", fn() => date('Y-m-d'));
        ...
        $this->fecha_inicio->AdvancedSearch->SearchValueDefault = $this->fecha_inicio->getSearchDefault();
        $this->fecha_inicio->AdvancedSearch->SearchOperatorDefault = ">=";
        $this->fecha_inicio->AdvancedSearch->SearchOperator2Default = "";
        $this->fecha_inicio->AdvancedSearch->SearchConditionDefault = "AND";
        ...
        $this->hora_sepelio->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_FORMAT"], $Language->phrase("IncorrectTime"));
        ...
        $this->hora_ofirel->DefaultErrorMessage = str_replace("%s", $GLOBALS["TIME_FORMAT"], $Language->phrase("IncorrectTime"));
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_prepara";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewPreparaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewPreparaView" => $Language->phrase("View"),
            "ViewPreparaEdit" => $Language->phrase("Edit"),
            "ViewPreparaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewPreparaView",
            Config("API_ADD_ACTION") => "ViewPreparaAdd",
            Config("API_EDIT_ACTION") => "ViewPreparaEdit",
            Config("API_DELETE_ACTION") => "ViewPreparaDelete",
            Config("API_LIST_ACTION") => "ViewPreparaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewPreparaView", $parm);
        } else {
            $url = $this->keyUrl("ViewPreparaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPreparaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPreparaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPreparaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewPreparaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewPreparaDelete", $parm);
        }
    }
