 ...
 * Page class
 */
class ScoNotificacionesAdd extends ScoNotificaciones
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotificacionesAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoNotificacionesAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoNotificacionesView") {
