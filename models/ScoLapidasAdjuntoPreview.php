 ...
 * Page class
 */
class ScoLapidasAdjuntoPreview extends ScoLapidasAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoLapidasAdjuntoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoLapidasAdjuntoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sco_lapidas_registro") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_lapidas_registro&" . GetForeignKeyUrl("fk_Nlapidas_registro", $this->lapida_registro->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "sco_lapidas_registro") {
            $this->lapida_registro->setQueryStringValue($keys[0] ?? "");
        }
    }
