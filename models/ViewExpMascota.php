...
/**
 * Table class for view_exp_mascota
 */
class ViewExpMascota extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_exp_mascota";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_exp_mascota";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewExpMascotaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewExpMascotaView" => $Language->phrase("View"),
            "ViewExpMascotaEdit" => $Language->phrase("Edit"),
            "ViewExpMascotaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewExpMascotaView",
            Config("API_ADD_ACTION") => "ViewExpMascotaAdd",
            Config("API_EDIT_ACTION") => "ViewExpMascotaEdit",
            Config("API_DELETE_ACTION") => "ViewExpMascotaDelete",
            Config("API_LIST_ACTION") => "ViewExpMascotaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewExpMascotaView", $parm);
        } else {
            $url = $this->keyUrl("ViewExpMascotaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewExpMascotaAdd?" . $parm;
        } else {
            $url = "ViewExpMascotaAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewExpMascotaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewExpMascotaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewExpMascotaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewExpMascotaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewExpMascotaDelete", $parm);
        }
    }
