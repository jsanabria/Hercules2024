 ...
 * Page class
 */
class ScoExpedienteCiaGrid extends ScoExpedienteCia
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteCiaGrid";
    ...
    public $FormName = "fsco_expediente_ciagrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoExpedienteCiaGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nexpediente_cia->CurrentValue;
    ...
    public function emptyRow()
    {
        global $CurrentForm;
        if (
            $CurrentForm->hasValue("x_cia") &&
            $CurrentForm->hasValue("o_cia") &&
            $this->cia->CurrentValue != $this->cia->DefaultValue &&
            !($this->cia->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->cia->CurrentValue == $this->cia->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_expediente") &&
            $CurrentForm->hasValue("o_expediente") &&
            $this->expediente->CurrentValue != $this->expediente->DefaultValue &&
            !($this->expediente->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->expediente->CurrentValue == $this->expediente->getSessionValue())
        ) {
            return false;
        }
        if (
        ...
        if (
            $CurrentForm->hasValue("x_factura") &&
            $CurrentForm->hasValue("o_factura") &&
            $this->factura->CurrentValue != $this->factura->DefaultValue &&
            !($this->factura->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->factura->CurrentValue == $this->factura->getSessionValue())
        ) {
            return false;
        }
        if (
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_cia")) {
            $this->cia->setOldValue($CurrentForm->getValue("o_cia"));
        }
        ...
        if ($CurrentForm->hasValue("o_expediente")) {
            $this->expediente->setOldValue($CurrentForm->getValue("o_expediente"));
        }
        ...
        if ($CurrentForm->hasValue("o_factura")) {
            $this->factura->setOldValue($CurrentForm->getValue("o_factura"));
        }
        ...
        if (!$this->Nexpediente_cia->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->expediente->getSessionValue() != "") {
                ...
                $this->expediente->OldValue = $this->expediente->CurrentValue;
                $this->expediente->ViewValue = $this->expediente->CurrentValue;
                $curVal = strval($this->expediente->CurrentValue);
                if ($curVal != "") {
                    $this->expediente->ViewValue = $this->expediente->lookupCacheOption($curVal);
