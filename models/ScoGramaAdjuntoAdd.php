 ...
 * Page class
 */
class ScoGramaAdjuntoAdd extends ScoGramaAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaAdjuntoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoGramaAdjuntoAdd";
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ScoGramaAdjuntoList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ScoGramaAdjuntoList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ScoGramaAdjuntoView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ScoGramaAdjuntoList") {
                            ...
                            $returnUrl = "ScoGramaAdjuntoList"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->archivo->UseColorbox) {
                ...
                $this->archivo->LinkAttrs["data-rel"] = "sco_grama_adjunto_x_archivo";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoGramaAdjuntoList"), "", $this->TableVar, true);
