 ...
 * Page class
 */
class ScoNotaOrdenCompraEdit extends ScoNotaOrdenCompra
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotaOrdenCompraEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoNotaOrdenCompraEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("Nnota_orden_compra") ?? Key(0) ?? Route(2)) !== null) {
                $this->Nnota_orden_compra->setQueryStringValue($keyValue);
                $this->Nnota_orden_compra->setOldValue($this->Nnota_orden_compra->QueryStringValue);
            } elseif (Post("Nnota_orden_compra") !== null) {
                $this->Nnota_orden_compra->setFormValue(Post("Nnota_orden_compra"));
                $this->Nnota_orden_compra->setOldValue($this->Nnota_orden_compra->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                $loadByQuery = false;
                if (($keyValue = Get("Nnota_orden_compra") ?? Route("Nnota_orden_compra")) !== null) {
                    $this->Nnota_orden_compra->setQueryStringValue($keyValue);
                    $loadByQuery = true;
                } else {
                    $this->Nnota_orden_compra->CurrentValue = null;
                }
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoNotaOrdenCompraList"); // Return to list page
                        return;
                        ...
                        if ($this->Nnota_orden_compra->CurrentValue != null) {
                            while ($this->fetch()) {
                                if (SameString($this->Nnota_orden_compra->CurrentValue, $this->CurrentRow['Nnota_orden_compra'])) {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ScoNotaOrdenCompraList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ScoNotaOrdenCompraList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ScoNotaOrdenCompraList") {
                            ...
                            $returnUrl = "ScoNotaOrdenCompraList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->Nnota_orden_compra->IsDetailKey) {
    ...
    public function renderRow()
    {
        ...
        // Nnota_orden_compra
        $this->Nnota_orden_compra->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoNotaOrdenCompraList"), "", $this->TableVar, true);
        $pageId = "edit";
