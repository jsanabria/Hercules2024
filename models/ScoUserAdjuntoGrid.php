 ...
 * Page class
 */
class ScoUserAdjuntoGrid extends ScoUserAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoUserAdjuntoGrid";
    ...
    public $FormName = "fsco_user_adjuntogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoUserAdjuntoGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nuser_adjunto->CurrentValue;
    ...
    {
        $this->user->DefaultValue = $this->user->getDefault(); // PHP
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'Nuser_adjunto' first before field var 'x_Nuser_adjunto'
        $val = $CurrentForm->hasValue("Nuser_adjunto") ? $CurrentForm->getValue("Nuser_adjunto") : $CurrentForm->getValue("x_Nuser_adjunto");
        if (!$this->Nuser_adjunto->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->Nuser_adjunto->setFormValue($val);
        }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->Nuser_adjunto->CurrentValue = $this->Nuser_adjunto->FormValue;
        }
    ...
    protected function getAddRow()
    {
        ...
        if ($this->user->getSessionValue() != "") {
            $rsnew['user'] = $this->user->getSessionValue();
        }
        return $rsnew;
    }
