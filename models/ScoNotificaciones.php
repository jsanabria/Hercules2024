...
/**
 * Table class for sco_notificaciones
 */
class ScoNotificaciones extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "sco_notificaciones";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->tipo->addMethod("getSelectFilter", fn() => "`codigo` = '041'");
        ...
        $this->tipo->Lookup = new Lookup($this->tipo, 'sco_parametro', false, 'valor1', ["valor2","","",""], '', '', [], [], [], [], [], [], false, '`codigo`', '', "`valor2`");
        ...
        $this->notificar->addMethod("getSelectFilter", fn() => "`codigo` = '040'");
        ...
        $this->notificar->Lookup = new Lookup($this->notificar, 'sco_parametro', false, 'valor1', ["valor2","","",""], '', '', [], [], [], [], [], [], false, '`valor1`', '', "`valor2`");
        ...
        $this->enviado->Lookup = new Lookup($this->enviado, 'sco_notificaciones', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "sco_notificaciones";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ScoNotificacionesList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ScoNotificacionesView" => $Language->phrase("View"),
            "ScoNotificacionesEdit" => $Language->phrase("Edit"),
            "ScoNotificacionesAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ScoNotificacionesView",
            Config("API_ADD_ACTION") => "ScoNotificacionesAdd",
            Config("API_EDIT_ACTION") => "ScoNotificacionesEdit",
            Config("API_DELETE_ACTION") => "ScoNotificacionesDelete",
            Config("API_LIST_ACTION") => "ScoNotificacionesList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ScoNotificacionesView", $parm);
        } else {
            $url = $this->keyUrl("ScoNotificacionesView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ScoNotificacionesAdd?" . $parm;
        } else {
            $url = "ScoNotificacionesAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoNotificacionesEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoNotificacionesList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoNotificacionesAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoNotificacionesList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ScoNotificacionesDelete", $parm);
        }
    }
    ...
    {
        global $Response;
        $listPage = "ScoNotificacionesList";
    ...
    public function renderListRow()
    {
        ...
        if ($this->adjunto->UseColorbox) {
            ...
            $this->adjunto->LinkAttrs["data-rel"] = "sco_notificaciones_x_adjunto";
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'sco_notificaciones');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'sco_notificaciones', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'sco_notificaciones', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'sco_notificaciones', $fldname, $key, $oldvalue);
            }
        }
    }
