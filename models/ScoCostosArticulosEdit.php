 ...
 * Page class
 */
class ScoCostosArticulosEdit extends ScoCostosArticulos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCostosArticulosEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCostosArticulosEdit";
    ...
    public function run()
    {
        ...
        $this->Ncostos_articulo->Required = false;
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("Ncostos_articulo") ?? Key(0) ?? Route(2)) !== null) {
                $this->Ncostos_articulo->setQueryStringValue($keyValue);
                $this->Ncostos_articulo->setOldValue($this->Ncostos_articulo->QueryStringValue);
            } elseif (Post("Ncostos_articulo") !== null) {
                $this->Ncostos_articulo->setFormValue(Post("Ncostos_articulo"));
                $this->Ncostos_articulo->setOldValue($this->Ncostos_articulo->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("Ncostos_articulo") ?? Route("Ncostos_articulo")) !== null) {
                    ...
                    $this->Ncostos_articulo->CurrentValue = null;
                }
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoCostosArticulosList"); // Return to list page
                        return;
                        ...
                        if ($this->Ncostos_articulo->CurrentValue != null) {
                            while ($this->fetch()) {
                                if (SameString($this->Ncostos_articulo->CurrentValue, $this->CurrentRow['Ncostos_articulo'])) {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ScoCostosArticulosList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
                break;
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ScoCostosArticulosList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ScoCostosArticulosList") {
                            ...
                            $returnUrl = "ScoCostosArticulosList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
    ...
    public function renderRow()
    {
        ...
        // Ncostos_articulo
        $this->Ncostos_articulo->RowCssClass = "row";
        ...
        // tipo_hercules
        $this->tipo_hercules->RowCssClass = "row";

        // articulo_hercules
        $this->articulo_hercules->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoCostosArticulosList"), "", $this->TableVar, true);
        $pageId = "edit";
