    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($curVal != "") {
                ...
                $this->user->AdvancedSearch->ViewValue = $this->user->Lookup !== null && is_array($this->user->lookupOptions()) && count($this->user->lookupOptions()) > 0 ? $curVal : null;
            }
            if ($this->user->AdvancedSearch->ViewValue !== null) { // Load from cache
                ...
                if ($curVal == "") {
                    ...
                    $filterWrk = SearchFilter($this->user->Lookup->getTable()->Fields["username"]->searchExpression(), "=", $this->user->AdvancedSearch->SearchValue, $this->user->Lookup->getTable()->Fields["username"]->searchDataType(), "");
                }
