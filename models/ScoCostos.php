...
/**
 * Table class for sco_costos
 */
class ScoCostos extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Ncostos
        $this->Ncostos = new DbField(
            $this, // Table
            'x_Ncostos', // Variable name
            'Ncostos', // Name
            '`Ncostos`', // Expression
            '`Ncostos`', // Basic search expression
            20, // Type
            20, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`Ncostos`', // Virtual expression
            false, // Is virtual
        ...
        $this->Ncostos->InputTextType = "text";
        $this->Ncostos->Raw = true;
        $this->Ncostos->IsAutoIncrement = true; // Autoincrement field
        $this->Ncostos->IsPrimaryKey = true; // Primary key field
        $this->Ncostos->Nullable = false; // NOT NULL field
        $this->Ncostos->DefaultErrorMessage = $Language->phrase("IncorrectInteger");
        $this->Ncostos->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        $this->Fields['Ncostos'] = &$this->Ncostos;
        ...
        $this->tipo->Lookup = new Lookup($this->tipo, 'sco_costos_tipos', false, 'Ncostos_tipos', ["descripcion","","",""], '', '', [], ["x_costos_articulos"], [], [], [], [], false, '`descripcion` ASC', '', "`descripcion`");
        $this->tipo->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['tipo'] = &$this->tipo;

        // costos_articulos
        $this->costos_articulos = new DbField(
            $this, // Table
            'x_costos_articulos', // Variable name
            'costos_articulos', // Name
            '`costos_articulos`', // Expression
            '`costos_articulos`', // Basic search expression
            200, // Type
            10, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`costos_articulos`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->costos_articulos->InputTextType = "text";
        $this->costos_articulos->Required = true; // Required field
        $this->costos_articulos->setSelectMultiple(false); // Select one
        $this->costos_articulos->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->costos_articulos->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->costos_articulos->Lookup = new Lookup($this->costos_articulos, 'sco_costos_articulos', false, 'Ncostos_articulo', ["Ncostos_articulo","descripcion","",""], '', '', ["x_tipo"], [], ["tipo"], ["x_tipo"], [], [], false, '`descripcion` ASC', '', "CONCAT(COALESCE(`Ncostos_articulo`, ''),'" . ValueSeparator(1, $this->costos_articulos) . "',COALESCE(`descripcion`,''))");
        $this->costos_articulos->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        $this->Fields['costos_articulos'] = &$this->costos_articulos;

        // precio_actual
        $this->precio_actual = new DbField(
            $this, // Table
            'x_precio_actual', // Variable name
            'precio_actual', // Name
            '`precio_actual`', // Expression
            '`precio_actual`', // Basic search expression
            5, // Type
            22, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`precio_actual`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->precio_actual->addMethod("getDefault", fn() => 0);
        $this->precio_actual->InputTextType = "text";
        $this->precio_actual->Raw = true;
        $this->precio_actual->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->precio_actual->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['precio_actual'] = &$this->precio_actual;

        // porcentaje_aplicado
        $this->porcentaje_aplicado = new DbField(
            $this, // Table
            'x_porcentaje_aplicado', // Variable name
            'porcentaje_aplicado', // Name
            '`porcentaje_aplicado`', // Expression
            '`porcentaje_aplicado`', // Basic search expression
            4, // Type
            12, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`porcentaje_aplicado`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->porcentaje_aplicado->addMethod("getDefault", fn() => 0);
        $this->porcentaje_aplicado->InputTextType = "text";
        $this->porcentaje_aplicado->Raw = true;
        $this->porcentaje_aplicado->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->porcentaje_aplicado->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['porcentaje_aplicado'] = &$this->porcentaje_aplicado;
        ...
        $this->precio_nuevo->addMethod("getDefault", fn() => 0);
        ...
        $this->alicuota_iva->addMethod("getDefault", fn() => 0);
        ...
        $this->monto_iva->addMethod("getDefault", fn() => 0);
        ...
        $this->cerrado->Lookup = new Lookup($this->cerrado, 'sco_costos', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "sco_costos";
    }
    ...
    public function insert(&$rs)
    {
        ...
        if ($result) {
            $this->Ncostos->setDbValue($conn->lastInsertId());
            $rs['Ncostos'] = $this->Ncostos->DbValue;
    ...
    public function update(&$rs, $where = "", $rsold = null, $curfilter = true)
    {
        ...
        if ($success) {
            if (!isset($rs['Ncostos']) && !EmptyValue($this->Ncostos->CurrentValue)) {
                $rs['Ncostos'] = $this->Ncostos->CurrentValue;
            }
        }
    ...
    public function deleteSql(&$rs, $where = "", $curfilter = true)
    {
        ...
        if ($rs) {
            if (array_key_exists('Ncostos', $rs)) {
                AddFilter($where, QuotedName('Ncostos', $this->Dbid) . '=' . QuotedValue($rs['Ncostos'], $this->Ncostos->DataType, $this->Dbid));
            }
        }
        $filter = $curfilter ? $this->CurrentFilter : "";
        AddFilter($filter, $where);
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->Ncostos->DbValue = $row['Ncostos'];
        $this->id->DbValue = $row['id'];
        $this->fecha->DbValue = $row['fecha'];
        $this->tipo->DbValue = $row['tipo'];
        $this->costos_articulos->DbValue = $row['costos_articulos'];
        $this->precio_actual->DbValue = $row['precio_actual'];
        $this->porcentaje_aplicado->DbValue = $row['porcentaje_aplicado'];
    ...
    {
        $keys = [];
        $val = $current ? $this->Ncostos->CurrentValue : $this->Ncostos->OldValue;
        if (EmptyValue($val)) {
            return "";
        } else {
            $keys[] = $val;
    ...
    public function setKey($key, $current = false, $keySeparator = null)
    {
        ...
        if (count($keys) == 1) {
            if ($current) {
                $this->Ncostos->CurrentValue = $keys[0];
            } else {
                $this->Ncostos->OldValue = $keys[0];
            }
        }
    }
    ...
    public function getRecordFilter($row = null, $current = false)
    {
        ...
        if (is_array($row)) {
            $val = array_key_exists('Ncostos', $row) ? $row['Ncostos'] : null;
        } else {
            $val = !EmptyValue($this->Ncostos->OldValue) && !$current ? $this->Ncostos->OldValue : $this->Ncostos->CurrentValue;
        }
        if (!is_numeric($val)) {
        ...
        if ($val === null) {
            ...
            $keyFilter = str_replace("@Ncostos@", AdjustSql($val, $this->Dbid), $keyFilter); // Replace key value
        }
        return $keyFilter;
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ScoCostosList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ScoCostosView" => $Language->phrase("View"),
            "ScoCostosEdit" => $Language->phrase("Edit"),
            "ScoCostosAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ScoCostosView",
            Config("API_ADD_ACTION") => "ScoCostosAdd",
            Config("API_EDIT_ACTION") => "ScoCostosEdit",
            Config("API_DELETE_ACTION") => "ScoCostosDelete",
            Config("API_LIST_ACTION") => "ScoCostosList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ScoCostosView", $parm);
        } else {
            $url = $this->keyUrl("ScoCostosView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoCostosEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoCostosList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoCostosAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoCostosList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ScoCostosDelete", $parm);
        }
    }
    ...
    {
        $json = "";
        $json .= "\"Ncostos\":" . VarToJson($this->Ncostos->CurrentValue, "number");
        $json = "{" . $json . "}";
        if ($htmlEncode) {
    ...
    public function keyUrl($url, $parm = "")
    {
        if ($this->Ncostos->CurrentValue !== null) {
            $url .= "/" . $this->encodeKeyValue($this->Ncostos->CurrentValue);
        } else {
    ...
    public function getRecordKeys()
    {
        ...
        if (Param("key_m") !== null) {
            ...
            $keyValues = $isApi
                ...
                : []; // Non-API
            if (($keyValue = Param("Ncostos") ?? Route("Ncostos")) !== null) {
                $arKeys[] = $keyValue;
    ...
    public function getFilterFromRecordKeys($setCurrent = true)
    {
        ...
        foreach ($arKeys as $key) {
            ...
            if ($setCurrent) {
                $this->Ncostos->CurrentValue = $key;
            } else {
                $this->Ncostos->OldValue = $key;
            }
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->costos_articulos);
                    $doc->exportCaption($this->precio_actual);
                    $doc->exportCaption($this->porcentaje_aplicado);
                    ...
                    $doc->exportCaption($this->Ncostos);
                    $doc->exportCaption($this->id);
                    $doc->exportCaption($this->fecha);
                    $doc->exportCaption($this->tipo);
                    $doc->exportCaption($this->costos_articulos);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->costos_articulos);
                        $doc->exportField($this->precio_actual);
                        $doc->exportField($this->porcentaje_aplicado);
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'sco_costos');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'sco_costos', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'sco_costos', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'sco_costos', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    public function recordsetSelecting(&$filter) {
    	// Enter your code here
    	if(isset($_SESSION["id_costo"])) {
    		if(trim($_SESSION["id_costo"])!="") {
    			AddFilter($filter, "id = '" . trim($_SESSION["id_costo"]) . "'");
    		}
    	}
    }
    ...
    public function rowUpdating($rsold, &$rsnew) {
    	...
    	// To cancel, set return value to FALSE
    	if($rsold["cerrado"] == "S") {
    		$this->CancelMessage = "Esta estructura est&aacute; cerrada; no se puede modificar.";
    		return FALSE;
    	}
    	else {
    		if($rsold["precio_nuevo"] != $rsnew["precio_nuevo"]) {
    			$rsnew["porcentaje_aplicado"] = round((($rsnew["precio_nuevo"]-$rsold["precio_actual"])/$rsold["precio_actual"])*100,2);
    		}
    		else {
    			if($rsold["porcentaje_aplicado"] != $rsnew["porcentaje_aplicado"]) {
    				$rsnew["precio_nuevo"] = ($rsold["precio_actual"]*($rsnew["porcentaje_aplicado"]/100))+$rsold["precio_actual"];
    			}
    		}
    		$rsnew["precio_nuevo"] = round($rsnew["precio_nuevo"], 2);
    		$value = ExecuteScalar("SELECT valor1 iva FROM sco_parametro WHERE codigo = '002'");
    		$iva = (double) $value;
    		$rsnew["monto_iva"] = $rsnew["precio_nuevo"]*($iva/100);
    		$rsnew["total"] = $rsnew["precio_nuevo"]+($rsnew["precio_nuevo"]*($iva/100));
    		return TRUE;
    	}
    }
    ...
    public function rowDeleting(&$rs) {
    	...
    	// To cancel, set return value to False
    	if($rs["cerrado"] == "S") {
    		$this->CancelMessage = "Esta estructura est&aacute; cerrada; no se puede eliminar.";
    		 return FALSE;
    	}
    	else return TRUE;
    }
