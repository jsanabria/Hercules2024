...
/**
 * Table class for sco_reserva
 */
class ScoReserva extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->capilla->Nullable = false; // NOT NULL field
        ...
        $this->capilla->Lookup = new Lookup($this->capilla, 'view_capillas', false, 'Nservicio', ["nombre","","",""], '', '', [], [], [], [], [], [], false, '`tipo`', '', "`nombre`");
        $this->capilla->SearchOperators = ["=", "<>"];
        ...
        $this->fecha_inicio->Nullable = false; // NOT NULL field
        ...
        $this->fecha_inicio->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->hora_inicio->Nullable = false; // NOT NULL field
        ...
        $this->hora_inicio->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->user_registra->Lookup = new Lookup($this->user_registra, 'sco_user', false, 'username', ["username","nombre","",""], '', '', [], [], [], [], [], [], false, '', '', "CONCAT(COALESCE(`username`, ''),'" . ValueSeparator(1, $this->user_registra) . "',COALESCE(`nombre`,''))");
        ...
        $this->fecha_fin->Nullable = false; // NOT NULL field
        ...
        $this->fecha_fin->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->hora_fin->Nullable = false; // NOT NULL field
        ...
        $this->hora_fin->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "sco_reserva";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ScoReservaList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ScoReservaView" => $Language->phrase("View"),
            "ScoReservaEdit" => $Language->phrase("Edit"),
            "ScoReservaAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ScoReservaView",
            Config("API_ADD_ACTION") => "ScoReservaAdd",
            Config("API_EDIT_ACTION") => "ScoReservaEdit",
            Config("API_DELETE_ACTION") => "ScoReservaDelete",
            Config("API_LIST_ACTION") => "ScoReservaList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ScoReservaView", $parm);
        } else {
            $url = $this->keyUrl("ScoReservaView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoReservaEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoReservaList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoReservaAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoReservaList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ScoReservaDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->hora_fin->EditValue = FormatDateTime($this->hora_fin->CurrentValue, $this->hora_fin->formatPattern());
        $this->hora_fin->PlaceHolder = RemoveHtml($this->hora_fin->caption());

        // motivo
        $this->motivo->setupEditAttributes();
        if (!$this->motivo->Raw) {
            $this->motivo->CurrentValue = HtmlDecode($this->motivo->CurrentValue);
        }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'sco_reserva');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'sco_reserva', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'sco_reserva', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'sco_reserva', $fldname, $key, $oldvalue);
            }
        }
    }
