 ...
 * Page class
 */
class ScoExpedienteEstatusView extends ScoExpedienteEstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteEstatusView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteEstatusView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("expediente") ?? Route("expediente")) !== null) {
            $this->RecKey["expediente"] = $keyValue;
        }
        if (($keyValue = Get("estatus") ?? Route("estatus")) !== null) {
            $this->RecKey["estatus"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("expediente") ?? Route("expediente")) !== null) {
            ...
            $this->RecKey["expediente"] = $this->expediente->QueryStringValue;
        } elseif (Post("expediente") !== null) {
            $this->expediente->setFormValue(Post("expediente"));
            $this->RecKey["expediente"] = $this->expediente->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->expediente->setQueryStringValue($keyValue);
            $this->RecKey["expediente"] = $this->expediente->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoExpedienteEstatusList"; // Return to list
        }
        if (($keyValue = Get("estatus") ?? Route("estatus")) !== null) {
            $this->estatus->setQueryStringValue($keyValue);
            $this->RecKey["estatus"] = $this->estatus->QueryStringValue;
        } elseif (Post("estatus") !== null) {
            $this->estatus->setFormValue(Post("estatus"));
            $this->RecKey["estatus"] = $this->estatus->FormValue;
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoExpedienteEstatusList"; // No matching record, return to list
                    } else {
