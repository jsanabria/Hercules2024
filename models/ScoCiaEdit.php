 ...
 * Page class
 */
class ScoCiaEdit extends ScoCia
{
    use MessagesTrait;
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCiaEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("Ncia") ?? Key(0) ?? Route(2)) !== null) {
                $this->Ncia->setQueryStringValue($keyValue);
                $this->Ncia->setOldValue($this->Ncia->QueryStringValue);
            } elseif (Post("Ncia") !== null) {
                $this->Ncia->setFormValue(Post("Ncia"));
                $this->Ncia->setOldValue($this->Ncia->FormValue);
            } else {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->Ncia->IsDetailKey) {
            $this->Ncia->setFormValue($val);
        }
    }
    ...
    {
        global $CurrentForm;
        $this->Ncia->CurrentValue = $this->Ncia->FormValue;
