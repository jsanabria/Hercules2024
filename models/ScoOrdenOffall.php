...
/**
 * Table class for sco_orden_offall
 */
class ScoOrdenOffall extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->TableVar = "sco_orden_offall";
        $this->TableName = 'sco_orden_offall';
        $this->TableType = "TABLE";
        $this->ImportUseTransaction = $this->supportsTransaction() && Config("IMPORT_USE_TRANSACTION");
        $this->UseTransaction = $this->supportsTransaction() && Config("USE_TRANSACTION");

        // Update Table
        $this->UpdateTable = "sco_orden_offall";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->Norden->Required = true; // Required field
        ...
        $this->servicio_tipo->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY"];
        ...
        $this->proveedor->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->anulada->Lookup = new Lookup($this->anulada, 'sco_orden_offall', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "sco_orden_offall";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ScoOrdenOffallList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ScoOrdenOffallView" => $Language->phrase("View"),
            "ScoOrdenOffallEdit" => $Language->phrase("Edit"),
            "ScoOrdenOffallAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ScoOrdenOffallView",
            Config("API_ADD_ACTION") => "ScoOrdenOffallAdd",
            Config("API_EDIT_ACTION") => "ScoOrdenOffallEdit",
            Config("API_DELETE_ACTION") => "ScoOrdenOffallDelete",
            Config("API_LIST_ACTION") => "ScoOrdenOffallList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ScoOrdenOffallView", $parm);
        } else {
            $url = $this->keyUrl("ScoOrdenOffallView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ScoOrdenOffallAdd?" . $parm;
        } else {
            $url = "ScoOrdenOffallAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoOrdenOffallEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoOrdenOffallList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoOrdenOffallAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoOrdenOffallList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ScoOrdenOffallDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->Norden->EditValue) != "" && is_numeric($this->Norden->EditValue)) {
            $this->Norden->EditValue = $this->Norden->EditValue;
        }
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'sco_orden_offall');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'sco_orden_offall', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'sco_orden_offall', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'sco_orden_offall', $fldname, $key, $oldvalue);
            }
        }
    }
