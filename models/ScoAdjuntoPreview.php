 ...
 * Page class
 */
class ScoAdjuntoPreview extends ScoAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoAdjuntoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoAdjuntoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "view_capillas") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=view_capillas&" . GetForeignKeyUrl("fk_Nservicio", $this->servicio->QueryStringValue) . "";
        }
        if ($masterTblVar == "sco_servicio") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_servicio&" . GetForeignKeyUrl("fk_Nservicio", $this->servicio->QueryStringValue) . "";
        }
        if ($masterTblVar == "sco_flota") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_flota&" . GetForeignKeyUrl("fk_Nflota", $this->flota->QueryStringValue) . "";
        }
        if ($masterTblVar == "sco_flota_incidencia") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_flota_incidencia&" . GetForeignKeyUrl("fk_Nflota_incidencia", $this->flota_incidencia->QueryStringValue) . "";
        }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "view_capillas") {
            $this->servicio->setQueryStringValue($keys[0] ?? "");
        }
        if ($masterTblVar == "sco_servicio") {
            $this->servicio->setQueryStringValue($keys[0] ?? "");
        }
        if ($masterTblVar == "sco_flota") {
            $this->flota->setQueryStringValue($keys[0] ?? "");
        }
        if ($masterTblVar == "sco_flota_incidencia") {
            $this->flota_incidencia->setQueryStringValue($keys[0] ?? "");
        }
        if ($masterTblVar == "sco_expediente") {
