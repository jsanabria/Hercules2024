 ...
 * Page class
 */
class ScoGramaNotaView extends ScoGramaNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaNotaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoGramaNotaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nnota") ?? Route("Nnota")) !== null) {
            ...
            $this->RecKey["Nnota"] = $this->Nnota->QueryStringValue;
        } elseif (Post("Nnota") !== null) {
            $this->Nnota->setFormValue(Post("Nnota"));
            $this->RecKey["Nnota"] = $this->Nnota->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nnota->setQueryStringValue($keyValue);
            $this->RecKey["Nnota"] = $this->Nnota->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoGramaNotaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoGramaNotaList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Nnota->CurrentValue, $this->CurrentRow['Nnota'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoGramaNotaList"; // No matching record, return to list
                    } else {
