 ...
 * Page class
 */
class ViewCapillasAdd extends ViewCapillas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewCapillasAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewCapillasAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ViewCapillasView") {
    ...
    protected function getAddRow()
    {
        ...
        // secuencia
        $this->secuencia->setDbValueDef($rsnew, $this->secuencia->CurrentValue, strval($this->secuencia->CurrentValue) == "");
