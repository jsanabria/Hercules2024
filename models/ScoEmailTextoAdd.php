 ...
 * Page class
 */
class ScoEmailTextoAdd extends ScoEmailTexto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEmailTextoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoEmailTextoAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoEmailTextoView") {
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->script->CurrentValue != "") { // Check field with unique index
            $filter = "(`script` = '" . AdjustSql($this->script->CurrentValue, $this->Dbid) . "')";
