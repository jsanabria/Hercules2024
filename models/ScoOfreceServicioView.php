 ...
 * Page class
 */
class ScoOfreceServicioView extends ScoOfreceServicio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOfreceServicioView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOfreceServicioView";
    ...
    {
        $this->Nfrece_servicio->setVisibility();
    ...
    public function __construct()
    {
        ...
        // Set up record key
        if (($keyValue = Get("Nfrece_servicio") ?? Route("Nfrece_servicio")) !== null) {
            $this->RecKey["Nfrece_servicio"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nfrece_servicio") ?? Route("Nfrece_servicio")) !== null) {
            $this->Nfrece_servicio->setQueryStringValue($keyValue);
            $this->RecKey["Nfrece_servicio"] = $this->Nfrece_servicio->QueryStringValue;
        } elseif (Post("Nfrece_servicio") !== null) {
            $this->Nfrece_servicio->setFormValue(Post("Nfrece_servicio"));
            $this->RecKey["Nfrece_servicio"] = $this->Nfrece_servicio->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nfrece_servicio->setQueryStringValue($keyValue);
            $this->RecKey["Nfrece_servicio"] = $this->Nfrece_servicio->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoOfreceServicioList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoOfreceServicioList"); // Return to list page
                        return;
                        ...
                        while ($this->fetch()) {
                            if (SameString($this->Nfrece_servicio->CurrentValue, $this->CurrentRow['Nfrece_servicio'])) {
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoOfreceServicioList"; // No matching record, return to list
                    } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoOfreceServicioList"), "", $this->TableVar, true);
        $pageId = "view";
