 ...
 * Page class
 */
class ScoEntradaSalidaDetalleDelete extends ScoEntradaSalidaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEntradaSalidaDetalleDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoEntradaSalidaDetalleDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoEntradaSalidaDetalleList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoEntradaSalidaDetalleList"); // Return to list
                return;
            }
        }
