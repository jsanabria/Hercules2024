 ...
 * Page class
 */
class ScoOrdenCompraDetalleView extends ScoOrdenCompraDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOrdenCompraDetalleView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOrdenCompraDetalleView";
    ...
    {
        $this->Norden_compra_detalle->setVisibility();
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Norden_compra_detalle") ?? Route("Norden_compra_detalle")) !== null) {
            $this->RecKey["Norden_compra_detalle"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Norden_compra_detalle") ?? Route("Norden_compra_detalle")) !== null) {
            ...
            $this->RecKey["Norden_compra_detalle"] = $this->Norden_compra_detalle->QueryStringValue;
        } elseif (Post("Norden_compra_detalle") !== null) {
            $this->Norden_compra_detalle->setFormValue(Post("Norden_compra_detalle"));
            $this->RecKey["Norden_compra_detalle"] = $this->Norden_compra_detalle->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Norden_compra_detalle->setQueryStringValue($keyValue);
            $this->RecKey["Norden_compra_detalle"] = $this->Norden_compra_detalle->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoOrdenCompraDetalleList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoOrdenCompraDetalleList"; // No matching record, return to list
                    } else {
