 ...
 * Page class
 */
class ScoCostosTarifaDelete extends ScoCostosTarifa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCostosTarifaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCostosTarifaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoCostosTarifaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoCostosTarifaList"); // Return to list
                return;
            }
        }
