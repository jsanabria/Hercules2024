 ...
 * Page class
 */
class ScoServicioGrid extends ScoServicio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoServicioGrid";
    ...
    public $FormName = "fsco_serviciogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoServicioGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nservicio->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_Nservicio") &&
            $CurrentForm->hasValue("o_Nservicio") &&
            $this->Nservicio->CurrentValue != $this->Nservicio->DefaultValue &&
            !($this->Nservicio->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->Nservicio->CurrentValue == $this->Nservicio->getSessionValue())
        ) {
            return false;
        }
        if (
            $CurrentForm->hasValue("x_nombre") &&
            $CurrentForm->hasValue("o_nombre") &&
            $this->nombre->CurrentValue != $this->nombre->DefaultValue &&
            !($this->nombre->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->nombre->CurrentValue == $this->nombre->getSessionValue())
        ) {
            return false;
        }
        if (
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_Nservicio")) {
            $this->Nservicio->setOldValue($CurrentForm->getValue("o_Nservicio"));
        }
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            $this->Nservicio->EditValue = HtmlEncode($this->Nservicio->CurrentValue);
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "sco_servicio_tipo") {
            $this->tipo->Visible = true; // Need to insert foreign key
            $this->tipo->CurrentValue = $this->tipo->getSessionValue();
        }
        ...
        // Update current values
        $this->setCurrentValues($rsnew);
        if ($this->Nservicio->CurrentValue != "") { // Check field with unique index
            $filter = "(`Nservicio` = '" . AdjustSql($this->Nservicio->CurrentValue, $this->Dbid) . "')";
    ...
    protected function getAddRow()
    {
        ...
        // Nservicio
        $this->Nservicio->setDbValueDef($rsnew, $this->Nservicio->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['Nservicio'])) { // Nservicio
            $this->Nservicio->setFormValue($row['Nservicio']);
        }
        if (isset($row['nombre'])) { // nombre
