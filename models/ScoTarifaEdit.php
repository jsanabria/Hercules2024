 ...
 * Page class
 */
class ScoTarifaEdit extends ScoTarifa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoTarifaEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoTarifaEdit";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("Ntarifa") ?? Key(0) ?? Route(2)) !== null) {
                $this->Ntarifa->setQueryStringValue($keyValue);
                $this->Ntarifa->setOldValue($this->Ntarifa->QueryStringValue);
            } elseif (Post("Ntarifa") !== null) {
                $this->Ntarifa->setFormValue(Post("Ntarifa"));
                $this->Ntarifa->setOldValue($this->Ntarifa->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("Ntarifa") ?? Route("Ntarifa")) !== null) {
                    ...
                    $this->Ntarifa->CurrentValue = null;
                }
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoTarifaList"); // Return to list page
                        return;
                        ...
                        if ($this->Ntarifa->CurrentValue != null) {
                            while ($this->fetch()) {
                                if (SameString($this->Ntarifa->CurrentValue, $this->CurrentRow['Ntarifa'])) {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->Ntarifa->IsDetailKey) {
            $this->Ntarifa->setFormValue($val);
        }
    }
    ...
    {
        global $CurrentForm;
        $this->Ntarifa->CurrentValue = $this->Ntarifa->FormValue;
