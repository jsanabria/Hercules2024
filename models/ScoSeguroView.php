 ...
 * Page class
 */
class ScoSeguroView extends ScoSeguro
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoSeguroView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoSeguroView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nseguro") ?? Route("Nseguro")) !== null) {
            ...
            $this->RecKey["Nseguro"] = $this->Nseguro->QueryStringValue;
        } elseif (Post("Nseguro") !== null) {
            $this->Nseguro->setFormValue(Post("Nseguro"));
            $this->RecKey["Nseguro"] = $this->Nseguro->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nseguro->setQueryStringValue($keyValue);
            $this->RecKey["Nseguro"] = $this->Nseguro->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoSeguroList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoSeguroList"; // No matching record, return to list
                    } else {
