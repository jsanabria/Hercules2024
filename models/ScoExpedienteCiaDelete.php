 ...
 * Page class
 */
class ScoExpedienteCiaDelete extends ScoExpedienteCia
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteCiaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteCiaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoExpedienteCiaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoExpedienteCiaList"); // Return to list
                return;
            }
        }
