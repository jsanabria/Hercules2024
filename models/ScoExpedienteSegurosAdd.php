 ...
 * Page class
 */
class ScoExpedienteSegurosAdd extends ScoExpedienteSeguros
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteSegurosAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteSegurosAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoExpedienteSegurosView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->religion->DefaultValue = $this->religion->getDefault(); // PHP
        $this->religion->OldValue = $this->religion->DefaultValue;
    }
    ...
    protected function validateForm()
    {
        ...
        if (in_array("sco_expediente_seguros_adjunto", $detailTblVar) && $detailPage->DetailAdd) {
            $detailPage->run();
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("ScoExpedienteSegurosAdjuntoGrid");
            if (in_array("sco_expediente_seguros_adjunto", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
                $detailPage->expediente_seguros->setSessionValue($this->Nexpediente_seguros->CurrentValue); // Set master key
                ...
                if (!$addRow) {
                $detailPage->expediente_seguros->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
    ...
    protected function getAddRow()
    {
        ...
        // religion
        $this->religion->setDbValueDef($rsnew, $this->religion->CurrentValue, strval($this->religion->CurrentValue) == "");
