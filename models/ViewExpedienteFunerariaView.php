 ...
 * Page class
 */
class ViewExpedienteFunerariaView extends ViewExpedienteFuneraria
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewExpedienteFunerariaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewExpedienteFunerariaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Norden") ?? Route("Norden")) !== null) {
            ...
            $returnUrl = "ViewExpedienteFunerariaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewExpedienteFunerariaList"; // No matching record, return to list
                    } else {
