...
/**
 * Table class for sco_orden
 */
class ScoOrden extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        $this->servicio->Lookup = new Lookup($this->servicio, 'sco_servicio', false, 'Nservicio', ["nombre","","",""], '', '', [], ["x_proveedor"], [], [], [], [], false, '`nombre`', '', "`nombre`");
        ...
        $this->proveedor->Lookup = new Lookup($this->proveedor, 'view_servicio_proveedor', false, 'Nproveedor', ["proveedor","","",""], '', '', ["x_servicio"], [], ["Nservicio"], ["x_Nservicio"], [], [], false, '`proveedor` ASC', '', "`proveedor`");
        ...
        $this->responsable_servicio->Required = true; // Required field
        ...
        $this->paso->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN"];
        ...
        $this->hora_inicio->Required = true; // Required field
        ...
        $this->horas->DefaultErrorMessage = $Language->phrase("IncorrectFloat");
        $this->horas->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->hora_fin->Required = true; // Required field
        ...
        $this->capilla->Required = true; // Required field
        ...
        $this->referencia_ubicacion->Required = true; // Required field
        ...
        $this->anulada->Required = true; // Required field
        $this->anulada->setSelectMultiple(false); // Select one
        $this->anulada->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->anulada->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->anulada->Lookup = new Lookup($this->anulada, 'sco_orden', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        ...
        $this->espera_cenizas->setSelectMultiple(false); // Select one
        $this->espera_cenizas->UsePleaseSelect = true; // Use PleaseSelect by default
        $this->espera_cenizas->PleaseSelectText = $Language->phrase("PleaseSelect"); // "PleaseSelect" text
        $this->espera_cenizas->Lookup = new Lookup($this->espera_cenizas, 'sco_orden', false, '', ["","","",""], '', '', [], [], [], [], [], [], false, '', '', "");
        $this->espera_cenizas->OptionCount = 2;
        $this->espera_cenizas->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
        ...
        $this->adjunto->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        ...
        $this->ministro->Lookup = new Lookup($this->ministro, 'sco_user', false, 'username', ["nombre","","",""], '', '', [], [], [], [], [], [], false, '', '', "`nombre`");
        $this->ministro->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "sco_orden";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ScoOrdenList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ScoOrdenView" => $Language->phrase("View"),
            "ScoOrdenEdit" => $Language->phrase("Edit"),
            "ScoOrdenAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ScoOrdenView",
            Config("API_ADD_ACTION") => "ScoOrdenAdd",
            Config("API_EDIT_ACTION") => "ScoOrdenEdit",
            Config("API_DELETE_ACTION") => "ScoOrdenDelete",
            Config("API_LIST_ACTION") => "ScoOrdenList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ScoOrdenView", $parm);
        } else {
            $url = $this->keyUrl("ScoOrdenView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoOrdenEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoOrdenList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoOrdenAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ScoOrdenList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ScoOrdenDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        $this->paso->EditValue = $this->paso->CurrentValue;
        $this->paso->PlaceHolder = RemoveHtml($this->paso->caption());
        if (strval($this->paso->EditValue) != "" && is_numeric($this->paso->EditValue)) {
            $this->paso->EditValue = $this->paso->EditValue;
        }
        ...
        $this->hora_inicio->EditValue = FormatDateTime($this->hora_inicio->CurrentValue, $this->hora_inicio->formatPattern());
        ...
        if (!$this->ministro->Raw) {
            $this->ministro->CurrentValue = HtmlDecode($this->ministro->CurrentValue);
        }
        $this->ministro->EditValue = $this->ministro->CurrentValue;
    ...
    {
        WriteAuditLog(CurrentUserIdentifier(), $typ, 'sco_orden');
    }
    ...
    public function writeAuditTrailOnAdd(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "A", 'sco_orden', $fldname, $key, "", $newvalue);
            }
        }
    }
        ...
        foreach (array_keys($rsnew) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && array_key_exists($fldname, $rsold) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                if ($modified) {
                    ...
                    WriteAuditLog($usr, "U", 'sco_orden', $fldname, $key, $oldvalue, $newvalue);
                }
            }
        }
    }
    ...
    public function writeAuditTrailOnDelete(&$rs)
    {
        ...
        foreach (array_keys($rs) as $fldname) {
            if (array_key_exists($fldname, $this->Fields) && $this->Fields[$fldname]->DataType != DataType::BLOB) { // Ignore BLOB fields
                ...
                WriteAuditLog($usr, "D", 'sco_orden', $fldname, $key, $oldvalue);
            }
        }
    }
    ...
    public function rowDeleted($rs) {
    	//echo "Row Deleted";
    	$sql = "SELECT sum(total) as total FROM sco_orden WHERE expediente = '".$rs["expediente"]."'";
    	$costo = floatval(ExecuteScalar($sql));
    	Execute("UPDATE sco_expediente SET costos = '$costo' WHERE Nexpediente = '".$rs["expediente"]."'");
    	if($rs["paso"] == 3) {
    		$sql = "INSERT INTO sco_entrada_salida
    					(Nentrada_salida, tipo_doc, proveedor, clasificacion, documento, fecha, nota, username)
    				VALUES (NULL, 'EXIN', -1, 'EXPE', '".$rs["expediente"]."', NOW(), 'ENTRADA AUTOMATICA POR ELIMINACION DE ORDEN EN Exp.: ".$rs["expediente"]."', '".CurrentUserName()."')";
    		Execute($sql);
    		...
    		$sql = "INSERT INTO sco_entrada_salida_detalle
    				...
    				VALUES (NULL, $idEntr, 'EXIN', -1, '".$rs["servicio"]."', 1, 0, 0)";
    		Execute($sql);
    	}
    	if($rs["paso"] == 2) {
    		$sql = "DELETE FROM sco_orden WHERE expediente = '".$rs["expediente"]."' AND paso = '3'";
    		Execute($sql);
    		$sql = "DELETE FROM sco_cremacion_estatus WHERE expediente = '".$rs["expediente"]."';";
    		Execute($sql);
    	}
    	header("Location: sco_expedientelist.php");
    }
