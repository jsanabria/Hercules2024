 ...
 * Page class
 */
class ViewCapillasEdit extends ViewCapillas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewCapillasEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewCapillasEdit";
    ...
    public function run()
    {
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if (!$loaded) { // Load record based on key
                        ...
                        $this->terminate("ViewCapillasList"); // No matching record, return to list
                        return;
                    }
                } // End modal checking
            ...
            case "update": // Update
                ...
                if (GetPageName($returnUrl) == "ViewCapillasList") {
                ...
                if ($this->editRow()) { // Update record based on key
                    ...
                    if ($this->IsModal && $this->UseAjaxActions) {
                        ...
                        if (GetPageName($returnUrl) != "ViewCapillasList") {
                            ...
                            $returnUrl = "ViewCapillasList"; // Return list page content
                        }
                    }
                    if (IsJsonResponse()) {
                        $this->terminate(true);
