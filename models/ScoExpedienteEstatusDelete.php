 ...
 * Page class
 */
class ScoExpedienteEstatusDelete extends ScoExpedienteEstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteEstatusDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteEstatusDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoExpedienteEstatusList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoExpedienteEstatusList"); // Return to list
                return;
            }
        }
