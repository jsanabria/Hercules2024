 ...
 * Page class
 */
class ScoCostosTarifaAdd extends ScoCostosTarifa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCostosTarifaAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCostosTarifaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoCostosTarifaView") {
    ...
    protected function validateForm()
    {
        ...
        if (in_array("sco_costos_tarifa_detalle", $detailTblVar) && $detailPage->DetailAdd) {
            $detailPage->run();
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($addRow) {
            $detailTblVar = explode(",", $this->getCurrentDetailTable());
            $detailPage = Container("ScoCostosTarifaDetalleGrid");
            if (in_array("sco_costos_tarifa_detalle", $detailTblVar) && $detailPage->DetailAdd && $addRow) {
                $detailPage->costos_tarifa->setSessionValue($this->Ncostos_tarifa->CurrentValue); // Set master key
                ...
                if (!$addRow) {
                $detailPage->costos_tarifa->setSessionValue(""); // Clear master key if insert failed
                }
            }
        }
    ...
    protected function getAddRow()
    {
        ...
        // tipo_servicio
        $this->tipo_servicio->setDbValueDef($rsnew, $this->tipo_servicio->CurrentValue, false);
    ...
    protected function restoreAddFormFromRow($row)
    {
        ...
        if (isset($row['tipo_servicio'])) { // tipo_servicio
            $this->tipo_servicio->setFormValue($row['tipo_servicio']);
        }
