 ...
 * Page class
 */
class ScoReclamoNotaGrid extends ScoReclamoNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoReclamoNotaGrid";
    ...
    public $FormName = "fsco_reclamo_notagrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoReclamoNotaGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nreclamo_nota->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'Nreclamo_nota' first before field var 'x_Nreclamo_nota'
        $val = $CurrentForm->hasValue("Nreclamo_nota") ? $CurrentForm->getValue("Nreclamo_nota") : $CurrentForm->getValue("x_Nreclamo_nota");
        if (!$this->Nreclamo_nota->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->Nreclamo_nota->setFormValue($val);
        }
    }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->Nreclamo_nota->CurrentValue = $this->Nreclamo_nota->FormValue;
        }
