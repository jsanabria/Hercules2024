 ...
 * Page class
 */
class ScoCostosArticulosDelete extends ScoCostosArticulos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCostosArticulosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCostosArticulosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoCostosArticulosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoCostosArticulosList"); // Return to list
                return;
            }
        }
