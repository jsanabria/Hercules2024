 ...
 * Page class
 */
class ViewVelacionDelete extends ViewVelacion
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewVelacionDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewVelacionDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ViewVelacionList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ViewVelacionList"); // Return to list
                return;
            }
        }
