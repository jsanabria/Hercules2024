...
class Audittrail extends DbTable
{
    ...
    public function __construct()
    {
        ...
        $this->user->Lookup = new Lookup($this->user, 'sco_user', true, 'username', ["username","nombre","",""], '', '', [], [], [], [], [], [], false, '`nombre`', '', "CONCAT(COALESCE(`username`, ''),'" . ValueSeparator(1, $this->user) . "',COALESCE(`nombre`,''))");
        $this->user->SearchOperators = ["=", "<>", "IS NULL", "IS NOT NULL"];
