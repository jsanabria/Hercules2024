 ...
 * Page class
 */
class ScoFlotaDelete extends ScoFlota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoFlotaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoFlotaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoFlotaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoFlotaList"); // Return to list
                return;
            }
        }
