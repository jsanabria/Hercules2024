 ...
 * Page class
 */
class ScoParcelaVentasDelete extends ScoParcelaVentas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoParcelaVentasDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoParcelaVentasDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoParcelaVentasList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoParcelaVentasList"); // Return to list
                return;
            }
        }
