 ...
 * Page class
 */
class ScoEmailCpfDelete extends ScoEmailCpf
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEmailCpfDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoEmailCpfDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoEmailCpfList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoEmailCpfList"); // Return to list
                return;
            }
        }
