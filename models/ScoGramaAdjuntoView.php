 ...
 * Page class
 */
class ScoGramaAdjuntoView extends ScoGramaAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaAdjuntoView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoGramaAdjuntoView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nadjunto") ?? Route("Nadjunto")) !== null) {
            ...
            $returnUrl = "ScoGramaAdjuntoList"; // Return to list
        }
        ...
        switch ($this->CurrentAction) {
            case "show": // Get a record to display
                    ...
                    if (!$res) { // Load record based on key
                        ...
                        $returnUrl = "ScoGramaAdjuntoList"; // No matching record, return to list
                    }
                break;
        }
        if ($returnUrl != "") {
