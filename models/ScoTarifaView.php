 ...
 * Page class
 */
class ScoTarifaView extends ScoTarifa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoTarifaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoTarifaView";
    ...
    public function setVisibility()
    {
        ...
        $this->crear_nuevo_precio->setVisibility();
        $this->porc_recargo->setVisibility();
    }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Ntarifa") ?? Route("Ntarifa")) !== null) {
            ...
            $this->RecKey["Ntarifa"] = $this->Ntarifa->QueryStringValue;
        } elseif (Post("Ntarifa") !== null) {
            $this->Ntarifa->setFormValue(Post("Ntarifa"));
            $this->RecKey["Ntarifa"] = $this->Ntarifa->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Ntarifa->setQueryStringValue($keyValue);
            $this->RecKey["Ntarifa"] = $this->Ntarifa->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoTarifaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoTarifaList"; // No matching record, return to list
                    } else {
