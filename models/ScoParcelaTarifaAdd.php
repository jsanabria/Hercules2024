 ...
 * Page class
 */
class ScoParcelaTarifaAdd extends ScoParcelaTarifa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoParcelaTarifaAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoParcelaTarifaAdd";
    ...
    public function setVisibility()
    {
        ...
        $this->fecha_actualizacion->Visible = false;
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoParcelaTarifaView") {
