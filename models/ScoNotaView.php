 ...
 * Page class
 */
class ScoNotaView extends ScoNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoNotaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nnota") ?? Route("Nnota")) !== null) {
            ...
            $returnUrl = "ScoNotaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoNotaList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoNotaList"; // No matching record, return to list
                    } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoNotaList"), "", $this->TableVar, true);
        $pageId = "view";
