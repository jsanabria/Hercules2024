 ...
 * Page class
 */
class AutogestionPlantillasView extends AutogestionPlantillas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "AutogestionPlantillasView";
    ...
    // CSS class/style
    public $CurrentPageName = "AutogestionPlantillasView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Nplantilla") ?? Route("Nplantilla")) !== null) {
            $this->RecKey["Nplantilla"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nplantilla") ?? Route("Nplantilla")) !== null) {
            ...
            $this->RecKey["Nplantilla"] = $this->Nplantilla->QueryStringValue;
        } elseif (Post("Nplantilla") !== null) {
            $this->Nplantilla->setFormValue(Post("Nplantilla"));
            $this->RecKey["Nplantilla"] = $this->Nplantilla->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nplantilla->setQueryStringValue($keyValue);
            $this->RecKey["Nplantilla"] = $this->Nplantilla->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "AutogestionPlantillasList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "AutogestionPlantillasList"; // No matching record, return to list
                    } else {
    ...
    public function renderRow()
    {
        ...
        if ($this->RowType == RowType::VIEW) {
            ...
            if ($this->imagen->UseColorbox) {
                ...
                $this->imagen->LinkAttrs["data-rel"] = "autogestion_plantillas_x_imagen";
