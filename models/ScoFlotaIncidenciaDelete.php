 ...
 * Page class
 */
class ScoFlotaIncidenciaDelete extends ScoFlotaIncidencia
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoFlotaIncidenciaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoFlotaIncidenciaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoFlotaIncidenciaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoFlotaIncidenciaList"); // Return to list
                return;
            }
        }
