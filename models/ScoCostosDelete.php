 ...
 * Page class
 */
class ScoCostosDelete extends ScoCostos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCostosDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCostosDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoCostosList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoCostosList"); // Return to list
                return;
            }
        }
