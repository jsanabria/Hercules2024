 ...
 * Page class
 */
class ScoOrdenCompraDetalleEdit extends ScoOrdenCompraDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOrdenCompraDetalleEdit";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOrdenCompraDetalleEdit";
    ...
    public function run()
    {
        ...
        $this->setVisibility();
        $this->tipo_insumo->Required = false;
        $this->articulo->Required = false;
        $this->unidad_medida->Required = false;
        ...
        if (IsApi()) {
            // Load key values
            $loaded = true;
            if (($keyValue = Get("Norden_compra_detalle") ?? Key(0) ?? Route(2)) !== null) {
                $this->Norden_compra_detalle->setQueryStringValue($keyValue);
                $this->Norden_compra_detalle->setOldValue($this->Norden_compra_detalle->QueryStringValue);
            } elseif (Post("Norden_compra_detalle") !== null) {
                $this->Norden_compra_detalle->setFormValue(Post("Norden_compra_detalle"));
                $this->Norden_compra_detalle->setOldValue($this->Norden_compra_detalle->FormValue);
            } else {
            ...
            if (Post("action", "") !== "") {
                ...
                if (($keyValue = Get("Norden_compra_detalle") ?? Route("Norden_compra_detalle")) !== null) {
                    ...
                    $this->Norden_compra_detalle->CurrentValue = null;
                }
            ...
            if ($this->isShow()) {
                if (!$this->IsModal) { // Normal edit page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ScoOrdenCompraDetalleList"); // Return to list page
                        return;
                        ...
                        if ($this->Norden_compra_detalle->CurrentValue != null) {
                            while ($this->fetch()) {
                                if (SameString($this->Norden_compra_detalle->CurrentValue, $this->CurrentRow['Norden_compra_detalle'])) {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->Norden_compra_detalle->IsDetailKey) {
