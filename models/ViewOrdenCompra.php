...
/**
 * Table class for view_orden_compra
 */
class ViewOrdenCompra extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_orden_compra";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->Norden_compra->addMethod("getLinkPrefix", fn() => "sco_orden_compraview.php?showdetail=sco_orden_compra_detalle&Norden_compra=");
        ...
        $this->unidad_solicitante->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        $this->tipo_insumo->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_orden_compra";
    }
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewOrdenCompraList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewOrdenCompraView" => $Language->phrase("View"),
            "ViewOrdenCompraEdit" => $Language->phrase("Edit"),
            "ViewOrdenCompraAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewOrdenCompraView",
            Config("API_ADD_ACTION") => "ViewOrdenCompraAdd",
            Config("API_EDIT_ACTION") => "ViewOrdenCompraEdit",
            Config("API_DELETE_ACTION") => "ViewOrdenCompraDelete",
            Config("API_LIST_ACTION") => "ViewOrdenCompraList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewOrdenCompraView", $parm);
        } else {
            $url = $this->keyUrl("ViewOrdenCompraView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        if ($parm != "") {
            $url = "ViewOrdenCompraAdd?" . $parm;
        } else {
            $url = "ViewOrdenCompraAdd";
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOrdenCompraEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOrdenCompraList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOrdenCompraAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewOrdenCompraList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewOrdenCompraDelete", $parm);
        }
    }
    ...
    public function renderEditRow()
    {
        ...
        if (!$this->unidad_solicitante->Raw) {
            $this->unidad_solicitante->CurrentValue = HtmlDecode($this->unidad_solicitante->CurrentValue);
        }
    ...
    public function rowRendering() {
    	...
    	if ($this->PageID == "list" || $this->PageID == "view" || $this->PageID == "edit") { // List/View page only
    		...
    		$this->articulo->CellAttrs["style"] = $style;
    	 }	
    }
