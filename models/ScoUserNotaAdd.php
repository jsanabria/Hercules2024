 ...
 * Page class
 */
class ScoUserNotaAdd extends ScoUserNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoUserNotaAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoUserNotaAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoUserNotaView") {
