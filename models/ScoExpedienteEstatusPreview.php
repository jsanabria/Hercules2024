 ...
 * Page class
 */
class ScoExpedienteEstatusPreview extends ScoExpedienteEstatus
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteEstatusPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteEstatusPreview";
    ...
    public function pageDataRendering(&$header) {
    	// Example:
    		...
    		{
    		case 1:
    			$img = "images/x_recep.png";
    			break;
    		case 2:
    			$img = "images/x_envi.png";
    			break;
    		case 3:
    			$img = "images/x_loca.png";
    			break;
    		case 4:
    			$img = "images/x_resg.png";
    			break;
    		case 5:
    			$img = "images/x_vela.png";
    			break;
    		case 6:
    			$img = "images/x_sepe.png";
    			break;
    		case 7:
    			$img = "images/x_anul.png";
    			break;
    		default:
    			$img = "images/x_sins.png";
    		}
    ...
    public function listOptionsRendered() {
        ...
        if($this->estatus->CurrentValue != "") {
            ...
            $this->ListOptions->Items["fec_hora"]->Body = date("d/m/Y h:i:sA", strtotime($this->fecha_hora->CurrentValue));
    		$sql = "select
    					color
    				from
    					sco_estatus
