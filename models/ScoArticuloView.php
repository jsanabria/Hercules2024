 ...
 * Page class
 */
class ScoArticuloView extends ScoArticulo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoArticuloView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoArticuloView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Narticulo") ?? Route("Narticulo")) !== null) {
            $this->RecKey["Narticulo"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Narticulo") ?? Route("Narticulo")) !== null) {
            ...
            $this->RecKey["Narticulo"] = $this->Narticulo->QueryStringValue;
        } elseif (Post("Narticulo") !== null) {
            $this->Narticulo->setFormValue(Post("Narticulo"));
            $this->RecKey["Narticulo"] = $this->Narticulo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Narticulo->setQueryStringValue($keyValue);
            $this->RecKey["Narticulo"] = $this->Narticulo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoArticuloList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoArticuloList"; // No matching record, return to list
                    } else {
