 ...
 * Page class
 */
class ScoUserAdjuntoAdd extends ScoUserAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoUserAdjuntoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoUserAdjuntoAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoUserAdjuntoView") {
