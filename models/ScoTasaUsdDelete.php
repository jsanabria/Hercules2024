 ...
 * Page class
 */
class ScoTasaUsdDelete extends ScoTasaUsd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoTasaUsdDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoTasaUsdDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoTasaUsdList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoTasaUsdList"); // Return to list
                return;
            }
        }
