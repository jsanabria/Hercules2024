 ...
 * Page class
 */
class ScoNotaDelete extends ScoNota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoNotaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoNotaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoNotaList"); // Return to list
                return;
            }
        }
