 ...
 * Page class
 */
class ScoMttotecnicoView extends ScoMttotecnico
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoMttotecnicoView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoMttotecnicoView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Nmttotecnico") ?? Route("Nmttotecnico")) !== null) {
            $this->RecKey["Nmttotecnico"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nmttotecnico") ?? Route("Nmttotecnico")) !== null) {
            ...
            $this->RecKey["Nmttotecnico"] = $this->Nmttotecnico->QueryStringValue;
        } elseif (Post("Nmttotecnico") !== null) {
            $this->Nmttotecnico->setFormValue(Post("Nmttotecnico"));
            $this->RecKey["Nmttotecnico"] = $this->Nmttotecnico->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nmttotecnico->setQueryStringValue($keyValue);
            $this->RecKey["Nmttotecnico"] = $this->Nmttotecnico->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoMttotecnicoList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoMttotecnicoList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $item = &$option->add("detail_sco_mttotecnico_adjunto");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("sco_mttotecnico_adjunto", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoMttotecnicoAdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=sco_mttotecnico&" . GetForeignKeyUrl("fk_Nmttotecnico", $this->Nmttotecnico->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        ...
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_mttotecnico')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mttotecnico_adjunto"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_mttotecnico')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mttotecnico_adjunto"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
        ...
        $item = &$option->add("detail_sco_mttotecnico_notas");
        $body = $Language->phrase("ViewPageDetailLink") . $Language->tablePhrase("sco_mttotecnico_notas", "TblCaption");
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoMttotecnicoNotasList?" . Config("TABLE_SHOW_MASTER") . "=sco_mttotecnico&" . GetForeignKeyUrl("fk_Nmttotecnico", $this->Nmttotecnico->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
        $detailPageObj = Container("ScoMttotecnicoNotasGrid");
        if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_mttotecnico')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailViewLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mttotecnico_notas"))) . "\">" . $Language->phrase("MasterDetailViewLink", null) . "</a></li>";
            if ($detailViewTblVar != "") {
                $detailViewTblVar .= ",";
            }
        ...
        if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_mttotecnico')) {
            $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($Language->phrase("MasterDetailEditLink")) . "\" href=\"" . HtmlEncode(GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mttotecnico_notas"))) . "\">" . $Language->phrase("MasterDetailEditLink", null) . "</a></li>";
            if ($detailEditTblVar != "") {
                $detailEditTblVar .= ",";
            }
    ...
    {
        // Solo mostrar en la vista (View) o edición (Edit) 
        // Evita que aparezca en la lista general si no hay un registro seleccionado
        if (!in_array($this->PageID, ["view", "edit"])) return;
        $idMtt = $this->Nmttotecnico->CurrentValue;
        if (empty($idMtt)) return;
                ...
                <div class="col-md-6 col-sm-12 mb-3">
                    <div class="card border-0 shadow-sm rounded-lg">
                        <div class="card-header bg-primary text-white font-weight-bold">
                            <i class="fas fa-sticky-note mr-2"></i> Bitácora / Notas Técnicas
                        </div>
                        <iframe 
                            src="../dashboard/mttotecnico_notas.php?id={$idMtt}&username={$userName}" 
                            frameborder="0" 
                ...
                <div class="col-md-6 col-sm-12 mb-3">
                    <div class="card border-0 shadow-sm rounded-lg">
                        <div class="card-header bg-info text-white font-weight-bold">
                            <i class="fas fa-camera mr-2"></i> Evidencias y Adjuntos
                        </div>
                        <iframe 
                            src="../dashboard/mttotecnico_adjuntos.php?id={$idMtt}&username={$userName}" 
                            frameborder="0" 
                            style="height: {$height}; width: 100%; border-radius: 0 0 5px 5px;">
                        </iframe>
                    </div>
