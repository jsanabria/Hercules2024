 ...
 * Page class
 */
class ScoOrdenCompraDetalleGrid extends ScoOrdenCompraDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOrdenCompraDetalleGrid";
    ...
    public $FormName = "fsco_orden_compra_detallegrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoOrdenCompraDetalleGrid";
