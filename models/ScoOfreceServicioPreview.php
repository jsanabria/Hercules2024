 ...
 * Page class
 */
class ScoOfreceServicioPreview extends ScoOfreceServicio
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOfreceServicioPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOfreceServicioPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sco_proveedor") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_proveedor&" . GetForeignKeyUrl("fk_Nproveedor", $this->proveedor->QueryStringValue) . "";
        }
        return $url;
    }
