 ...
 * Page class
 */
class ScoModeloView extends ScoModelo
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoModeloView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoModeloView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nmodelo") ?? Route("Nmodelo")) !== null) {
            ...
            $this->RecKey["Nmodelo"] = $this->Nmodelo->QueryStringValue;
        } elseif (Post("Nmodelo") !== null) {
            $this->Nmodelo->setFormValue(Post("Nmodelo"));
            $this->RecKey["Nmodelo"] = $this->Nmodelo->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nmodelo->setQueryStringValue($keyValue);
            $this->RecKey["Nmodelo"] = $this->Nmodelo->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoModeloList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoModeloList"; // No matching record, return to list
                    } else {
