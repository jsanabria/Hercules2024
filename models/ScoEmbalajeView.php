 ...
 * Page class
 */
class ScoEmbalajeView extends ScoEmbalaje
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEmbalajeView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoEmbalajeView";
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Nembalaje") ?? Route("Nembalaje")) !== null) {
            $this->RecKey["Nembalaje"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nembalaje") ?? Route("Nembalaje")) !== null) {
            ...
            $this->RecKey["Nembalaje"] = $this->Nembalaje->QueryStringValue;
        } elseif (Post("Nembalaje") !== null) {
            $this->Nembalaje->setFormValue(Post("Nembalaje"));
            $this->RecKey["Nembalaje"] = $this->Nembalaje->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nembalaje->setQueryStringValue($keyValue);
            $this->RecKey["Nembalaje"] = $this->Nembalaje->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoEmbalajeList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoEmbalajeList"; // No matching record, return to list
                    } else {
