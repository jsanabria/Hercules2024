 ...
 * Page class
 */
class ScoNotaOrdenCompraAdd extends ScoNotaOrdenCompra
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoNotaOrdenCompraAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoNotaOrdenCompraAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoNotaOrdenCompraView") {
