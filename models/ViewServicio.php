...
/**
 * Table class for view_servicio
 */
class ViewServicio extends DbTable
{
    protected $SqlFrom = "";
    ...
    public function __construct()
    {
        ...
        // Update Table
        $this->UpdateTable = "view_servicio";
        $this->Dbid = 'DB';
        $this->ExportAll = true;
        ...
        $this->Nexpediente->Required = true; // Required field
        ...
        $this->tipo_servicio->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        ...
        // fecha_sepelio
        $this->fecha_sepelio = new DbField(
            $this, // Table
            'x_fecha_sepelio', // Variable name
            'fecha_sepelio', // Name
            '`fecha_sepelio`', // Expression
            CastDateFieldForLike("`fecha_sepelio`", 7, "DB"), // Basic search expression
            135, // Type
            19, // Size
            7, // Date/Time format
            false, // Is upload field
            '`fecha_sepelio`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->fecha_sepelio->addMethod("getSearchDefault", fn() => date('Y-m-d'));
        $this->fecha_sepelio->addMethod("getSearchDefault2", fn() => date('Y-m-d'));
        $this->fecha_sepelio->InputTextType = "text";
        $this->fecha_sepelio->Raw = true;
        $this->fecha_sepelio->DefaultErrorMessage = str_replace("%s", DateFormat(7), $Language->phrase("IncorrectDate"));
        $this->fecha_sepelio->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->fecha_sepelio->AdvancedSearch->SearchValueDefault = $this->fecha_sepelio->getSearchDefault();
        $this->fecha_sepelio->AdvancedSearch->SearchValue2Default = $this->fecha_sepelio->getSearchDefault2();
        $this->fecha_sepelio->AdvancedSearch->SearchOperatorDefault = "BETWEEN";
        $this->fecha_sepelio->AdvancedSearch->SearchOperator2Default = "";
        $this->fecha_sepelio->AdvancedSearch->SearchConditionDefault = "AND";
        $this->Fields['fecha_sepelio'] = &$this->fecha_sepelio;

        // hora_sepelio
        $this->hora_sepelio = new DbField(
            $this, // Table
            'x_hora_sepelio', // Variable name
            'hora_sepelio', // Name
            '`hora_sepelio`', // Expression
            '`hora_sepelio`', // Basic search expression
            200, // Type
            7, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`hora_sepelio`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->hora_sepelio->InputTextType = "text";
        $this->hora_sepelio->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['hora_sepelio'] = &$this->hora_sepelio;
        ...
        // fecha_ofirel
        $this->fecha_ofirel = new DbField(
            $this, // Table
            'x_fecha_ofirel', // Variable name
            'fecha_ofirel', // Name
            '`fecha_ofirel`', // Expression
            CastDateFieldForLike("`fecha_ofirel`", 7, "DB"), // Basic search expression
            135, // Type
            19, // Size
            7, // Date/Time format
            false, // Is upload field
            '`fecha_ofirel`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->fecha_ofirel->InputTextType = "text";
        $this->fecha_ofirel->Raw = true;
        $this->fecha_ofirel->DefaultErrorMessage = str_replace("%s", DateFormat(7), $Language->phrase("IncorrectDate"));
        $this->fecha_ofirel->SearchOperators = ["=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL"];
        $this->Fields['fecha_ofirel'] = &$this->fecha_ofirel;

        // hora_ofirel
        $this->hora_ofirel = new DbField(
            $this, // Table
            'x_hora_ofirel', // Variable name
            'hora_ofirel', // Name
            '`hora_ofirel`', // Expression
            '`hora_ofirel`', // Basic search expression
            200, // Type
            7, // Size
            -1, // Date/Time format
            false, // Is upload field
            '`hora_ofirel`', // Virtual expression
            false, // Is virtual
            false, // Force selection
            false, // Is Virtual search
            'FORMATTED TEXT', // View Tag
        ...
        $this->hora_ofirel->InputTextType = "text";
        $this->hora_ofirel->SearchOperators = ["=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL"];
        $this->Fields['hora_ofirel'] = &$this->hora_ofirel;
    ...
    {
        return ($this->SqlFrom != "") ? $this->SqlFrom : "view_servicio";
    }
    ...
    public function getSqlWhere()
    {
        ...
        $this->DefaultFilter = "`funeraria` = '1'";
    ...
    protected function loadDbValues($row)
    {
        ...
        $this->fecha_sepelio->DbValue = $row['fecha_sepelio'];
        $this->hora_sepelio->DbValue = $row['hora_sepelio'];
        $this->estatus->DbValue = $row['estatus'];
        $this->fecha_ofirel->DbValue = $row['fecha_ofirel'];
        $this->hora_ofirel->DbValue = $row['hora_ofirel'];
    ...
    public function getReturnUrl()
    {
        ...
        return $_SESSION[$name] ?? GetUrl("ViewServicioList");
    }
    ...
    public function getModalCaption($pageName)
    {
        ...
        return match ($pageName) {
            "ViewServicioView" => $Language->phrase("View"),
            "ViewServicioEdit" => $Language->phrase("Edit"),
            "ViewServicioAdd" => $Language->phrase("Add"),
            default => ""
        };
    }
    ...
    public function getApiPageName($action)
    {
        return match (strtolower($action)) {
            Config("API_VIEW_ACTION") => "ViewServicioView",
            Config("API_ADD_ACTION") => "ViewServicioAdd",
            Config("API_EDIT_ACTION") => "ViewServicioEdit",
            Config("API_DELETE_ACTION") => "ViewServicioDelete",
            Config("API_LIST_ACTION") => "ViewServicioList",
            default => ""
        };
    }
    ...
    {
        if ($parm != "") {
            $url = $this->keyUrl("ViewServicioView", $parm);
        } else {
            $url = $this->keyUrl("ViewServicioView", Config("TABLE_SHOW_DETAIL") . "=");
        }
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewServicioEdit", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewServicioList", "action=edit");
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewServicioAdd", $parm);
        return $this->addMasterUrl($url);
    }
    ...
    {
        $url = $this->keyUrl("ViewServicioList", "action=copy");
        return $this->addMasterUrl($url);
    }
    ...
    public function getDeleteUrl($parm = "")
    {
        if ($this->UseAjaxActions && ConvertToBool(Param("infinitescroll")) && CurrentPageID() == "list") {
            ...
            return $this->keyUrl("ViewServicioDelete", $parm);
        }
    }
    ...
    public function renderListRow()
    {
        ...
        // fecha_ofirel
        $this->fecha_ofirel->HrefValue = "";
        $this->fecha_ofirel->TooltipValue = "";

        // hora_ofirel
        $this->hora_ofirel->HrefValue = "";
        $this->hora_ofirel->TooltipValue = "";
    ...
    public function renderEditRow()
    {
        ...
        if (strval($this->Nexpediente->EditValue) != "" && is_numeric($this->Nexpediente->EditValue)) {
            $this->Nexpediente->EditValue = $this->Nexpediente->EditValue;
        }
        ...
        if (!$this->tipo_servicio->Raw) {
            $this->tipo_servicio->CurrentValue = HtmlDecode($this->tipo_servicio->CurrentValue);
        }
        ...
        $this->fecha_sepelio->EditValue = FormatDateTime($this->fecha_sepelio->CurrentValue, $this->fecha_sepelio->formatPattern());
        ...
        if (!$this->hora_sepelio->Raw) {
            $this->hora_sepelio->CurrentValue = HtmlDecode($this->hora_sepelio->CurrentValue);
        }
        $this->hora_sepelio->EditValue = $this->hora_sepelio->CurrentValue;
        ...
        if (strval($this->estatus->EditValue) != "" && is_numeric($this->estatus->EditValue)) {
            $this->estatus->EditValue = $this->estatus->EditValue;
        }

        // fecha_ofirel
        $this->fecha_ofirel->setupEditAttributes();
        $this->fecha_ofirel->EditValue = FormatDateTime($this->fecha_ofirel->CurrentValue, $this->fecha_ofirel->formatPattern());
        $this->fecha_ofirel->PlaceHolder = RemoveHtml($this->fecha_ofirel->caption());

        // hora_ofirel
        $this->hora_ofirel->setupEditAttributes();
        if (!$this->hora_ofirel->Raw) {
            $this->hora_ofirel->CurrentValue = HtmlDecode($this->hora_ofirel->CurrentValue);
        }
        $this->hora_ofirel->EditValue = $this->hora_ofirel->CurrentValue;
        $this->hora_ofirel->PlaceHolder = RemoveHtml($this->hora_ofirel->caption());
        ...
        if (!$doc->ExportCustom) {
            ...
            if ($doc->Horizontal) { // Horizontal format, write header
                ...
                if ($exportPageType == "view") {
                    ...
                    $doc->exportCaption($this->fecha_sepelio);
                    $doc->exportCaption($this->hora_sepelio);
                    $doc->exportCaption($this->estatus);
                    $doc->exportCaption($this->fecha_ofirel);
                    $doc->exportCaption($this->hora_ofirel);
                } else {
                    $doc->exportCaption($this->Nexpediente);
                    $doc->exportCaption($this->difunto);
                    $doc->exportCaption($this->capilla);
            ...
            if ($recCnt >= $startRec) {
                ...
                if (!$doc->ExportCustom) {
                    ...
                    if ($exportPageType == "view") {
                        ...
                        $doc->exportField($this->fecha_sepelio);
                        $doc->exportField($this->hora_sepelio);
                        $doc->exportField($this->estatus);
                        $doc->exportField($this->fecha_ofirel);
                        $doc->exportField($this->hora_ofirel);
                    } else {
                        $doc->exportField($this->Nexpediente);
                        $doc->exportField($this->difunto);
                        $doc->exportField($this->capilla);
