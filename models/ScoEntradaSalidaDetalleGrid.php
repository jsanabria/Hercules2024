 ...
 * Page class
 */
class ScoEntradaSalidaDetalleGrid extends ScoEntradaSalidaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoEntradaSalidaDetalleGrid";
    ...
    public $FormName = "fsco_entrada_salida_detallegrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoEntradaSalidaDetalleGrid";
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "sco_entrada_salida") {
            $this->entrada_salida->Visible = true; // Need to insert foreign key
            $this->entrada_salida->CurrentValue = $this->entrada_salida->getSessionValue();
            $this->tipo_doc->Visible = true; // Need to insert foreign key
            $this->tipo_doc->CurrentValue = $this->tipo_doc->getSessionValue();
