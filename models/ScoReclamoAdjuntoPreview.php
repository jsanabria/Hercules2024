 ...
 * Page class
 */
class ScoReclamoAdjuntoPreview extends ScoReclamoAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoReclamoAdjuntoPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoReclamoAdjuntoPreview";
    ...
    protected function masterKeyUrl()
    {
        ...
        if ($masterTblVar == "sco_reclamo") {
            $url = "" . Config("TABLE_SHOW_MASTER") . "=sco_reclamo&" . GetForeignKeyUrl("fk_Nreclamo", $this->reclamo->QueryStringValue) . "";
        }
        return $url;
    }
    ...
    protected function setupForeignKeys($keys)
    {
        $masterTblVar = Get("t", "");
        if ($masterTblVar == "sco_reclamo") {
            $this->reclamo->setQueryStringValue($keys[0] ?? "");
        }
    }
