 ...
 * Page class
 */
class ScoParcelaVentasView extends ScoParcelaVentas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoParcelaVentasView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoParcelaVentasView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nparcela_ventas") ?? Route("Nparcela_ventas")) !== null) {
            ...
            $returnUrl = "ScoParcelaVentasList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoParcelaVentasList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoParcelaVentasNotaList?" . Config("TABLE_SHOW_MASTER") . "=sco_parcela_ventas&" . GetForeignKeyUrl("fk_Nparcela_ventas", $this->Nparcela_ventas->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
