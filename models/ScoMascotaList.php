 ...
 * Page class
 */
class ScoMascotaList extends ScoMascota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoMascotaList";
    ...
    public $FormName = "fsco_mascotalist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoMascotaList";
    ...
    public function setVisibility()
    {
        ...
        $this->direccion_contratante->Visible = false;
        ...
        $this->fecha_cremacion->Visible = false;
        $this->hora_cremacion->Visible = false;
        $this->username_registra->setVisibility();
    ...
    public function __construct()
    {
        ...
        // Initialize URLs
        $this->AddUrl = "ScoMascotaAdd?" . Config("TABLE_SHOW_DETAIL") . "=";
        $this->InlineAddUrl = $pageUrl . "action=add";
        $this->GridAddUrl = $pageUrl . "action=gridadd";
        $this->GridEditUrl = $pageUrl . "action=gridedit";
        $this->MultiEditUrl = $pageUrl . "action=multiedit";
        $this->MultiDeleteUrl = "ScoMascotaDelete";
        $this->MultiUpdateUrl = "ScoMascotaUpdate";
    ...
    public function run()
    {
        ...
        if ($this->IsModal) {
            $this->FormName = "fsco_mascotagrid";
        }
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->Nmascota->AdvancedSearch->toJson(), ","); // Field Nmascota
        $filterList = Concat($filterList, $this->nombre_contratante->AdvancedSearch->toJson(), ","); // Field nombre_contratante
        $filterList = Concat($filterList, $this->cedula_contratante->AdvancedSearch->toJson(), ","); // Field cedula_contratante
        $filterList = Concat($filterList, $this->direccion_contratante->AdvancedSearch->toJson(), ","); // Field direccion_contratante
        ...
        $filterList = Concat($filterList, $this->nombre_mascota->AdvancedSearch->toJson(), ","); // Field nombre_mascota
        ...
        $filterList = Concat($filterList, $this->tipo_otro->AdvancedSearch->toJson(), ","); // Field tipo_otro
        $filterList = Concat($filterList, $this->color->AdvancedSearch->toJson(), ","); // Field color
        $filterList = Concat($filterList, $this->procedencia->AdvancedSearch->toJson(), ","); // Field procedencia
        ...
        $filterList = Concat($filterList, $this->fecha_cremacion->AdvancedSearch->toJson(), ","); // Field fecha_cremacion
        $filterList = Concat($filterList, $this->hora_cremacion->AdvancedSearch->toJson(), ","); // Field hora_cremacion
        $filterList = Concat($filterList, $this->username_registra->AdvancedSearch->toJson(), ","); // Field username_registra
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fsco_mascotasrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Nmascota
        $this->Nmascota->AdvancedSearch->SearchValue = @$filter["x_Nmascota"];
        $this->Nmascota->AdvancedSearch->SearchOperator = @$filter["z_Nmascota"];
        $this->Nmascota->AdvancedSearch->SearchCondition = @$filter["v_Nmascota"];
        $this->Nmascota->AdvancedSearch->SearchValue2 = @$filter["y_Nmascota"];
        $this->Nmascota->AdvancedSearch->SearchOperator2 = @$filter["w_Nmascota"];
        $this->Nmascota->AdvancedSearch->save();

        // Field nombre_contratante
        $this->nombre_contratante->AdvancedSearch->SearchValue = @$filter["x_nombre_contratante"];
        $this->nombre_contratante->AdvancedSearch->SearchOperator = @$filter["z_nombre_contratante"];
        $this->nombre_contratante->AdvancedSearch->SearchCondition = @$filter["v_nombre_contratante"];
        $this->nombre_contratante->AdvancedSearch->SearchValue2 = @$filter["y_nombre_contratante"];
        $this->nombre_contratante->AdvancedSearch->SearchOperator2 = @$filter["w_nombre_contratante"];
        $this->nombre_contratante->AdvancedSearch->save();

        // Field cedula_contratante
        $this->cedula_contratante->AdvancedSearch->SearchValue = @$filter["x_cedula_contratante"];
        $this->cedula_contratante->AdvancedSearch->SearchOperator = @$filter["z_cedula_contratante"];
        $this->cedula_contratante->AdvancedSearch->SearchCondition = @$filter["v_cedula_contratante"];
        $this->cedula_contratante->AdvancedSearch->SearchValue2 = @$filter["y_cedula_contratante"];
        $this->cedula_contratante->AdvancedSearch->SearchOperator2 = @$filter["w_cedula_contratante"];
        $this->cedula_contratante->AdvancedSearch->save();

        // Field direccion_contratante
        $this->direccion_contratante->AdvancedSearch->SearchValue = @$filter["x_direccion_contratante"];
        $this->direccion_contratante->AdvancedSearch->SearchOperator = @$filter["z_direccion_contratante"];
        $this->direccion_contratante->AdvancedSearch->SearchCondition = @$filter["v_direccion_contratante"];
        $this->direccion_contratante->AdvancedSearch->SearchValue2 = @$filter["y_direccion_contratante"];
        $this->direccion_contratante->AdvancedSearch->SearchOperator2 = @$filter["w_direccion_contratante"];
        $this->direccion_contratante->AdvancedSearch->save();
        ...
        $this->nombre_mascota->AdvancedSearch->SearchValue = @$filter["x_nombre_mascota"];
        $this->nombre_mascota->AdvancedSearch->SearchOperator = @$filter["z_nombre_mascota"];
        $this->nombre_mascota->AdvancedSearch->SearchCondition = @$filter["v_nombre_mascota"];
        $this->nombre_mascota->AdvancedSearch->SearchValue2 = @$filter["y_nombre_mascota"];
        $this->nombre_mascota->AdvancedSearch->SearchOperator2 = @$filter["w_nombre_mascota"];
        $this->nombre_mascota->AdvancedSearch->save();
        ...
        // Field tipo_otro
        $this->tipo_otro->AdvancedSearch->SearchValue = @$filter["x_tipo_otro"];
        $this->tipo_otro->AdvancedSearch->SearchOperator = @$filter["z_tipo_otro"];
        $this->tipo_otro->AdvancedSearch->SearchCondition = @$filter["v_tipo_otro"];
        $this->tipo_otro->AdvancedSearch->SearchValue2 = @$filter["y_tipo_otro"];
        $this->tipo_otro->AdvancedSearch->SearchOperator2 = @$filter["w_tipo_otro"];
        $this->tipo_otro->AdvancedSearch->save();
        ...
        // Field procedencia
        $this->procedencia->AdvancedSearch->SearchValue = @$filter["x_procedencia"];
        $this->procedencia->AdvancedSearch->SearchOperator = @$filter["z_procedencia"];
        $this->procedencia->AdvancedSearch->SearchCondition = @$filter["v_procedencia"];
        $this->procedencia->AdvancedSearch->SearchValue2 = @$filter["y_procedencia"];
        $this->procedencia->AdvancedSearch->SearchOperator2 = @$filter["w_procedencia"];
        $this->procedencia->AdvancedSearch->save();
        ...
        $this->fecha_cremacion->AdvancedSearch->SearchValue = @$filter["x_fecha_cremacion"];
        $this->fecha_cremacion->AdvancedSearch->SearchOperator = @$filter["z_fecha_cremacion"];
        $this->fecha_cremacion->AdvancedSearch->SearchCondition = @$filter["v_fecha_cremacion"];
        $this->fecha_cremacion->AdvancedSearch->SearchValue2 = @$filter["y_fecha_cremacion"];
        $this->fecha_cremacion->AdvancedSearch->SearchOperator2 = @$filter["w_fecha_cremacion"];
        $this->fecha_cremacion->AdvancedSearch->save();

        // Field hora_cremacion
        $this->hora_cremacion->AdvancedSearch->SearchValue = @$filter["x_hora_cremacion"];
        $this->hora_cremacion->AdvancedSearch->SearchOperator = @$filter["z_hora_cremacion"];
        $this->hora_cremacion->AdvancedSearch->SearchCondition = @$filter["v_hora_cremacion"];
        $this->hora_cremacion->AdvancedSearch->SearchValue2 = @$filter["y_hora_cremacion"];
        $this->hora_cremacion->AdvancedSearch->SearchOperator2 = @$filter["w_hora_cremacion"];
        $this->hora_cremacion->AdvancedSearch->save();

        // Field username_registra
        $this->username_registra->AdvancedSearch->SearchValue = @$filter["x_username_registra"];
        $this->username_registra->AdvancedSearch->SearchOperator = @$filter["z_username_registra"];
        $this->username_registra->AdvancedSearch->SearchCondition = @$filter["v_username_registra"];
        $this->username_registra->AdvancedSearch->SearchValue2 = @$filter["y_username_registra"];
        $this->username_registra->AdvancedSearch->SearchOperator2 = @$filter["w_username_registra"];
        $this->username_registra->AdvancedSearch->save();
    ...
    public function basicSearchWhere($default = false)
    {
        ...
        // Fields to search
        $searchFlds = [];
        $searchFlds[] = &$this->nombre_contratante;
        $searchFlds[] = &$this->cedula_contratante;
        $searchFlds[] = &$this->direccion_contratante;
        $searchFlds[] = &$this->telefono1;
        $searchFlds[] = &$this->telefono2;
        $searchFlds[] = &$this->_email;
        $searchFlds[] = &$this->nombre_mascota;
        $searchFlds[] = &$this->peso;
        $searchFlds[] = &$this->raza;
        $searchFlds[] = &$this->tipo;
        $searchFlds[] = &$this->tipo_otro;
        $searchFlds[] = &$this->color;
        $searchFlds[] = &$this->procedencia;
        $searchFlds[] = &$this->tarifa;
        $searchFlds[] = &$this->factura;
        $searchFlds[] = &$this->nota;
        $searchFlds[] = &$this->username_registra;
    ...
    protected function setupSortOrder()
    {
        ...
        if ($this->Command != "json") {
            $defaultSort = $this->Nmascota->Expression . " DESC"; // Set up default sort
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->Nmascota); // Nmascota
            $this->updateSort($this->nombre_contratante); // nombre_contratante
            $this->updateSort($this->cedula_contratante); // cedula_contratante
            $this->updateSort($this->nombre_mascota); // nombre_mascota
            $this->updateSort($this->raza); // raza
            $this->updateSort($this->tipo); // tipo
            $this->updateSort($this->color); // color
            $this->updateSort($this->procedencia); // procedencia
            $this->updateSort($this->factura); // factura
            $this->updateSort($this->username_registra); // username_registra
    ...
    protected function resetCmd()
    {
        ...
        if (StartsString("reset", $this->Command)) {
            ...
            if ($this->Command == "resetsort") {
                ...
                $this->Nmascota->setSort("");
                $this->nombre_contratante->setSort("");
                $this->cedula_contratante->setSort("");
                $this->direccion_contratante->setSort("");
                $this->telefono1->setSort("");
                $this->telefono2->setSort("");
                $this->_email->setSort("");
                $this->nombre_mascota->setSort("");
                $this->peso->setSort("");
                $this->raza->setSort("");
                $this->tipo->setSort("");
                $this->tipo_otro->setSort("");
                $this->color->setSort("");
                $this->procedencia->setSort("");
                $this->tarifa->setSort("");
                $this->factura->setSort("");
                $this->costo->setSort("");
                $this->tasa->setSort("");
                $this->nota->setSort("");
                $this->fecha_cremacion->setSort("");
                $this->hora_cremacion->setSort("");
                $this->username_registra->setSort("");
    ...
    protected function setupListOptions()
    {
        ...
        // "detail_sco_nota_mascota"
        $item = &$this->ListOptions->add("detail_sco_nota_mascota");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'sco_nota_mascota');
        $item->OnLeft = true;
        $item->ShowInButtonGroup = false;

        // "detail_sco_mascota_estatus"
        $item = &$this->ListOptions->add("detail_sco_mascota_estatus");
        $item->CssClass = "text-nowrap";
        $item->Visible = $Security->allowList(CurrentProjectID() . 'sco_mascota_estatus');
        $item->OnLeft = true;
        $item->ShowInButtonGroup = false;
        ...
        // Set up detail pages
        $pages = new SubPages();
        $pages->add("sco_nota_mascota");
        $pages->add("sco_mascota_estatus");
    ...
    public function renderListOptions()
    {
        ...
        if ($this->CurrentMode == "view") {
            ...
            if ($Security->canView()) {
                if ($this->ModalView && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-view\" title=\"" . $viewcaption . "\" data-table=\"sco_mascota\" data-caption=\"" . $viewcaption . "\" data-ew-action=\"modal\" data-action=\"view\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->ViewUrl)) . "\" data-btn=\"null\">" . $Language->phrase("ViewLink") . "</a>";
                } else {
            ...
            if ($Security->canEdit()) {
                if ($this->ModalEdit && !IsMobile()) {
                    $opt->Body = "<a class=\"ew-row-link ew-edit\" title=\"" . $editcaption . "\" data-table=\"sco_mascota\" data-caption=\"" . $editcaption . "\" data-ew-action=\"modal\" data-action=\"edit\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->EditUrl)) . "\" data-btn=\"SaveBtn\">" . $Language->phrase("EditLink") . "</a>";
                } else {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fsco_mascotalist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fsco_mascotalist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        // "detail_sco_nota_mascota"
        $opt = $this->ListOptions["detail_sco_nota_mascota"];
        if ($Security->allowList(CurrentProjectID() . 'sco_nota_mascota')) {
            $body = $Language->phrase("DetailLink") . $Language->tablePhrase("sco_nota_mascota", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("ScoNotaMascotaList?" . Config("TABLE_SHOW_MASTER") . "=sco_mascota&" . GetForeignKeyUrl("fk_Nmascota", $this->Nmascota->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ScoNotaMascotaGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_mascota')) {
                $caption = $Language->phrase("MasterDetailViewLink", null);
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_nota_mascota");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
                $detailViewTblVar .= "sco_nota_mascota";
            }
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_mascota')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_nota_mascota");
                ...
                $detailEditTblVar .= "sco_nota_mascota";
            }
            if ($links != "") {
        ...
        // "detail_sco_mascota_estatus"
        $opt = $this->ListOptions["detail_sco_mascota_estatus"];
        if ($Security->allowList(CurrentProjectID() . 'sco_mascota_estatus')) {
            $body = $Language->phrase("DetailLink") . $Language->tablePhrase("sco_mascota_estatus", "TblCaption");
            $body = "<a class=\"btn btn-default ew-row-link ew-detail" . ($this->ListOptions->UseDropDownButton ? " dropdown-toggle" : "") . "\" data-action=\"list\" href=\"" . HtmlEncode("ScoMascotaEstatusList?" . Config("TABLE_SHOW_MASTER") . "=sco_mascota&" . GetForeignKeyUrl("fk_Nmascota", $this->Nmascota->CurrentValue) . "") . "\">" . $body . "</a>";
            $links = "";
            $detailPage = Container("ScoMascotaEstatusGrid");
            if ($detailPage->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_mascota')) {
                $caption = $Language->phrase("MasterDetailViewLink", null);
                $url = $this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mascota_estatus");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-view\" data-action=\"view\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailViewTblVar != "") {
                    $detailViewTblVar .= ",";
                }
                $detailViewTblVar .= "sco_mascota_estatus";
            }
            if ($detailPage->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_mascota')) {
                $caption = $Language->phrase("MasterDetailEditLink", null);
                $url = $this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mascota_estatus");
                $links .= "<li><a class=\"dropdown-item ew-row-link ew-detail-edit\" data-action=\"edit\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode($url) . "\">" . $caption . "</a></li>";
                if ($detailEditTblVar != "") {
                    $detailEditTblVar .= ",";
                }
                $detailEditTblVar .= "sco_mascota_estatus";
            }
            if ($links != "") {
                $body .= "<button type=\"button\" class=\"dropdown-toggle btn btn-default ew-detail\" data-bs-toggle=\"dropdown\"></button>";
                $body .= "<ul class=\"dropdown-menu\">" . $links . "</ul>";
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->Nmascota->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function renderListOptionsExt()
    {
        ...
        $detailFilters = [];
        $masterKeys = []; // Reset
        $masterKeys["Nmascota"] = strval($this->Nmascota->DbValue);

        // Column "detail_sco_nota_mascota"
        if ($this->DetailPages?->getItem("sco_nota_mascota")?->Visible && $Security->allowList(CurrentProjectID() . 'sco_nota_mascota')) {
            $link = "";
            $option = $this->ListOptions["detail_sco_nota_mascota"];
            $detailTbl = Container("sco_nota_mascota");
            $detailFilter = $detailTbl->getDetailFilter($this);
            $detailTbl->setCurrentMasterTable($this->TableVar);
            $detailFilter = $detailTbl->applyUserIDFilters($detailFilter);
            $url = "ScoNotaMascotaPreview?t=sco_mascota&f=" . Encrypt($detailFilter . "|" . implode("|", array_values($masterKeys)));
            $btngrp = "<div data-table=\"sco_nota_mascota\" data-url=\"" . $url . "\" class=\"ew-detail-btn-group d-none\">";
            if ($Security->allowList(CurrentProjectID() . 'sco_mascota')) {
                $label = $Language->tablePhrase("sco_nota_mascota", "TblCaption");
                $link = "<button class=\"nav-link\" data-bs-toggle=\"tab\" data-table=\"sco_nota_mascota\" data-url=\"" . $url . "\" type=\"button\" role=\"tab\" aria-selected=\"false\">" . $label . "</button>";
                $detaillnk = GetUrl("ScoNotaMascotaList?" . Config("TABLE_SHOW_MASTER") . "=sco_mascota");
                foreach ($masterKeys as $key => $value) {
                    $detaillnk .= "&" . GetForeignKeyUrl("fk_$key", $value);
                }
                $title = $Language->tablePhrase("sco_nota_mascota", "TblCaption");
            ...
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_mascota')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $viewurl = GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_nota_mascota"));
                $btngrp .= "<a href=\"#\" class=\"me-2\" title=\"" . HtmlTitle($caption) . "\" data-ew-action=\"redirect\" data-url=\"" . HtmlEncode($viewurl) . "\">" . $caption . "</a>";
            }
            if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_mascota')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $editurl = GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_nota_mascota"));
        ...
        // Column "detail_sco_mascota_estatus"
        if ($this->DetailPages?->getItem("sco_mascota_estatus")?->Visible && $Security->allowList(CurrentProjectID() . 'sco_mascota_estatus')) {
            $link = "";
            $option = $this->ListOptions["detail_sco_mascota_estatus"];
            $detailTbl = Container("sco_mascota_estatus");
            $detailFilter = $detailTbl->getDetailFilter($this);
            $detailTbl->setCurrentMasterTable($this->TableVar);
            $detailFilter = $detailTbl->applyUserIDFilters($detailFilter);
            $url = "ScoMascotaEstatusPreview?t=sco_mascota&f=" . Encrypt($detailFilter . "|" . implode("|", array_values($masterKeys)));
            $btngrp = "<div data-table=\"sco_mascota_estatus\" data-url=\"" . $url . "\" class=\"ew-detail-btn-group d-none\">";
            if ($Security->allowList(CurrentProjectID() . 'sco_mascota')) {
                $label = $Language->tablePhrase("sco_mascota_estatus", "TblCaption");
                $link = "<button class=\"nav-link\" data-bs-toggle=\"tab\" data-table=\"sco_mascota_estatus\" data-url=\"" . $url . "\" type=\"button\" role=\"tab\" aria-selected=\"false\">" . $label . "</button>";
                $detaillnk = GetUrl("ScoMascotaEstatusList?" . Config("TABLE_SHOW_MASTER") . "=sco_mascota");
                foreach ($masterKeys as $key => $value) {
                    $detaillnk .= "&" . GetForeignKeyUrl("fk_$key", $value);
                }
                $title = $Language->tablePhrase("sco_mascota_estatus", "TblCaption");
                $caption = $Language->phrase("MasterDetailListLink");
                $btngrp .= "<a href=\"#\" class=\"me-2\" title=\"" . $title . "\" data-ew-action=\"redirect\" data-url=\"" . HtmlEncode($detaillnk) . "\">" . $caption . "</a>";
            }
            ...
            if ($detailPageObj->DetailView && $Security->canView() && $Security->allowView(CurrentProjectID() . 'sco_mascota')) {
                $caption = $Language->phrase("MasterDetailViewLink");
                $viewurl = GetUrl($this->getViewUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mascota_estatus"));
                $btngrp .= "<a href=\"#\" class=\"me-2\" title=\"" . HtmlTitle($caption) . "\" data-ew-action=\"redirect\" data-url=\"" . HtmlEncode($viewurl) . "\">" . $caption . "</a>";
            }
            if ($detailPageObj->DetailEdit && $Security->canEdit() && $Security->allowEdit(CurrentProjectID() . 'sco_mascota')) {
                $caption = $Language->phrase("MasterDetailEditLink");
                $editurl = GetUrl($this->getEditUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mascota_estatus"));
                $btngrp .= "<a href=\"#\" class=\"me-2\" title=\"" . HtmlTitle($caption) . "\" data-ew-action=\"redirect\" data-url=\"" . HtmlEncode($editurl) . "\">" . $caption . "</a>";
            }
            $btngrp .= "</div>";
            if ($link != "") {
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->ModalAdd && !IsMobile()) {
            $item->Body = "<a class=\"ew-add-edit ew-add\" title=\"" . $addcaption . "\" data-table=\"sco_mascota\" data-caption=\"" . $addcaption . "\" data-ew-action=\"modal\" data-action=\"add\" data-ajax=\"" . ($this->UseAjaxActions ? "true" : "false") . "\" data-url=\"" . HtmlEncode(GetUrl($this->AddUrl)) . "\" data-btn=\"AddBtn\">" . $Language->phrase("AddLink") . "</a>";
        } else {
        ...
        $detailTableLink = "";
        $item = &$option->add("detailadd_sco_nota_mascota");
        $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=sco_nota_mascota");
        $detailPage = Container("ScoNotaMascotaGrid");
        $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
        $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
        $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'sco_mascota') && $Security->canAdd());
        if ($item->Visible) {
            if ($detailTableLink != "") {
                $detailTableLink .= ",";
            }
            $detailTableLink .= "sco_nota_mascota";
        }
        $item = &$option->add("detailadd_sco_mascota_estatus");
        $url = $this->getAddUrl(Config("TABLE_SHOW_DETAIL") . "=sco_mascota_estatus");
        $detailPage = Container("ScoMascotaEstatusGrid");
        $caption = $Language->phrase("Add") . "&nbsp;" . $this->tableCaption() . "/" . $detailPage->tableCaption();
        $item->Body = "<a class=\"ew-detail-add-group ew-detail-add\" title=\"" . HtmlTitle($caption) . "\" data-caption=\"" . HtmlTitle($caption) . "\" href=\"" . HtmlEncode(GetUrl($url)) . "\">" . $caption . "</a>";
        $item->Visible = ($detailPage->DetailAdd && $Security->allowAdd(CurrentProjectID() . 'sco_mascota') && $Security->canAdd());
        if ($item->Visible) {
            ...
            $detailTableLink .= "sco_mascota_estatus";
        }
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "Nmascota");
            $this->createColumnOption($option, "nombre_contratante");
            $this->createColumnOption($option, "cedula_contratante");
            $this->createColumnOption($option, "nombre_mascota");
            $this->createColumnOption($option, "raza");
            $this->createColumnOption($option, "tipo");
            $this->createColumnOption($option, "color");
            $this->createColumnOption($option, "procedencia");
            $this->createColumnOption($option, "factura");
            $this->createColumnOption($option, "username_registra");
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fsco_mascotasrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fsco_mascotasrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fsco_mascotalist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    public function setupRow()
    {
        ...
        if ($this->isGridAdd() || $this->isGridEdit()) {
            if ($this->RowIndex === '$rowindex$') { // Render template row first
                ...
                // Set row properties
                $this->resetAttributes();
                $this->RowAttrs->merge(["data-rowindex" => $this->RowIndex, "id" => "r0_sco_mascota", "data-rowtype" => RowType::ADD]);
        ...
        $this->RowAttrs->merge([
            ...
            "id" => "r" . $this->RowCount . "_sco_mascota",
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fsco_mascotasrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    public function pageDataRendering(&$header) {
    	// Example:
    	$sql = "SELECT count(*) AS cantidad FROM sco_parametro 
    			WHERE codigo = '026';";
    	$cantidad = ExecuteScalar($sql);
    	for($i=0; $i<$cantidad; $i++) {
    		$sql = "SELECT valor1, valor2, valor4 FROM sco_parametro 
    			WHERE codigo = '026' ORDER BY valor3 ASC LIMIT $i, 1;";
    		$row = ExecuteRow($sql);
    		$header .= '<a href="?myst=' . $row["valor1"] . '" class="btn" style="' . $row["valor4"] . '">' . $row["valor2"] . '</a> ';
    	}
    	$header .= '<a href="?cmd=reset" class="btn btn-default btn-lg"><span class="icon-reset-search ewIcon"></span></a>';
    	$this->estatus->Visible = false;
    }
    ...
    public function listOptionsRendered() {
    	// Example: 
    	if(CurrentTable()->estatus->CurrentValue == "P4" or CurrentTable()->estatus->CurrentValue == "P5")
    		$this->ListOptions->Items["print"]->Body = '<a target="_blank" href="fpdf_report/rptConstanciaCremacionMascota.php?Nmascota=' . CurrentTable()->Nmascota->CurrentValue . '"><span class="glyphicon glyphicon-print"></span></a>';
    }
