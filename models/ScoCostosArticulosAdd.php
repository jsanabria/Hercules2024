 ...
 * Page class
 */
class ScoCostosArticulosAdd extends ScoCostosArticulos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoCostosArticulosAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoCostosArticulosAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoCostosArticulosView") {
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->variacion->IsDetailKey) {
            if (IsApi() && $val === null) {
                ...
                $this->variacion->setFormValue($val, true, $validate);
            }
        }
    ...
    protected function validateForm()
    {
        ...
        $validateForm = true;
            ...
            if (!CheckNumber($this->variacion->FormValue)) {
                $this->variacion->addErrorMessage($this->variacion->getErrorMessage(false));
            }
