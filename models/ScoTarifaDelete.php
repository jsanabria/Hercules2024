 ...
 * Page class
 */
class ScoTarifaDelete extends ScoTarifa
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoTarifaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoTarifaDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoTarifaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoTarifaList"); // Return to list
                return;
            }
        }
