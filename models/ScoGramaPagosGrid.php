 ...
 * Page class
 */
class ScoGramaPagosGrid extends ScoGramaPagos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaPagosGrid";
    ...
    public $FormName = "fsco_grama_pagosgrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoGramaPagosGrid";
    ...
    protected function clearInlineMode()
    {
        ...
        $this->tasa->FormValue = ""; // Clear form value
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Ngrama_pagos->CurrentValue;
    ...
    public function emptyRow()
    {
        ...
        if (
            $CurrentForm->hasValue("x_ref") &&
            $CurrentForm->hasValue("o_ref") &&
            $this->ref->CurrentValue != $this->ref->DefaultValue &&
            !($this->ref->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->ref->CurrentValue == $this->ref->getSessionValue())
        ) {
            return false;
        }
        if (
        ...
        if (
            $CurrentForm->hasValue("x_tasa") &&
            $CurrentForm->hasValue("o_tasa") &&
            $this->tasa->CurrentValue != $this->tasa->DefaultValue &&
            !($this->tasa->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->tasa->CurrentValue == $this->tasa->getSessionValue())
        ) {
            return false;
        }
        if (
        ...
        if (
            $CurrentForm->hasValue("x_cta_destino") &&
            $CurrentForm->hasValue("o_cta_destino") &&
            $this->cta_destino->CurrentValue != $this->cta_destino->DefaultValue &&
            !($this->cta_destino->IsForeignKey && $this->getCurrentMasterTable() != "" && $this->cta_destino->CurrentValue == $this->cta_destino->getSessionValue())
        ) {
            return false;
        }
        return true;
    ...
    protected function loadFormValues()
    {
        ...
        if ($CurrentForm->hasValue("o_ref")) {
            $this->ref->setOldValue($CurrentForm->getValue("o_ref"));
        }
        ...
        if ($CurrentForm->hasValue("o_tasa")) {
            $this->tasa->setOldValue($CurrentForm->getValue("o_tasa"));
        }
        ...
        if ($CurrentForm->hasValue("o_cta_destino")) {
            $this->cta_destino->setOldValue($CurrentForm->getValue("o_cta_destino"));
        }
        ...
        if (!$this->Ngrama_pagos->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
