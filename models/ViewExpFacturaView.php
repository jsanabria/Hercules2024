 ...
 * Page class
 */
class ViewExpFacturaView extends ViewExpFactura
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewExpFacturaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewExpFacturaView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nexpediente") ?? Route("Nexpediente")) !== null) {
            ...
            $returnUrl = "ViewExpFacturaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if ($this->TotalRecords <= 0) { // No record found
                        ...
                        $this->terminate("ViewExpFacturaList"); // Return to list page
                        return;
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewExpFacturaList"; // No matching record, return to list
                    } else {
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ViewExpFacturaList"), "", $this->TableVar, true);
        $pageId = "view";
