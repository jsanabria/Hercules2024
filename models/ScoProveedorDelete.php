 ...
 * Page class
 */
class ScoProveedorDelete extends ScoProveedor
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoProveedorDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoProveedorDelete";
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoProveedorList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoProveedorList"); // Return to list
                return;
            }
        }
