 ...
 * Page class
 */
class ScoFlotaIncidenciaDetalleGrid extends ScoFlotaIncidenciaDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoFlotaIncidenciaDetalleGrid";
    ...
    public $FormName = "fsco_flota_incidencia_detallegrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoFlotaIncidenciaDetalleGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nflota_incidencia_detalle->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        // Check field name 'Nflota_incidencia_detalle' first before field var 'x_Nflota_incidencia_detalle'
        $val = $CurrentForm->hasValue("Nflota_incidencia_detalle") ? $CurrentForm->getValue("Nflota_incidencia_detalle") : $CurrentForm->getValue("x_Nflota_incidencia_detalle");
        if (!$this->Nflota_incidencia_detalle->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->Nflota_incidencia_detalle->setFormValue($val);
        }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->Nflota_incidencia_detalle->CurrentValue = $this->Nflota_incidencia_detalle->FormValue;
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['Nflota_incidencia_detalle'];
