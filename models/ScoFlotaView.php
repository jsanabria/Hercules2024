 ...
 * Page class
 */
class ScoFlotaView extends ScoFlota
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoFlotaView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoFlotaView";
    ...
    public function setVisibility()
    {
        ...
        $this->km_oil_next->setVisibility();
    }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nflota") ?? Route("Nflota")) !== null) {
            ...
            $this->RecKey["Nflota"] = $this->Nflota->QueryStringValue;
        } elseif (Post("Nflota") !== null) {
            $this->Nflota->setFormValue(Post("Nflota"));
            $this->RecKey["Nflota"] = $this->Nflota->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Nflota->setQueryStringValue($keyValue);
            $this->RecKey["Nflota"] = $this->Nflota->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoFlotaList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoFlotaList"; // No matching record, return to list
                    } else {
    ...
    protected function setupOtherOptions()
    {
        ...
        */
        ...
        $body = "<a class=\"btn btn-default ew-row-link ew-detail\" data-action=\"list\" href=\"" . HtmlEncode(GetUrl("ScoAdjuntoList?" . Config("TABLE_SHOW_MASTER") . "=sco_flota&" . GetForeignKeyUrl("fk_Nflota", $this->Nflota->CurrentValue) . "")) . "\">" . $body . "</a>";
        $links = "";
