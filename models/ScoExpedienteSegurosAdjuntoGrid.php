 ...
 * Page class
 */
class ScoExpedienteSegurosAdjuntoGrid extends ScoExpedienteSegurosAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteSegurosAdjuntoGrid";
    ...
    public $FormName = "fsco_expediente_seguros_adjuntogrid";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoExpedienteSegurosAdjuntoGrid";
        ...
        for ($rowindex = 1; $rowindex <= $rowcnt; $rowindex++) {
            ...
            if (!$this->emptyRow()) {
                ...
                if ($gridInsert) {
                    ...
                    $key .= $this->Nexpediente_seguros_adjunto->CurrentValue;
    ...
    protected function loadFormValues()
    {
        ...
        if (!$this->Nexpediente_seguros_adjunto->IsDetailKey && !$this->isGridAdd() && !$this->isAdd()) {
            $this->Nexpediente_seguros_adjunto->setFormValue($val);
        }
    ...
    public function restoreFormValues()
    {
        ...
        if (!$this->isGridAdd() && !$this->isAdd()) {
            $this->Nexpediente_seguros_adjunto->CurrentValue = $this->Nexpediente_seguros_adjunto->FormValue;
        }
    ...
    protected function deleteRows()
    {
        ...
        foreach ($rsold as $row) {
            ...
            $thisKey .= $row['Nexpediente_seguros_adjunto'];
    ...
    protected function editRow()
    {
        ...
        // Check referential integrity for master table 'sco_expediente_seguros'
        $detailKeys = [];
        $keyValue = $rsnew['expediente_seguros'] ?? $rsold['expediente_seguros'];
        $detailKeys['expediente_seguros'] = $keyValue;
        ...
        if ($this->archivo->Visible && !$this->archivo->Upload->KeepFile) {
            if (!EmptyValue($this->archivo->Upload->FileName)) {
                ...
                $this->archivo->setDbValueDef($rsnew, $this->archivo->Upload->FileName, $this->archivo->ReadOnly);
            }
        }
    ...
    protected function addRow($rsold = null)
    {
        ...
        if ($this->getCurrentMasterTable() == "sco_expediente_seguros") {
            $this->expediente_seguros->Visible = true; // Need to insert foreign key
            $this->expediente_seguros->CurrentValue = $this->expediente_seguros->getSessionValue();
        }
        ...
        $detailKeys = [];
        $detailKeys["expediente_seguros"] = $this->expediente_seguros->getSessionValue();
        $masterTable = Container("sco_expediente_seguros");
        $masterFilter = $this->getMasterFilter($masterTable, $detailKeys);
        if (!EmptyValue($masterFilter)) {
            $rsmaster = $masterTable->loadRs($masterFilter)->fetch();
    ...
    protected function getAddRow()
    {
        ...
        if ($this->expediente_seguros->getSessionValue() != "") {
            $rsnew['expediente_seguros'] = $this->expediente_seguros->getSessionValue();
        }
        return $rsnew;
    }
