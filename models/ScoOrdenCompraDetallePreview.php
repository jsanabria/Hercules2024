 ...
 * Page class
 */
class ScoOrdenCompraDetallePreview extends ScoOrdenCompraDetalle
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOrdenCompraDetallePreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOrdenCompraDetallePreview";
