 ...
 * Page class
 */
class ViewVelacionView extends ViewVelacion
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ViewVelacionView";
    ...
    // CSS class/style
    public $CurrentPageName = "ViewVelacionView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Nservicio") ?? Route("Nservicio")) !== null) {
            ...
            $returnUrl = "ViewVelacionList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ViewVelacionList"; // No matching record, return to list
                    } else {
