 ...
 * Page class
 */
class ScoExpedienteOldAdd extends ScoExpedienteOld
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoExpedienteOldAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoExpedienteOldAdd";
        ...
        switch ($this->CurrentAction) {
            ...
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    } elseif (GetPageName($returnUrl) == "ScoExpedienteOldView") {
    ...
    protected function loadDefaultValues()
    {
        ...
        $this->marca_pasos->DefaultValue = $this->marca_pasos->getDefault(); // PHP
        $this->marca_pasos->OldValue = $this->marca_pasos->DefaultValue;
    ...
    protected function getAddRow()
    {
        ...
        // tipo_contratacion
        $this->tipo_contratacion->setDbValueDef($rsnew, $this->tipo_contratacion->CurrentValue, false);

        // seguro
        $this->seguro->setDbValueDef($rsnew, $this->seguro->CurrentValue, false);

        // nacionalidad_contacto
        $this->nacionalidad_contacto->setDbValueDef($rsnew, $this->nacionalidad_contacto->CurrentValue, false);

        // cedula_contacto
        $this->cedula_contacto->setDbValueDef($rsnew, $this->cedula_contacto->CurrentValue, false);

        // nombre_contacto
        $this->nombre_contacto->setDbValueDef($rsnew, $this->nombre_contacto->CurrentValue, false);

        // apellidos_contacto
        $this->apellidos_contacto->setDbValueDef($rsnew, $this->apellidos_contacto->CurrentValue, false);
        ...
        // nacionalidad_fallecido
        $this->nacionalidad_fallecido->setDbValueDef($rsnew, $this->nacionalidad_fallecido->CurrentValue, false);
        ...
        // edad_fallecido
        $this->edad_fallecido->setDbValueDef($rsnew, $this->edad_fallecido->CurrentValue, false);

        // estado_civil
        $this->estado_civil->setDbValueDef($rsnew, $this->estado_civil->CurrentValue, false);

        // lugar_nacimiento_fallecido
        $this->lugar_nacimiento_fallecido->setDbValueDef($rsnew, $this->lugar_nacimiento_fallecido->CurrentValue, false);
        ...
        // hora_ocurrencia
        $this->hora_ocurrencia->setDbValueDef($rsnew, UnFormatDateTime($this->hora_ocurrencia->CurrentValue, $this->hora_ocurrencia->formatPattern()), false);
        ...
        // descripcion_ocurrencia
        $this->descripcion_ocurrencia->setDbValueDef($rsnew, $this->descripcion_ocurrencia->CurrentValue, false);

        // calidad
        $this->calidad->setDbValueDef($rsnew, $this->calidad->CurrentValue, false);

        // costos
        $this->costos->setDbValueDef($rsnew, $this->costos->CurrentValue, false);
        ...
        // user_cierra
        $this->user_cierra->setDbValueDef($rsnew, $this->user_cierra->CurrentValue, false);

        // fecha_cierre
        $this->fecha_cierre->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_cierre->CurrentValue, $this->fecha_cierre->formatPattern()), false);
        ...
        // unir_con_expediente
        $this->unir_con_expediente->setDbValueDef($rsnew, $this->unir_con_expediente->CurrentValue, false);
        ...
        // autoriza_cremar
        $this->autoriza_cremar->setDbValueDef($rsnew, $this->autoriza_cremar->CurrentValue, strval($this->autoriza_cremar->CurrentValue) == "");

        // username_autoriza
        $this->username_autoriza->setDbValueDef($rsnew, $this->username_autoriza->CurrentValue, false);

        // fecha_autoriza
        $this->fecha_autoriza->setDbValueDef($rsnew, UnFormatDateTime($this->fecha_autoriza->CurrentValue, $this->fecha_autoriza->formatPattern()), false);
        ...
        // email_calidad
        $this->email_calidad->setDbValueDef($rsnew, $this->email_calidad->CurrentValue, strval($this->email_calidad->CurrentValue) == "");
    ...
    protected function restoreAddFormFromRow($row)
    {
        if (isset($row['tipo_contratacion'])) { // tipo_contratacion
            $this->tipo_contratacion->setFormValue($row['tipo_contratacion']);
        }
        if (isset($row['seguro'])) { // seguro
            $this->seguro->setFormValue($row['seguro']);
        }
        if (isset($row['nacionalidad_contacto'])) { // nacionalidad_contacto
            $this->nacionalidad_contacto->setFormValue($row['nacionalidad_contacto']);
        }
        if (isset($row['cedula_contacto'])) { // cedula_contacto
            $this->cedula_contacto->setFormValue($row['cedula_contacto']);
        }
        ...
        if (isset($row['apellidos_contacto'])) { // apellidos_contacto
            $this->apellidos_contacto->setFormValue($row['apellidos_contacto']);
        }
        ...
        if (isset($row['nacionalidad_fallecido'])) { // nacionalidad_fallecido
            $this->nacionalidad_fallecido->setFormValue($row['nacionalidad_fallecido']);
        }
        ...
        if (isset($row['edad_fallecido'])) { // edad_fallecido
            $this->edad_fallecido->setFormValue($row['edad_fallecido']);
        }
        if (isset($row['estado_civil'])) { // estado_civil
            $this->estado_civil->setFormValue($row['estado_civil']);
        }
        if (isset($row['lugar_nacimiento_fallecido'])) { // lugar_nacimiento_fallecido
            $this->lugar_nacimiento_fallecido->setFormValue($row['lugar_nacimiento_fallecido']);
        }
        ...
        if (isset($row['hora_ocurrencia'])) { // hora_ocurrencia
            $this->hora_ocurrencia->setFormValue($row['hora_ocurrencia']);
        }
        ...
        if (isset($row['descripcion_ocurrencia'])) { // descripcion_ocurrencia
            $this->descripcion_ocurrencia->setFormValue($row['descripcion_ocurrencia']);
        }
        if (isset($row['calidad'])) { // calidad
            $this->calidad->setFormValue($row['calidad']);
        }
        if (isset($row['costos'])) { // costos
            $this->costos->setFormValue($row['costos']);
        }
        ...
        if (isset($row['user_cierra'])) { // user_cierra
            $this->user_cierra->setFormValue($row['user_cierra']);
        }
        if (isset($row['fecha_cierre'])) { // fecha_cierre
            $this->fecha_cierre->setFormValue($row['fecha_cierre']);
        }
        ...
        if (isset($row['unir_con_expediente'])) { // unir_con_expediente
            $this->unir_con_expediente->setFormValue($row['unir_con_expediente']);
        }
        ...
        if (isset($row['autoriza_cremar'])) { // autoriza_cremar
            $this->autoriza_cremar->setFormValue($row['autoriza_cremar']);
        }
        if (isset($row['username_autoriza'])) { // username_autoriza
            $this->username_autoriza->setFormValue($row['username_autoriza']);
        }
        if (isset($row['fecha_autoriza'])) { // fecha_autoriza
            $this->fecha_autoriza->setFormValue($row['fecha_autoriza']);
        }
        ...
        if (isset($row['email_calidad'])) { // email_calidad
            $this->email_calidad->setFormValue($row['email_calidad']);
        }
