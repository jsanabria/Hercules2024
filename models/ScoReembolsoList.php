 ...
 * Page class
 */
class ScoReembolsoList extends ScoReembolso
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoReembolsoList";
    ...
    public $FormName = "fsco_reembolsolist";
    public $FormActionName = "";
    public $FormBlankRowName = "";
    public $FormKeyCountName = "";

    // CSS class/style
    public $CurrentPageName = "ScoReembolsoList";
    ...
    public function __construct()
    {
        ...
        $this->MultiDeleteUrl = "ScoReembolsoDelete";
        $this->MultiUpdateUrl = "ScoReembolsoUpdate";
    ...
    public function getFilterList()
    {
        ...
        $filterList = "";
        $savedFilterList = "";
        $filterList = Concat($filterList, $this->Nreembolso->AdvancedSearch->toJson(), ","); // Field Nreembolso
        ...
        $filterList = Concat($filterList, $this->fecha_tasa->AdvancedSearch->toJson(), ","); // Field fecha_tasa
        ...
        $filterList = Concat($filterList, $this->nro_cta->AdvancedSearch->toJson(), ","); // Field nro_cta
        ...
        $filterList = Concat($filterList, $this->nro_ref->AdvancedSearch->toJson(), ","); // Field nro_ref
        ...
        $filterList = Concat($filterList, $this->pagador->AdvancedSearch->toJson(), ","); // Field pagador
        $filterList = Concat($filterList, $this->fecha_pago->AdvancedSearch->toJson(), ","); // Field fecha_pago
        $filterList = Concat($filterList, $this->email_enviado->AdvancedSearch->toJson(), ","); // Field email_enviado
        if ($this->BasicSearch->Keyword != "") {
    ...
    protected function processFilterList()
    {
        if (Post("ajax") == "savefilters") { // Save filter request (Ajax)
            ...
            Profile()->setSearchFilters("fsco_reembolsosrch", $filters);
    ...
    protected function restoreFilterList()
    {
        ...
        // Field Nreembolso
        $this->Nreembolso->AdvancedSearch->SearchValue = @$filter["x_Nreembolso"];
        $this->Nreembolso->AdvancedSearch->SearchOperator = @$filter["z_Nreembolso"];
        $this->Nreembolso->AdvancedSearch->SearchCondition = @$filter["v_Nreembolso"];
        $this->Nreembolso->AdvancedSearch->SearchValue2 = @$filter["y_Nreembolso"];
        $this->Nreembolso->AdvancedSearch->SearchOperator2 = @$filter["w_Nreembolso"];
        $this->Nreembolso->AdvancedSearch->save();
        ...
        // Field fecha_tasa
        $this->fecha_tasa->AdvancedSearch->SearchValue = @$filter["x_fecha_tasa"];
        $this->fecha_tasa->AdvancedSearch->SearchOperator = @$filter["z_fecha_tasa"];
        $this->fecha_tasa->AdvancedSearch->SearchCondition = @$filter["v_fecha_tasa"];
        $this->fecha_tasa->AdvancedSearch->SearchValue2 = @$filter["y_fecha_tasa"];
        $this->fecha_tasa->AdvancedSearch->SearchOperator2 = @$filter["w_fecha_tasa"];
        $this->fecha_tasa->AdvancedSearch->save();
        ...
        // Field nro_cta
        $this->nro_cta->AdvancedSearch->SearchValue = @$filter["x_nro_cta"];
        $this->nro_cta->AdvancedSearch->SearchOperator = @$filter["z_nro_cta"];
        $this->nro_cta->AdvancedSearch->SearchCondition = @$filter["v_nro_cta"];
        $this->nro_cta->AdvancedSearch->SearchValue2 = @$filter["y_nro_cta"];
        $this->nro_cta->AdvancedSearch->SearchOperator2 = @$filter["w_nro_cta"];
        $this->nro_cta->AdvancedSearch->save();
        ...
        // Field nro_ref
        $this->nro_ref->AdvancedSearch->SearchValue = @$filter["x_nro_ref"];
        $this->nro_ref->AdvancedSearch->SearchOperator = @$filter["z_nro_ref"];
        $this->nro_ref->AdvancedSearch->SearchCondition = @$filter["v_nro_ref"];
        $this->nro_ref->AdvancedSearch->SearchValue2 = @$filter["y_nro_ref"];
        $this->nro_ref->AdvancedSearch->SearchOperator2 = @$filter["w_nro_ref"];
        $this->nro_ref->AdvancedSearch->save();
        ...
        // Field pagador
        $this->pagador->AdvancedSearch->SearchValue = @$filter["x_pagador"];
        $this->pagador->AdvancedSearch->SearchOperator = @$filter["z_pagador"];
        $this->pagador->AdvancedSearch->SearchCondition = @$filter["v_pagador"];
        $this->pagador->AdvancedSearch->SearchValue2 = @$filter["y_pagador"];
        $this->pagador->AdvancedSearch->SearchOperator2 = @$filter["w_pagador"];
        $this->pagador->AdvancedSearch->save();
        ...
        // Field email_enviado
        $this->email_enviado->AdvancedSearch->SearchValue = @$filter["x_email_enviado"];
        $this->email_enviado->AdvancedSearch->SearchOperator = @$filter["z_email_enviado"];
        $this->email_enviado->AdvancedSearch->SearchCondition = @$filter["v_email_enviado"];
        $this->email_enviado->AdvancedSearch->SearchValue2 = @$filter["y_email_enviado"];
        $this->email_enviado->AdvancedSearch->SearchOperator2 = @$filter["w_email_enviado"];
        $this->email_enviado->AdvancedSearch->save();
    ...
    protected function setupSortOrder()
    {
        ...
        if (Get("order") !== null) {
            ...
            $this->updateSort($this->nro_ref); // nro_ref
            ...
            $this->updateSort($this->email_enviado); // email_enviado
    ...
    public function renderListOptions()
    {
                ...
                if ($listAction->Select == ACTION_SINGLE && $allowed) {
                    ...
                    if ($action != "") {
                        ...
                        $link = $disabled
                            ...
                            : "<li><button type=\"button\" class=\"dropdown-item ew-action ew-list-action\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fsco_reembolsolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button></li>";
                        $links[] = $link;
                        if ($body == "") { // Setup first button
                            $body = $disabled
                            ? "<div class=\"alert alert-light\">" . $icon . " " . $caption . "</div>"
                            : "<button type=\"button\" class=\"btn btn-default ew-action ew-list-action\" title=\"" . $title . "\" data-caption=\"" . $title . "\" data-ew-action=\"submit\" form=\"fsco_reembolsolist\" data-key=\"" . $this->keyToJson(true) . "\"" . $listAction->toDataAttributes() . ">" . $icon . " " . $caption . "</button>";
                        }
                    }
                }
            }
        ...
        $opt->Body = "<div class=\"form-check\"><input type=\"checkbox\" id=\"key_m_" . $this->RowCount . "\" name=\"key_m[]\" class=\"form-check-input ew-multi-select\" value=\"" . HtmlEncode($this->Nreembolso->CurrentValue) . "\" data-ew-action=\"select-key\"></div>";
    ...
    protected function setupOtherOptions()
    {
        ...
        if ($this->UseColumnVisibility) {
            ...
            $this->createColumnOption($option, "nro_ref");
            ...
            $this->createColumnOption($option, "email_enviado");
        }
        ...
        $item->Body = "<a class=\"ew-save-filter\" data-form=\"fsco_reembolsosrch\" data-ew-action=\"none\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
        $item->Visible = true;
        $item = &$this->FilterOptions->add("deletefilter");
        $item->Body = "<a class=\"ew-delete-filter\" data-form=\"fsco_reembolsosrch\" data-ew-action=\"none\">" . $Language->phrase("DeleteFilter") . "</a>";
        $item->Visible = true;
    ...
    public function renderOtherOptions()
    {
        ...
        foreach ($this->ListActions as $listAction) {
            if ($listAction->Select == ACTION_MULTIPLE) {
                ...
                $item->Body = '<button type="button" class="btn btn-default ew-action ew-list-action" title="' . HtmlEncode($caption) . '" data-caption="' . HtmlEncode($caption) . '" data-ew-action="submit" form="fsco_reembolsolist"' . $listAction->toDataAttributes() . '>' . $icon . '</button>';
    ...
    protected function setupSearchOptions()
    {
        ...
        $item->Body = "<a class=\"btn btn-default ew-search-toggle" . $searchToggleClass . "\" role=\"button\" title=\"" . $Language->phrase("SearchPanel") . "\" data-caption=\"" . $Language->phrase("SearchPanel") . "\" data-ew-action=\"search-toggle\" data-form=\"fsco_reembolsosrch\" aria-pressed=\"" . ($searchToggleClass == " active" ? "true" : "false") . "\">" . $Language->phrase("SearchLink") . "</a>";
        $item->Visible = true;
    ...
    public function listOptionsRendered() {
    	// Example: 
    	$this->ListOptions->Items["print"]->Body = '<a target="_blank" href="fpdf_report/rptReembolso.php?Nreembolso=' . CurrentTable()->Nreembolso->CurrentValue . '"><span class="glyphicon glyphicon-print"></span></a>';
    }
