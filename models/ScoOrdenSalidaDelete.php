 ...
 * Page class
 */
class ScoOrdenSalidaDelete extends ScoOrdenSalida
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoOrdenSalidaDelete";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoOrdenSalidaDelete";
    ...
    public function setVisibility()
    {
        ...
        $this->acompanantes->Visible = false;
    ...
    public function run()
    {
        ...
        if ($filter == "") {
            $this->terminate("ScoOrdenSalidaList"); // Prevent SQL injection, return to list
            return;
        }
        ...
        if ($this->isShow()) { // Load records for display
            ...
            if ($this->TotalRecords <= 0) { // No record found, exit
                $this->Recordset?->free();
                $this->terminate("ScoOrdenSalidaList"); // Return to list
                return;
            }
        }
