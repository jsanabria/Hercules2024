 ...
 * Page class
 */
class ScoTasaUsdView extends ScoTasaUsd
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoTasaUsdView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoTasaUsdView";
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("id") ?? Route("id")) !== null) {
            ...
            $returnUrl = "ScoTasaUsdList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoTasaUsdList"; // No matching record, return to list
                    } else {
