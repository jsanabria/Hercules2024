 ...
 * Page class
 */
class ScoMttotecnicoNotasPreview extends ScoMttotecnicoNotas
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoMttotecnicoNotasPreview";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoMttotecnicoNotasPreview";
