 ...
 * Page class
 */
class ScoReclamoAdjuntoAdd extends ScoReclamoAdjunto
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoReclamoAdjuntoAdd";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoReclamoAdjuntoAdd";
    ...
    public function run()
    {
        ...
        if (IsApi()) {
            ...
            if (($keyValue = Get("Nreclamo_adjunto") ?? Route("Nreclamo_adjunto")) !== null) {
                $this->Nreclamo_adjunto->setQueryStringValue($keyValue);
            }
        ...
        switch ($this->CurrentAction) {
            case "copy": // Copy an existing record
                if (!$rsold) { // Record not loaded
                    ...
                    $this->terminate("ScoReclamoAdjuntoList"); // No matching record, return to list
                    return;
                }
                break;
            case "insert": // Add new record
                ...
                if ($this->addRow($rsold)) { // Add successful
                    ...
                    if (GetPageName($returnUrl) == "ScoReclamoAdjuntoList") {
                        $returnUrl = $this->addMasterUrl($returnUrl); // List page, return to List page with correct master key if necessary
                    } elseif (GetPageName($returnUrl) == "ScoReclamoAdjuntoView") {
                    ...
                    if ($this->IsModal && $this->UseAjaxActions && !$this->getCurrentMasterTable()) {
                        ...
                        if (GetPageName($returnUrl) != "ScoReclamoAdjuntoList") {
                            ...
                            $returnUrl = "ScoReclamoAdjuntoList"; // Return list page content
                        }
                    }
    ...
    public function renderRow()
    {
        ...
        // Nreclamo_adjunto
        $this->Nreclamo_adjunto->RowCssClass = "row";
    ...
    protected function setupBreadcrumb()
    {
        ...
        $url = CurrentUrl();
        $Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ScoReclamoAdjuntoList"), "", $this->TableVar, true);
