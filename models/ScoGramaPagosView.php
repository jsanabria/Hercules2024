 ...
 * Page class
 */
class ScoGramaPagosView extends ScoGramaPagos
{
    use MessagesTrait;
    ...
    // Page object name
    public $PageObjName = "ScoGramaPagosView";
    ...
    // CSS class/style
    public $CurrentPageName = "ScoGramaPagosView";
    ...
    {
        $this->Ngrama_pagos->setVisibility();
        ...
        $this->usuario_registra->setVisibility();
    }
    ...
    public function __construct()
    {
        ...
        if (($keyValue = Get("Ngrama_pagos") ?? Route("Ngrama_pagos")) !== null) {
            $this->RecKey["Ngrama_pagos"] = $keyValue;
        }
    ...
    public function run()
    {
        ...
        if (($keyValue = Get("Ngrama_pagos") ?? Route("Ngrama_pagos")) !== null) {
            ...
            $this->RecKey["Ngrama_pagos"] = $this->Ngrama_pagos->QueryStringValue;
        } elseif (Post("Ngrama_pagos") !== null) {
            $this->Ngrama_pagos->setFormValue(Post("Ngrama_pagos"));
            $this->RecKey["Ngrama_pagos"] = $this->Ngrama_pagos->FormValue;
        } elseif (IsApi() && ($keyValue = Key(0) ?? Route(2)) !== null) {
            $this->Ngrama_pagos->setQueryStringValue($keyValue);
            $this->RecKey["Ngrama_pagos"] = $this->Ngrama_pagos->QueryStringValue;
        } elseif (!$loadCurrentRecord) {
            $returnUrl = "ScoGramaPagosList"; // Return to list
        }
            ...
            case "show": // Get a record to display
                if (!$this->IsModal && !IsApi()) { // Normal view page
                    ...
                    if (!$matchRecord) {
                        ...
                        $returnUrl = "ScoGramaPagosList"; // No matching record, return to list
                    } else {
