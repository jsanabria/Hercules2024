...
/**
 * Entity class for "view_parcela_ventas" table
 */
#[Entity]
#[Table(name: "view_parcela_ventas")]
class ViewParcelaVenta extends AbstractEntity
{
    #[Id]
    #[Column(name: "Nparcela_ventas", type: "integer")]
    #[GeneratedValue]
