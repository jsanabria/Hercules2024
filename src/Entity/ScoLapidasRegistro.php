...
/**
 * Entity class for "sco_lapidas_registro" table
 */
#[Entity]
#[Table(name: "sco_lapidas_registro")]
class ScoLapidasRegistro extends AbstractEntity
{
    #[Id]
    #[Column(name: "Nlapidas_registro", type: "integer", unique: true)]
    #[GeneratedValue]
    private int $nlapidasRegistro;
    ...
    #[Column(type: "string", nullable: true)]
    private ?string $maqueteo;

    #[Column(name: "coordenadas_maqueta", type: "string", nullable: true)]
    private ?string $coordenadasMaqueta;
    ...
    public function getNlapidasRegistro(): int
    {
        return $this->nlapidasRegistro;
    }

    public function setNlapidasRegistro(int $value): static
    {
        $this->nlapidasRegistro = $value;
        return $this;
    }
    ...
    public function getMaqueteo(): ?string
    {
        return HtmlDecode($this->maqueteo);
    }

    public function setMaqueteo(?string $value): static
    {
        $this->maqueteo = RemoveXss($value);
        return $this;
    }

    public function getCoordenadasMaqueta(): ?string
    {
        return HtmlDecode($this->coordenadasMaqueta);
    }

    public function setCoordenadasMaqueta(?string $value): static
    {
        $this->coordenadasMaqueta = RemoveXss($value);
        return $this;
    }
