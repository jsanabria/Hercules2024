...
/**
 * Entity class for "sco_cremacion_estatus" table
 */
#[Entity]
#[Table(name: "sco_cremacion_estatus")]
class ScoCremacionEstatus extends AbstractEntity
{
    #[Id]
    #[Column(type: "integer")]
    ...
    public function __construct(int $expediente, string $estatus)
    {
