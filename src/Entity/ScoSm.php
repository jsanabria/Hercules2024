...
/**
 * Entity class for "sco_sms" table
 */
#[Entity]
#[Table(name: "sco_sms")]
class ScoSm extends AbstractEntity
{
    #[Id]
    #[Column(name: "Nsms", type: "bigint", unique: true)]
    #[GeneratedValue]
    private string $nsms;
    ...
    public function getNsms(): string
    {
        return $this->nsms;
    }

    public function setNsms(string $value): static
    {
        $this->nsms = $value;
        return $this;
    }
