...
$CONFIG = [
    ...
    "PROJECT_STYLESHEET_FILENAME" => "css/hercules.css", // Project stylesheet file name
    ...
    "AES_ENCRYPTION_KEY" => "pVD/9I5GccfwJbzDq72fK9Yjfe9gIp8jJwDvPfVRckU=", // AES encryption key (base64 encoded)
    ...
    "AUTH_CONFIG" => [
        "providers" => [
            ...
            "Azure" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\hercules\\AzureAD',
                "keys" => [
                    "id" => '',
            ...
            "Saml" => [
                "enabled" => false,
                "adapter" => 'PHPMaker2024\\hercules\\Saml2',
    ...
    // Export Log
    "EXPORT_PATH" => "export-8204ed0a-01f4-49c6-8e13-d0a9484a17dd", // Export folder
    ...
    "USER_TABLE_NAME" => "sco_user",
    "USER_TABLE_ENTITY_CLASS" => Entity\ScoUser::class,
    ...
    "USER_EMAIL_FIELD_NAME" => "correo",
    "USER_EMAIL_PROPERTY_NAME" => "correo",
    ...
    // Email
    "SENDER_EMAIL" => "info@cementeriodeleste.com.ve", // Sender email address
    "RECIPIENT_EMAIL" => "info@cementeriodeleste.com.ve", // Recipient email address
    ...
    "UPLOAD_ALLOWED_FILE_EXT" => "gif,jpg,jpeg,bmp,png,pdf,mp3,wav,mp4,avi,cdr", // Allowed file extensions
